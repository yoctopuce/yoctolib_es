...
class YColorLed extends _yocto_api.YFunction {
    ...
    get_rgbColorAtPowerOn() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this12._rgbColorAtPowerOn;
            return res;
        })();
    }
    ...
    get_blinkSeqSignature() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this16._blinkSeqSignature;
            return res;
        })();
    }
