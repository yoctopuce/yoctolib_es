...
class YSms {
    ...
    set_parts(parts) {
        ...
        return _asyncToGenerator(function* () {
            ...
            retcode = yield _this39.parsePdu(subsms.get_pdu());
    ...
    generateParts() {
        ...
        return _asyncToGenerator(function* () {
            ...
            while (wpos < udlen) {
                ...
                newpdu.set_received((yield _this45.isReceived()));
                newpdu.set_smsc((yield _this45.get_smsc()));
                newpdu.set_msgRef((yield _this45.get_msgRef()));
                newpdu.set_sender((yield _this45.get_sender()));
                newpdu.set_recipient((yield _this45.get_recipient()));
                newpdu.set_protocolId((yield _this45.get_protocolId()));
                newpdu.set_dcs((yield _this45.get_dcs()));
                newpdu.set_timestamp((yield _this45.get_timestamp()));
...
class YMessageBox extends _yocto_api.YFunction {
    ...
    fetchPdu(slot) {
        ...
        return _asyncToGenerator(function* () {
            ...
            sms.set_slot(slot);
            sms.parsePdu(_this63._yapi.imm_hexstr2bin(hexPdu));
            return sms;
        })();
    }
