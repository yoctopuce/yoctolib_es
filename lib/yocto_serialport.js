...
class YSerialPort extends _yocto_api.YFunction {
    ...
    reset() {
        ...
        return _asyncToGenerator(function* () {
            _this21._rxptr = 0;
            _this21._rxbuffptr = 0;
            _this21._rxbuff = new Uint8Array(0);
    ...
    readByte() {
        ...
        return _asyncToGenerator(function* () {
            ...
            bufflen = _this28._rxbuff.length;
            if (_this28._rxptr >= _this28._rxbuffptr && _this28._rxptr < _this28._rxbuffptr + bufflen) {
                res = _this28._rxbuff[_this28._rxptr - _this28._rxbuffptr];
                _this28._rxptr = _this28._rxptr + 1;
                return res;
            }

            // try to preload more than one byte to speed-up byte-per-byte access
            currpos = _this28._rxptr;
            reqlen = 1024;
            buff = yield _this28.readBin(reqlen);
            bufflen = buff.length;
            if (_this28._rxptr == currpos + bufflen) {
                res = buff[0];
                _this28._rxptr = currpos + 1;
                _this28._rxbuffptr = currpos;
                _this28._rxbuff = buff;
                return res;
            }
            // mixed bidirectional data, retry with a smaller block
            _this28._rxptr = currpos;
            reqlen = 16;
            buff = yield _this28.readBin(reqlen);
            bufflen = buff.length;
            if (_this28._rxptr == currpos + bufflen) {
