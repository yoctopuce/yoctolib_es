...
export var Y_VOLTAGELEVEL_OFF              = 0;
export var Y_VOLTAGELEVEL_TTL3V            = 1;
export var Y_VOLTAGELEVEL_TTL3VR           = 2;
export var Y_VOLTAGELEVEL_TTL5V            = 3;
export var Y_VOLTAGELEVEL_TTL5VR           = 4;
export var Y_VOLTAGELEVEL_RS232            = 5;
export var Y_VOLTAGELEVEL_RS485            = 6;
export var Y_VOLTAGELEVEL_INVALID          = -1;
export var Y_SSPOLARITY_ACTIVE_LOW         = 0;
export var Y_SSPOLARITY_ACTIVE_HIGH        = 1;
export var Y_SSPOLARITY_INVALID            = -1;
export var Y_SHITFTSAMPLING_OFF            = 0;
export var Y_SHITFTSAMPLING_ON             = 1;
export var Y_SHITFTSAMPLING_INVALID        = -1;
export var Y_RXCOUNT_INVALID               = YAPI.INVALID_UINT;
export var Y_TXCOUNT_INVALID               = YAPI.INVALID_UINT;
export var Y_ERRCOUNT_INVALID              = YAPI.INVALID_UINT;
export var Y_RXMSGCOUNT_INVALID            = YAPI.INVALID_UINT;
export var Y_TXMSGCOUNT_INVALID            = YAPI.INVALID_UINT;
export var Y_LASTMSG_INVALID               = YAPI.INVALID_STRING;
export var Y_CURRENTJOB_INVALID            = YAPI.INVALID_STRING;
export var Y_STARTUPJOB_INVALID            = YAPI.INVALID_STRING;
export var Y_COMMAND_INVALID               = YAPI.INVALID_STRING;
export var Y_PROTOCOL_INVALID              = YAPI.INVALID_STRING;
export var Y_SPIMODE_INVALID               = YAPI.INVALID_STRING;
...
export class YSpiPort extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YSpiPortProxy(this);
 ...
 * @return {YSpiPort} a YSpiPort object allowing you to drive the SPI port.
 */
export function yFindSpiPort(func)
{
