/*********************************************************************
 *
 * $Id: yocto_datalogger.js 27279 2017-04-25 15:42:35Z seb $
 *
...
import { YAPI, YAPI_SUCCESS, YFunction, YModule, YSensor, YDataStream, YDataSet, YFunctionProxy, YSensorProxy } from 'yoctolib-es/src/yocto_api'

//--- (generated code: YDataLogger definitions)
export var Y_RECORDING_OFF                 = 0;
export var Y_RECORDING_ON                  = 1;
export var Y_RECORDING_PENDING             = 2;
export var Y_RECORDING_INVALID             = -1;
export var Y_AUTOSTART_OFF                 = 0;
export var Y_AUTOSTART_ON                  = 1;
export var Y_AUTOSTART_INVALID             = -1;
export var Y_BEACONDRIVEN_OFF              = 0;
export var Y_BEACONDRIVEN_ON               = 1;
export var Y_BEACONDRIVEN_INVALID          = -1;
export var Y_CLEARHISTORY_FALSE            = 0;
export var Y_CLEARHISTORY_TRUE             = 1;
export var Y_CLEARHISTORY_INVALID          = -1;
export var Y_CURRENTRUNINDEX_INVALID       = YAPI.INVALID_UINT;
export var Y_TIMEUTC_INVALID               = YAPI.INVALID_LONG;
...
export class YDataLogger extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YDataLoggerProxy(this);
