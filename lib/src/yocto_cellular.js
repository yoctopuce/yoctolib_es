...
export var Y_CELLTYPE_GPRS                 = 0;
export var Y_CELLTYPE_EGPRS                = 1;
export var Y_CELLTYPE_WCDMA                = 2;
export var Y_CELLTYPE_HSDPA                = 3;
export var Y_CELLTYPE_NONE                 = 4;
export var Y_CELLTYPE_CDMA                 = 5;
export var Y_CELLTYPE_INVALID              = -1;
export var Y_AIRPLANEMODE_OFF              = 0;
export var Y_AIRPLANEMODE_ON               = 1;
export var Y_AIRPLANEMODE_INVALID          = -1;
export var Y_ENABLEDATA_HOMENETWORK        = 0;
export var Y_ENABLEDATA_ROAMING            = 1;
export var Y_ENABLEDATA_NEVER              = 2;
export var Y_ENABLEDATA_NEUTRALITY         = 3;
export var Y_ENABLEDATA_INVALID            = -1;
export var Y_LINKQUALITY_INVALID           = YAPI.INVALID_UINT;
export var Y_CELLOPERATOR_INVALID          = YAPI.INVALID_STRING;
export var Y_CELLIDENTIFIER_INVALID        = YAPI.INVALID_STRING;
export var Y_IMSI_INVALID                  = YAPI.INVALID_STRING;
export var Y_MESSAGE_INVALID               = YAPI.INVALID_STRING;
export var Y_PIN_INVALID                   = YAPI.INVALID_STRING;
export var Y_LOCKEDOPERATOR_INVALID        = YAPI.INVALID_STRING;
export var Y_APN_INVALID                   = YAPI.INVALID_STRING;
export var Y_APNSECRET_INVALID             = YAPI.INVALID_STRING;
export var Y_PINGINTERVAL_INVALID          = YAPI.INVALID_UINT;
export var Y_DATASENT_INVALID              = YAPI.INVALID_UINT;
export var Y_DATARECEIVED_INVALID          = YAPI.INVALID_UINT;
...
export class YCellular extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YCellularProxy(this);
