...
export const Y_CELLTYPE_GPRS                 = 0;
export const Y_CELLTYPE_EGPRS                = 1;
export const Y_CELLTYPE_WCDMA                = 2;
export const Y_CELLTYPE_HSDPA                = 3;
export const Y_CELLTYPE_NONE                 = 4;
export const Y_CELLTYPE_INVALID              = -1;
