...
export var Y_EXCITATIONMODE_INTERNAL_AC    = 0;
export var Y_EXCITATIONMODE_INTERNAL_DC    = 1;
export var Y_EXCITATIONMODE_EXTERNAL_DC    = 2;
export var Y_EXCITATIONMODE_INVALID        = -1;
export var Y_BRIDGELATENCY_INVALID         = YAPI.INVALID_UINT;
export var Y_ADVALUE_INVALID               = YAPI.INVALID_INT;
export var Y_ADGAIN_INVALID                = YAPI.INVALID_UINT;
...
export class YBridgeControl extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YBridgeControlProxy(this);
...
export class YBridgeControlProxy extends YFunctionProxy
{
 ...
 * @return {YBridgeControl} a YBridgeControl object allowing you to drive the Wheatstone bridge controller.
 */
export function yFindBridgeControl(func)
{
 ...
 *         if there are none.
 */
export function yFirstBridgeControl()
{
