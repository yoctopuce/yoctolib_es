...
export var Y_GLOBALSTATE_ABSENT            = 0;
export var Y_GLOBALSTATE_ALERT             = 1;
export var Y_GLOBALSTATE_HI_Z              = 2;
export var Y_GLOBALSTATE_STOP              = 3;
export var Y_GLOBALSTATE_RUN               = 4;
export var Y_GLOBALSTATE_BATCH             = 5;
export var Y_GLOBALSTATE_INVALID           = -1;
export var Y_NAXIS_INVALID                 = YAPI.INVALID_UINT;
...
export class YMultiAxisController extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YMultiAxisControllerProxy(this);
 ...
 * @return {YMultiAxisController} a YMultiAxisController object allowing you to drive the multi-axis controller.
 */
export function yFindMultiAxisController(func)
{
 ...
 *         if there are none.
 */
export function yFirstMultiAxisController()
{
