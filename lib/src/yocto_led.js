/*********************************************************************
 *
 * $Id: yocto_led.js 23963 2016-04-17 20:55:12Z mvuilleu $
 *
...
//--- (YLed definitions)
export var Y_POWER_OFF                     = 0;
export var Y_POWER_ON                      = 1;
export var Y_POWER_INVALID                 = -1;
export var Y_BLINKING_STILL                = 0;
export var Y_BLINKING_RELAX                = 1;
export var Y_BLINKING_AWARE                = 2;
export var Y_BLINKING_RUN                  = 3;
export var Y_BLINKING_CALL                 = 4;
export var Y_BLINKING_PANIC                = 5;
export var Y_BLINKING_INVALID              = -1;
export var Y_LUMINOSITY_INVALID            = YAPI.INVALID_UINT;
