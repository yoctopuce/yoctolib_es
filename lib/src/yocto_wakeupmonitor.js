/*********************************************************************
 *
 * $Id: yocto_wakeupmonitor.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_WAKEUPREASON_USBPOWER         = 0;
export var Y_WAKEUPREASON_EXTPOWER         = 1;
export var Y_WAKEUPREASON_ENDOFSLEEP       = 2;
export var Y_WAKEUPREASON_EXTSIG1          = 3;
export var Y_WAKEUPREASON_SCHEDULE1        = 4;
export var Y_WAKEUPREASON_SCHEDULE2        = 5;
export var Y_WAKEUPREASON_INVALID          = -1;
export var Y_WAKEUPSTATE_SLEEPING          = 0;
export var Y_WAKEUPSTATE_AWAKE             = 1;
export var Y_WAKEUPSTATE_INVALID           = -1;
export var Y_POWERDURATION_INVALID         = YAPI.INVALID_INT;
export var Y_SLEEPCOUNTDOWN_INVALID        = YAPI.INVALID_INT;
export var Y_NEXTWAKEUP_INVALID            = YAPI.INVALID_LONG;
export var Y_RTCTIME_INVALID               = YAPI.INVALID_LONG;
...
export class YWakeUpMonitor extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YWakeUpMonitorProxy(this);
