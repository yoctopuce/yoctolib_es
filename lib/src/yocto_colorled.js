/*********************************************************************
 *
 * $Id: yocto_colorled.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_RGBCOLOR_INVALID              = YAPI.INVALID_UINT;
export var Y_HSLCOLOR_INVALID              = YAPI.INVALID_UINT;
export var Y_RGBMOVE_INVALID               = null;
export var Y_HSLMOVE_INVALID               = null;
export var Y_RGBCOLORATPOWERON_INVALID     = YAPI.INVALID_UINT;
export var Y_BLINKSEQSIZE_INVALID          = YAPI.INVALID_UINT;
export var Y_BLINKSEQMAXSIZE_INVALID       = YAPI.INVALID_UINT;
export var Y_BLINKSEQSIGNATURE_INVALID     = YAPI.INVALID_UINT;
...
export class YColorLed extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YColorLedProxy(this);
