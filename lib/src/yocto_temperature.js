/*********************************************************************
 *
 * $Id: yocto_temperature.js 24195 2016-04-22 18:29:20Z mvuilleu $
 *
...
export var Y_SENSORTYPE_DIGITAL            = 0;
export var Y_SENSORTYPE_TYPE_K             = 1;
export var Y_SENSORTYPE_TYPE_E             = 2;
export var Y_SENSORTYPE_TYPE_J             = 3;
export var Y_SENSORTYPE_TYPE_N             = 4;
export var Y_SENSORTYPE_TYPE_R             = 5;
export var Y_SENSORTYPE_TYPE_S             = 6;
export var Y_SENSORTYPE_TYPE_T             = 7;
export var Y_SENSORTYPE_PT100_4WIRES       = 8;
export var Y_SENSORTYPE_PT100_3WIRES       = 9;
export var Y_SENSORTYPE_PT100_2WIRES       = 10;
export var Y_SENSORTYPE_RES_OHM            = 11;
export var Y_SENSORTYPE_RES_NTC            = 12;
export var Y_SENSORTYPE_RES_LINEAR         = 13;
export var Y_SENSORTYPE_INVALID            = -1;
export var Y_SIGNALVALUE_INVALID           = YAPI.INVALID_DOUBLE;
export var Y_SIGNALUNIT_INVALID            = YAPI.INVALID_STRING;
...
export class YTemperature extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YTemperatureProxy(this);
