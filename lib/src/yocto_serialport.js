/*********************************************************************
 *
 * $Id: yocto_serialport.js 24195 2016-04-22 18:29:20Z mvuilleu $
 *
...
export var Y_SERIALMODE_INVALID            = YAPI.INVALID_STRING;
...
export class YSerialPort extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YSerialPortProxy(this);
...
export class YSerialPortProxy extends YFunctionProxy
{
    ...
    get_CTS()
    {
        this.liveFunc.get_CTS().then((nextCTS) => { this.liveFunc._cachedCTS = nextCTS; });
