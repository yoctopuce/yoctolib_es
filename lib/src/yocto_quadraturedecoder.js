/*********************************************************************
 *
 * $Id: yocto_quadraturedecoder.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export var Y_DECODING_OFF                  = 0;
export var Y_DECODING_ON                   = 1;
export var Y_DECODING_INVALID              = -1;
...
export class YQuadratureDecoder extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YQuadratureDecoderProxy(this);
