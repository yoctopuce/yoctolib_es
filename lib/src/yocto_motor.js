/*********************************************************************
 *
 * $Id: yocto_motor.js 26669 2017-02-28 13:40:47Z seb $
 *
...
//--- (YMotor definitions)
export var Y_MOTORSTATUS_IDLE              = 0;
export var Y_MOTORSTATUS_BRAKE             = 1;
export var Y_MOTORSTATUS_FORWD             = 2;
export var Y_MOTORSTATUS_BACKWD            = 3;
export var Y_MOTORSTATUS_LOVOLT            = 4;
export var Y_MOTORSTATUS_HICURR            = 5;
export var Y_MOTORSTATUS_HIHEAT            = 6;
export var Y_MOTORSTATUS_FAILSF            = 7;
export var Y_MOTORSTATUS_INVALID           = -1;
export var Y_DRIVINGFORCE_INVALID          = YAPI.INVALID_DOUBLE;
export var Y_BRAKINGFORCE_INVALID          = YAPI.INVALID_DOUBLE;
export var Y_CUTOFFVOLTAGE_INVALID         = YAPI.INVALID_DOUBLE;
export var Y_OVERCURRENTLIMIT_INVALID      = YAPI.INVALID_INT;
export var Y_FREQUENCY_INVALID             = YAPI.INVALID_DOUBLE;
export var Y_STARTERTIME_INVALID           = YAPI.INVALID_INT;
export var Y_FAILSAFETIMEOUT_INVALID       = YAPI.INVALID_UINT;
