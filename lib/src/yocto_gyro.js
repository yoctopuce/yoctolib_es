/*********************************************************************
 *
 * $Id: yocto_gyro.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export class YGyro extends YSensor
{
    ...
    async _loadQuaternion()
    {
        ...
        if ((age_ms >= 10) || (this._qt_stamp == 0)) {
            ...
            if (this._qt_stamp == 0) {
                this._qt_w = await YQt.FindQtInContext(this._yapi, this._serial+'.qt1');
                this._qt_x = await YQt.FindQtInContext(this._yapi, this._serial+'.qt2');
                this._qt_y = await YQt.FindQtInContext(this._yapi, this._serial+'.qt3');
                this._qt_z = await YQt.FindQtInContext(this._yapi, this._serial+'.qt4');
            }
