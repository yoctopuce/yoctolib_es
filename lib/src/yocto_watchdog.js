/*********************************************************************
 *
 * $Id: yocto_watchdog.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_STATE_A                       = 0;
export var Y_STATE_B                       = 1;
export var Y_STATE_INVALID                 = -1;
export var Y_STATEATPOWERON_UNCHANGED      = 0;
export var Y_STATEATPOWERON_A              = 1;
export var Y_STATEATPOWERON_B              = 2;
export var Y_STATEATPOWERON_INVALID        = -1;
export var Y_OUTPUT_OFF                    = 0;
export var Y_OUTPUT_ON                     = 1;
export var Y_OUTPUT_INVALID                = -1;
export var Y_AUTOSTART_OFF                 = 0;
export var Y_AUTOSTART_ON                  = 1;
export var Y_AUTOSTART_INVALID             = -1;
export var Y_RUNNING_OFF                   = 0;
export var Y_RUNNING_ON                    = 1;
export var Y_RUNNING_INVALID               = -1;
export var Y_MAXTIMEONSTATEA_INVALID       = YAPI.INVALID_LONG;
export var Y_MAXTIMEONSTATEB_INVALID       = YAPI.INVALID_LONG;
export var Y_PULSETIMER_INVALID            = YAPI.INVALID_LONG;
export var Y_DELAYEDPULSETIMER_INVALID     = null;
export var Y_COUNTDOWN_INVALID             = YAPI.INVALID_LONG;
export var Y_TRIGGERDELAY_INVALID          = YAPI.INVALID_LONG;
export var Y_TRIGGERDURATION_INVALID       = YAPI.INVALID_LONG;
