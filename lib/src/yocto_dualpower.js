/*********************************************************************
 *
 * $Id: yocto_dualpower.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_POWERSTATE_OFF                = 0;
export var Y_POWERSTATE_FROM_USB           = 1;
export var Y_POWERSTATE_FROM_EXT           = 2;
export var Y_POWERSTATE_INVALID            = -1;
export var Y_POWERCONTROL_AUTO             = 0;
export var Y_POWERCONTROL_FROM_USB         = 1;
export var Y_POWERCONTROL_FROM_EXT         = 2;
export var Y_POWERCONTROL_OFF              = 3;
export var Y_POWERCONTROL_INVALID          = -1;
export var Y_EXTVOLTAGE_INVALID            = YAPI.INVALID_UINT;
...
export class YDualPower extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YDualPowerProxy(this);
