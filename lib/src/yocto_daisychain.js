...
export var Y_DAISYSTATE_READY              = 0;
export var Y_DAISYSTATE_IS_CHILD           = 1;
export var Y_DAISYSTATE_FIRMWARE_MISMATCH  = 2;
export var Y_DAISYSTATE_CHILD_MISSING      = 3;
export var Y_DAISYSTATE_CHILD_LOST         = 4;
export var Y_DAISYSTATE_INVALID            = -1;
export var Y_CHILDCOUNT_INVALID            = YAPI.INVALID_UINT;
export var Y_REQUIREDCHILDCOUNT_INVALID    = YAPI.INVALID_UINT;
...
export class YDaisyChain extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YDaisyChainProxy(this);
 ...
 * @return {YDaisyChain} a YDaisyChain object allowing you to drive the module chain.
 */
export function yFindDaisyChain(func)
{
 ...
 *         if there are none.
 */
export function yFirstDaisyChain()
{
