/*********************************************************************
 *
 * $Id: yocto_lightsensor.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export var Y_MEASURETYPE_HUMAN_EYE         = 0;
export var Y_MEASURETYPE_WIDE_SPECTRUM     = 1;
export var Y_MEASURETYPE_INFRARED          = 2;
export var Y_MEASURETYPE_HIGH_RATE         = 3;
export var Y_MEASURETYPE_HIGH_ENERGY       = 4;
export var Y_MEASURETYPE_INVALID           = -1;
...
export class YLightSensor extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YLightSensorProxy(this);
