/*********************************************************************
 *
 * $Id: yocto_pwmoutput.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_ENABLEDATPOWERON_FALSE        = 0;
export var Y_ENABLEDATPOWERON_TRUE         = 1;
export var Y_ENABLEDATPOWERON_INVALID      = -1;
export var Y_FREQUENCY_INVALID             = YAPI.INVALID_DOUBLE;
export var Y_PERIOD_INVALID                = YAPI.INVALID_DOUBLE;
export var Y_DUTYCYCLE_INVALID             = YAPI.INVALID_DOUBLE;
export var Y_PULSEDURATION_INVALID         = YAPI.INVALID_DOUBLE;
export var Y_PWMTRANSITION_INVALID         = YAPI.INVALID_STRING;
export var Y_DUTYCYCLEATPOWERON_INVALID    = YAPI.INVALID_DOUBLE;
...
export class YPwmOutput extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YPwmOutputProxy(this);
