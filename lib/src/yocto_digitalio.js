...
export var Y_OUTPUTVOLTAGE_USB_5V          = 0;
export var Y_OUTPUTVOLTAGE_USB_3V          = 1;
export var Y_OUTPUTVOLTAGE_EXT_V           = 2;
export var Y_OUTPUTVOLTAGE_INVALID         = -1;
export var Y_PORTSTATE_INVALID             = YAPI.INVALID_UINT;
export var Y_PORTDIRECTION_INVALID         = YAPI.INVALID_UINT;
export var Y_PORTOPENDRAIN_INVALID         = YAPI.INVALID_UINT;
export var Y_PORTPOLARITY_INVALID          = YAPI.INVALID_UINT;
export var Y_PORTDIAGS_INVALID             = YAPI.INVALID_UINT;
export var Y_PORTSIZE_INVALID              = YAPI.INVALID_UINT;
...
export class YDigitalIO extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YDigitalIOProxy(this);
