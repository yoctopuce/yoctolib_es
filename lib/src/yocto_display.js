/*********************************************************************
 *
 * $Id: yocto_display.js 27092 2017-04-06 20:59:34Z seb $
 *
...
export var Y_ORIENTATION_LEFT              = 0;
export var Y_ORIENTATION_UP                = 1;
export var Y_ORIENTATION_RIGHT             = 2;
export var Y_ORIENTATION_DOWN              = 3;
export var Y_ORIENTATION_INVALID           = -1;
export var Y_DISPLAYTYPE_MONO              = 0;
export var Y_DISPLAYTYPE_GRAY              = 1;
export var Y_DISPLAYTYPE_RGB               = 2;
export var Y_DISPLAYTYPE_INVALID           = -1;
export var Y_STARTUPSEQ_INVALID            = YAPI.INVALID_STRING;
export var Y_BRIGHTNESS_INVALID            = YAPI.INVALID_UINT;
export var Y_DISPLAYWIDTH_INVALID          = YAPI.INVALID_UINT;
export var Y_DISPLAYHEIGHT_INVALID         = YAPI.INVALID_UINT;
export var Y_LAYERWIDTH_INVALID            = YAPI.INVALID_UINT;
export var Y_LAYERHEIGHT_INVALID           = YAPI.INVALID_UINT;
export var Y_LAYERCOUNT_INVALID            = YAPI.INVALID_UINT;
...
export var Y_ALIGN_TOP_LEFT                = 0;
export var Y_ALIGN_CENTER_LEFT             = 1;
export var Y_ALIGN_BASELINE_LEFT           = 2;
export var Y_ALIGN_BOTTOM_LEFT             = 3;
export var Y_ALIGN_TOP_CENTER              = 4;
export var Y_ALIGN_CENTER                  = 5;
export var Y_ALIGN_BASELINE_CENTER         = 6;
export var Y_ALIGN_BOTTOM_CENTER           = 7;
export var Y_ALIGN_TOP_DECIMAL             = 8;
export var Y_ALIGN_CENTER_DECIMAL          = 9;
export var Y_ALIGN_BASELINE_DECIMAL        = 10;
export var Y_ALIGN_BOTTOM_DECIMAL          = 11;
export var Y_ALIGN_TOP_RIGHT               = 12;
export var Y_ALIGN_CENTER_RIGHT            = 13;
export var Y_ALIGN_BASELINE_RIGHT          = 14;
export var Y_ALIGN_BOTTOM_RIGHT            = 15;
...
export class YDisplay extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YDisplayProxy(this);
