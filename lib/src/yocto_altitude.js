/*********************************************************************
 *
 * $Id: yocto_altitude.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export var Y_QNH_INVALID                   = YAPI.INVALID_DOUBLE;
export var Y_TECHNOLOGY_INVALID            = YAPI.INVALID_STRING;
...
export class YAltitude extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YAltitudeProxy(this);
