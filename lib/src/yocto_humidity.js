/*********************************************************************
 *
 * $Id: yocto_humidity.js 23963 2016-04-17 20:55:12Z mvuilleu $
 *
...
export var Y_RELHUM_INVALID                = YAPI.INVALID_DOUBLE;
export var Y_ABSHUM_INVALID                = YAPI.INVALID_DOUBLE;
...
export class YHumidity extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YHumidityProxy(this);
