/*********************************************************************
 *
 * $Id: yocto_pwmpowersource.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_POWERMODE_USB_5V              = 0;
export var Y_POWERMODE_USB_3V              = 1;
export var Y_POWERMODE_EXT_V               = 2;
export var Y_POWERMODE_OPNDRN              = 3;
export var Y_POWERMODE_INVALID             = -1;
...
export class YPwmPowerSource extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YPwmPowerSourceProxy(this);
