/*********************************************************************
 *
 * $Id: yocto_genericsensor.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export var Y_SIGNALSAMPLING_HIGH_RATE      = 0;
export var Y_SIGNALSAMPLING_HIGH_RATE_FILTERED = 1;
export var Y_SIGNALSAMPLING_LOW_NOISE      = 2;
export var Y_SIGNALSAMPLING_LOW_NOISE_FILTERED = 3;
export var Y_SIGNALSAMPLING_INVALID        = -1;
export var Y_SIGNALVALUE_INVALID           = YAPI.INVALID_DOUBLE;
export var Y_SIGNALUNIT_INVALID            = YAPI.INVALID_STRING;
export var Y_SIGNALRANGE_INVALID           = YAPI.INVALID_STRING;
export var Y_VALUERANGE_INVALID            = YAPI.INVALID_STRING;
export var Y_SIGNALBIAS_INVALID            = YAPI.INVALID_DOUBLE;
