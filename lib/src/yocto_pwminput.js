/*********************************************************************
 *
 * $Id: yocto_pwminput.js 23550 2016-03-21 14:38:58Z seb $
 *
...
export var Y_PWMREPORTMODE_PWM_DUTYCYCLE   = 0;
export var Y_PWMREPORTMODE_PWM_FREQUENCY   = 1;
export var Y_PWMREPORTMODE_PWM_PULSEDURATION = 2;
export var Y_PWMREPORTMODE_PWM_EDGECOUNT   = 3;
export var Y_PWMREPORTMODE_INVALID         = -1;
...
export class YPwmInput extends YSensor
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YPwmInputProxy(this);
