...
export var Y_LOGICALNAME_INVALID           = YAPI_INVALID_STRING;
export var Y_ADVERTISEDVALUE_INVALID       = YAPI_INVALID_STRING;
//--- (end of generated code: YFunction definitions)

//--- (generated code: YModule definitions)
export var Y_PERSISTENTSETTINGS_LOADED     = 0;
export var Y_PERSISTENTSETTINGS_SAVED      = 1;
export var Y_PERSISTENTSETTINGS_MODIFIED   = 2;
export var Y_PERSISTENTSETTINGS_INVALID    = -1;
export var Y_BEACON_OFF                    = 0;
export var Y_BEACON_ON                     = 1;
export var Y_BEACON_INVALID                = -1;
export var Y_PRODUCTNAME_INVALID           = YAPI_INVALID_STRING;
export var Y_SERIALNUMBER_INVALID          = YAPI_INVALID_STRING;
export var Y_PRODUCTID_INVALID             = YAPI_INVALID_UINT;
export var Y_PRODUCTRELEASE_INVALID        = YAPI_INVALID_UINT;
export var Y_FIRMWARERELEASE_INVALID       = YAPI_INVALID_STRING;
export var Y_LUMINOSITY_INVALID            = YAPI_INVALID_UINT;
export var Y_UPTIME_INVALID                = YAPI_INVALID_LONG;
export var Y_USBCURRENT_INVALID            = YAPI_INVALID_UINT;
export var Y_REBOOTCOUNTDOWN_INVALID       = YAPI_INVALID_INT;
export var Y_USERVAR_INVALID               = YAPI_INVALID_INT;
//--- (end of generated code: YModule definitions)

//--- (generated code: YSensor definitions)
export var Y_UNIT_INVALID                  = YAPI_INVALID_STRING;
export var Y_CURRENTVALUE_INVALID          = YAPI_INVALID_DOUBLE;
export var Y_LOWESTVALUE_INVALID           = YAPI_INVALID_DOUBLE;
export var Y_HIGHESTVALUE_INVALID          = YAPI_INVALID_DOUBLE;
export var Y_CURRENTRAWVALUE_INVALID       = YAPI_INVALID_DOUBLE;
export var Y_LOGFREQUENCY_INVALID          = YAPI_INVALID_STRING;
export var Y_REPORTFREQUENCY_INVALID       = YAPI_INVALID_STRING;
export var Y_CALIBRATIONPARAM_INVALID      = YAPI_INVALID_STRING;
export var Y_RESOLUTION_INVALID            = YAPI_INVALID_DOUBLE;
export var Y_SENSORSTATE_INVALID           = YAPI_INVALID_INT;
...
export class YFirmwareUpdate
{
    ...
    async _processMore(newupdate)
    {
        ...
        let timeout = this._yapi.GetTickCount() + 30000;
...
export class YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YFunctionProxy(this);
...
{   
    ...
    async firmwareUpdate(serial, firmware, settings, progress)
    {
        ...
        if (use_self_flash) {
            ...
            yreq = await this.request('POST', baseUrl + '/upload.html', new YHTTPBody('startupConf.json', settings, null), 0);
            if(yreq.errorType != YAPI_SUCCESS) {
                return _throw('Failed to save settings on hub');
            }
            progress(38, 'Save current settings');
            yreq = await this.request('POST', baseUrl + '/upload.html', new YHTTPBody('firmwareConf', settings, null), 0);
            if(yreq.errorType != YAPI_SUCCESS) {
                return _throw('Failed to save settings on hub');
            }
        }
                    ...
                    case this._USB_META_ACK_UPLOAD:
                        ...
                        if(this.tcpChan[tcpchan]) {
                            ...
                            if(this._lastUploadAckTime[tcpchan] != 0 && ackBytes > this._lastUploadAckBytes[tcpchan]) {
                                let deltaBytes = ackBytes - this._lastUploadAckBytes[tcpchan];
                                let deltaTime = ackTime - this._lastUploadAckTime[tcpchan];
            ...
            if(end > 2108 && this._remoteVersion >= 2 && tcpchan == 0) {
                ...
                if(pos == 0) {
                    ...
                    if(toBeSent < 64) {
                        ...
                        setTimeout(() => { this.imm_sendPendingRequest(tcpchan); }, waitTime);
                        return;
                    }
                    if(end > pos + toBeSent) {
