...
export var Y_MOTORSTATE_ABSENT             = 0;
export var Y_MOTORSTATE_ALERT              = 1;
export var Y_MOTORSTATE_HI_Z               = 2;
export var Y_MOTORSTATE_STOP               = 3;
export var Y_MOTORSTATE_RUN                = 4;
export var Y_MOTORSTATE_BATCH              = 5;
export var Y_MOTORSTATE_INVALID            = -1;
export var Y_STEPPING_MICROSTEP16          = 0;
export var Y_STEPPING_MICROSTEP8           = 1;
export var Y_STEPPING_MICROSTEP4           = 2;
export var Y_STEPPING_HALFSTEP             = 3;
export var Y_STEPPING_FULLSTEP             = 4;
export var Y_STEPPING_INVALID              = -1;
export var Y_DIAGS_INVALID                 = YAPI.INVALID_UINT;
export var Y_STEPPOS_INVALID               = YAPI.INVALID_DOUBLE;
export var Y_SPEED_INVALID                 = YAPI.INVALID_DOUBLE;
export var Y_PULLINSPEED_INVALID           = YAPI.INVALID_DOUBLE;
export var Y_MAXACCEL_INVALID              = YAPI.INVALID_DOUBLE;
export var Y_MAXSPEED_INVALID              = YAPI.INVALID_DOUBLE;
export var Y_USTEPMAXSPEED_INVALID         = YAPI.INVALID_DOUBLE;
export var Y_OVERCURRENT_INVALID           = YAPI.INVALID_UINT;
export var Y_TCURRSTOP_INVALID             = YAPI.INVALID_UINT;
export var Y_TCURRRUN_INVALID              = YAPI.INVALID_UINT;
export var Y_ALERTMODE_INVALID             = YAPI.INVALID_STRING;
...
export class YStepperMotor extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YStepperMotorProxy(this);
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_ustepMaxSpeed(newval)
    {
        /** @type {string} **/
        let rest_val;
        rest_val = String(Math.round(newval * 65536.0));
        return await this._setAttr('ustepMaxSpeed',rest_val);
    }
 ...
 * @return {YStepperMotor} a YStepperMotor object allowing you to drive the stepper motor.
 */
export function yFindStepperMotor(func)
{
 ...
 *         if there are none.
 */
export function yFirstStepperMotor()
{
