/*********************************************************************
 *
 * $Id: yocto_bluetoothlink.js 26669 2017-02-28 13:40:47Z seb $
 *
...
export var Y_LINKSTATE_DOWN                = 0;
export var Y_LINKSTATE_FREE                = 1;
export var Y_LINKSTATE_SEARCH              = 2;
export var Y_LINKSTATE_EXISTS              = 3;
export var Y_LINKSTATE_LINKED              = 4;
export var Y_LINKSTATE_PLAY                = 5;
export var Y_LINKSTATE_INVALID             = -1;
export var Y_OWNADDRESS_INVALID            = YAPI.INVALID_STRING;
export var Y_PAIRINGPIN_INVALID            = YAPI.INVALID_STRING;
export var Y_REMOTEADDRESS_INVALID         = YAPI.INVALID_STRING;
export var Y_REMOTENAME_INVALID            = YAPI.INVALID_STRING;
export var Y_PREAMPLIFIER_INVALID          = YAPI.INVALID_UINT;
...
export class YBluetoothLink extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YBluetoothLinkProxy(this);
