...
export class YSms
{
    ...
    async set_parts(parts)
    {
        ...
        retcode = await this.parsePdu(subsms.get_pdu());
    ...
    async generateParts()
    {
        ...
        while (wpos < udlen) {
            ...
            newpdu.set_received(await this.isReceived());
            newpdu.set_smsc(await this.get_smsc());
            newpdu.set_msgRef(await this.get_msgRef());
            newpdu.set_sender(await this.get_sender());
            newpdu.set_recipient(await this.get_recipient());
            newpdu.set_protocolId(await this.get_protocolId());
            newpdu.set_dcs(await this.get_dcs());
            newpdu.set_timestamp(await this.get_timestamp());
...
export var Y_SLOTSINUSE_INVALID            = YAPI.INVALID_UINT;
export var Y_SLOTSCOUNT_INVALID            = YAPI.INVALID_UINT;
export var Y_SLOTSBITMAP_INVALID           = YAPI.INVALID_STRING;
export var Y_PDUSENT_INVALID               = YAPI.INVALID_UINT;
export var Y_PDURECEIVED_INVALID           = YAPI.INVALID_UINT;
...
export class YMessageBox extends YFunction
{
    ...
    async get_syncProxy()
    {
        ...
        var res = new YMessageBoxProxy(this);
    ...
    async fetchPdu(slot)
    {
        ...
        sms = new YSms(this);
        sms.set_slot(slot);
        sms.parsePdu(this._yapi.imm_hexstr2bin(hexPdu));
        return sms;
    }
 ...
 * @return {YMessageBox} a YMessageBox object allowing you to drive the MessageBox interface.
 */
export function yFindMessageBox(func)
{
 ...
 *         if there are none.
 */
export function yFirstMessageBox()
{
