...
class YNetwork extends _yocto_api.YFunction {
    ...
    useDHCPauto() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this46.set_ipConfig('DHCP:');
        })();
    }
    ...
    useStaticIP(ipAddress, subnetMaskLen, router) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this47.set_ipConfig('STATIC:' + ipAddress + '/' + String(Math.round(subnetMaskLen)) + '/' + router);
        })();
    }
    ...
    ping(host) {
        ...
        return _asyncToGenerator(function* () {
            ...
            content = yield _this48._download('ping.txt?host=' + host);
            return _this48._yapi.imm_bin2str(content);
        })();
    }
    ...
    triggerCallback() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this49.set_callbackMethod((yield _this49.get_callbackMethod()));
        })();
    }
