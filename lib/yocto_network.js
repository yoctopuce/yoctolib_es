...
class YNetwork extends _yocto_api.YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return new YNetworkProxy(_this);
        })();
    }
    ...
    get_callbackMinDelay() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this36._callbackMinDelay;
        })();
    }
    ...
    set_callbackMinDelay(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this37._setAttr('callbackMinDelay', rest_val);
        })();
    }
    ...
    get_callbackMaxDelay() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this38._callbackMaxDelay;
        })();
    }
    ...
    set_callbackMaxDelay(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this39._setAttr('callbackMaxDelay', rest_val);
        })();
    }
    ...
    useDHCP(fallbackIpAddr, fallbackSubnetMaskLen, fallbackRouter) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this41.set_ipConfig('DHCP:' + fallbackIpAddr + '/' + String(Math.round(fallbackSubnetMaskLen)) + '/' + fallbackRouter);
        })();
    }
    ...
    useStaticIP(ipAddress, subnetMaskLen, router) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this42.set_ipConfig('STATIC:' + ipAddress + '/' + String(Math.round(subnetMaskLen)) + '/' + router);
        })();
    }
    ...
    ping(host) {
        ...
        return _asyncToGenerator(function* () {
            ...
            content = yield _this43._download('ping.txt?host=' + host);
            return _this43._yapi.imm_bin2str(content);
        })();
    }
