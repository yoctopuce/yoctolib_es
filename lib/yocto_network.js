/*********************************************************************
 *
 * $Id: yocto_network.js 26669 2017-02-28 13:40:47Z seb $
 *
...
var Y_CALLBACKSCHEDULE_INVALID = exports.Y_CALLBACKSCHEDULE_INVALID = _yocto_api.YAPI.INVALID_STRING;
...
class YNetwork extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {string} **/
        this._callbackSchedule = Y_CALLBACKSCHEDULE_INVALID;
        /** @member {number} **/
        ...
        this.imm_setConst({
            ...
            CALLBACKSCHEDULE_INVALID: _yocto_api.YAPI.INVALID_STRING,
    ...
    get_callbackCredentials() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this33._callbackCredentials;
            return res;
        })();
    }
    ...
    get_callbackInitialDelay() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this36._callbackInitialDelay;
            return res;
        })();
    }
    ...
    set_callbackSchedule(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this39._setAttr('callbackSchedule', rest_val);
        })();
    }
    ...
    set_callbackMinDelay(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this41._setAttr('callbackMinDelay', rest_val);
        })();
    }
    ...
    set_callbackMaxDelay(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this43._setAttr('callbackMaxDelay', rest_val);
        })();
    }
    ...
    useDHCP(fallbackIpAddr, fallbackSubnetMaskLen, fallbackRouter) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this45.set_ipConfig('DHCP:' + fallbackIpAddr + '/' + String(Math.round(fallbackSubnetMaskLen)) + '/' + fallbackRouter);
        })();
    }
    ...
    useStaticIP(ipAddress, subnetMaskLen, router) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this46.set_ipConfig('STATIC:' + ipAddress + '/' + String(Math.round(subnetMaskLen)) + '/' + router);
        })();
    }
    ...
    ping(host) {
        ...
        return _asyncToGenerator(function* () {
            ...
            content = yield _this47._download('ping.txt?host=' + host);
            return _this47._yapi.imm_bin2str(content);
        })();
    }
    ...
    triggerCallback() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this48.set_callbackMethod((yield _this48.get_callbackMethod()));
        })();
    }
