...
const Y_CELLTYPE_GPRS = exports.Y_CELLTYPE_GPRS = 0;
const Y_CELLTYPE_EGPRS = exports.Y_CELLTYPE_EGPRS = 1;
const Y_CELLTYPE_WCDMA = exports.Y_CELLTYPE_WCDMA = 2;
const Y_CELLTYPE_HSDPA = exports.Y_CELLTYPE_HSDPA = 3;
const Y_CELLTYPE_NONE = exports.Y_CELLTYPE_NONE = 4;
const Y_CELLTYPE_INVALID = exports.Y_CELLTYPE_INVALID = -1;
...
class YCellular extends _yocto_api.YFunction {
     ...
     * YCellular.CELLTYPE_WCDMA, YCellular.CELLTYPE_HSDPA and YCellular.CELLTYPE_NONE
     *
    ...
    set_enableData(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this13._setAttr('enableData', rest_val);
        })();
    }
    ...
    set_apn(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this15._setAttr('apn', rest_val);
        })();
    }
    ...
    set_apnSecret(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this17._setAttr('apnSecret', rest_val);
        })();
    }
    ...
    sendPUK(puk, newPin) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {string} **/
            let gsmMsg;
            gsmMsg = yield _this20.get_message();
            if (!(gsmMsg == 'Enter SIM PUK')) {
                return _this20._throw(_this20._yapi.INVALID_ARGUMENT, 'PUK not expected at this time', _this20._yapi.INVALID_ARGUMENT);
            }
            if (newPin == '') {
                return yield _this20.set_command('AT+CPIN=' + puk + ',0000;+CLCK=SC,0,0000');
            }
            return yield _this20.set_command('AT+CPIN=' + puk + ',' + newPin);
        })();
    }
    ...
    set_apnAuth(username, password) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this21.set_apnSecret(username + ',' + password);
        })();
    }
    ...
    _AT(cmd) {
        ...
        return _asyncToGenerator(function* () {
            ...
            waitMore = 24;
            while (waitMore > 0) {
                buff = yield _this22._download(cmd);
                bufflen = buff.length;
                buffstr = _this22._yapi.imm_bin2str(buff);
    ...
    quickCellSurvey() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res = [];
            // may throw an exception
            moni = yield _this24._AT('+CCED=0;#MONI=7;#MONI');
            ...
            mcc = _this24._yapi.imm_atoi(mccs);
            ...
            mnc = _this24._yapi.imm_atoi(mncs);
            recs = moni.split('#');
            ...
            for (let ii in recs) {
                ...
                if (llen >= 44) {
                    if (recs[ii].substr(41, 3) == 'dbm') {
                        ...
                        dbm = _this24._yapi.imm_atoi(dbms);
                        if (llen > 66) {
                            tads = recs[ii].substr(54, 2);
                            if (tads.substr(0, 1) == ' ') {
                                tads = tads.substr(1, 3);
                            }
                            tad = _this24._yapi.imm_atoi(tads);
...
class YCellularProxy extends _yocto_api.YFunctionProxy {
     ...
     * Active cellular connection type
     *
     * @return a value among Y_CELLTYPE_GPRS, Y_CELLTYPE_EGPRS, Y_CELLTYPE_WCDMA, Y_CELLTYPE_HSDPA and Y_CELLTYPE_NONE
     *
