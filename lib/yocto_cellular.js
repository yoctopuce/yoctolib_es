...
class YCellular extends _yocto_api.YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return new YCellularProxy(_this);
        })();
    }
    ...
    set_pin(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this8._setAttr('pin', rest_val);
        })();
    }
    ...
    set_lockedOperator(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this10._setAttr('lockedOperator', rest_val);
        })();
    }
    ...
    set_enableData(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this12._setAttr('enableData', rest_val);
        })();
    }
    ...
    set_apn(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this14._setAttr('apn', rest_val);
        })();
    }
    ...
    set_apnSecret(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this16._setAttr('apnSecret', rest_val);
        })();
    }
    ...
    sendPUK(puk, newPin) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {string} **/
            let gsmMsg;
            gsmMsg = yield _this19.get_message();
            if (!(gsmMsg == 'Enter SIM PUK')) {
                return _this19._throw(_this19._yapi.INVALID_ARGUMENT, 'PUK not expected at this time', _this19._yapi.INVALID_ARGUMENT);
            }
            if (newPin == '') {
                return yield _this19.set_command('AT+CPIN=' + puk + ',0000;+CLCK=SC,0,0000');
            }
            return yield _this19.set_command('AT+CPIN=' + puk + ',' + newPin);
        })();
    }
    ...
    set_apnAuth(username, password) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this20.set_apnSecret(username + ',' + password);
        })();
    }
    ...
    _AT(cmd) {
        ...
        return _asyncToGenerator(function* () {
            ...
            waitMore = 24;
            while (waitMore > 0) {
                buff = yield _this21._download(cmd);
                bufflen = buff.length;
                buffstr = _this21._yapi.imm_bin2str(buff);
    ...
    quickCellSurvey() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res = [];
            // may throw an exception
            moni = yield _this23._AT('+CCED=0;#MONI=7;#MONI');
            ...
            mcc = _this23._yapi.imm_atoi(mccs);
            ...
            mnc = _this23._yapi.imm_atoi(mncs);
            recs = moni.split('#');
            ...
            for (let ii in recs) {
                ...
                if (llen >= 44) {
                    if (recs[ii].substr(41, 3) == 'dbm') {
                        ...
                        dbm = _this23._yapi.imm_atoi(dbms);
                        if (llen > 66) {
                            tads = recs[ii].substr(54, 2);
                            if (tads.substr(0, 1) == ' ') {
                                tads = tads.substr(1, 3);
                            }
                            tad = _this23._yapi.imm_atoi(tads);
