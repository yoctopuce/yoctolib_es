...
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { return step("next", value); }, function (err) { return step("throw", err); }); } } return step("next"); }); }; } /*********************************************************************
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          *
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          * $Id: yocto_cellular.js 27279 2017-04-25 15:42:35Z seb $
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          *
...
var Y_ENABLEDATA_NEUTRALITY = exports.Y_ENABLEDATA_NEUTRALITY = 3;
...
var Y_DATASENT_INVALID = exports.Y_DATASENT_INVALID = _yocto_api.YAPI.INVALID_UINT;
var Y_DATARECEIVED_INVALID = exports.Y_DATARECEIVED_INVALID = _yocto_api.YAPI.INVALID_UINT;
...
class YCellular extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {number} **/
        this._dataSent = Y_DATASENT_INVALID;
        /** @member {number} **/
        this._dataReceived = Y_DATARECEIVED_INVALID;
        /** @member {string} **/
        ...
        this.imm_setConst({
            ...
            DATASENT_INVALID: _yocto_api.YAPI.INVALID_UINT,
            DATARECEIVED_INVALID: _yocto_api.YAPI.INVALID_UINT,
    ...
    set_dataSent(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this23._setAttr('dataSent', rest_val);
        })();
    }
    ...
    set_dataReceived(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this25._setAttr('dataReceived', rest_val);
        })();
    }
    ...
    set_command(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this27._setAttr('command', rest_val);
        })();
    }
    ...
    sendPUK(puk, newPin) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {string} **/
            let gsmMsg;
            gsmMsg = yield _this28.get_message();
            if (!(gsmMsg.substr(0, 13) == 'Enter SIM PUK')) {
                return _this28._throw(_this28._yapi.INVALID_ARGUMENT, 'PUK not expected at this time', _this28._yapi.INVALID_ARGUMENT);
            }
            if (newPin == '') {
                return yield _this28.set_command('AT+CPIN=' + puk + ',0000;+CLCK=SC,0,0000');
            }
            return yield _this28.set_command('AT+CPIN=' + puk + ',' + newPin);
        })();
    }
    ...
    set_apnAuth(username, password) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this29.set_apnSecret(username + ',' + password);
        })();
    }
    ...
    clearDataCounters() {
        ...
        return _asyncToGenerator(function* () {
            ...
            retcode = yield _this30.set_dataReceived(0);
            if (retcode != _this30._yapi.SUCCESS) {
                return retcode;
            }
            retcode = yield _this30.set_dataSent(0);
            return retcode;
        })();
    }
    ...
    _AT(cmd) {
        ...
        return _asyncToGenerator(function* () {
            ...
            waitMore = 24;
            while (waitMore > 0) {
                buff = yield _this31._download(cmd);
                bufflen = buff.length;
                buffstr = _this31._yapi.imm_bin2str(buff);
    ...
    quickCellSurvey() {
        ...
        return _asyncToGenerator(function* () {
            ...
            moni = yield _this33._AT('+CCED=0;#MONI=7;#MONI');
            ...
            mcc = _this33._yapi.imm_atoi(mccs);
            ...
            mnc = _this33._yapi.imm_atoi(mncs);
            recs = moni.split('#');
            ...
            for (let ii in recs) {
                ...
                if (llen >= 44) {
                    if (recs[ii].substr(41, 3) == 'dbm') {
                        ...
                        dbm = _this33._yapi.imm_atoi(dbms);
                        if (llen > 66) {
                            tads = recs[ii].substr(54, 2);
                            if (tads.substr(0, 1) == ' ') {
                                tads = tads.substr(1, 3);
                            }
                            tad = _this33._yapi.imm_atoi(tads);
