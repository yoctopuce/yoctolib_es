    ...
    get_dataStreams(v) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (Array.isArray(loadval[0])) {
                ...
                var sets = yield _this5.parse_dataSets(JSON.stringify(loadval));
                for (var i = 0; i < sets.length; i++) {
                    var ds = yield sets[i].get_privateDataStreams();
