/*********************************************************************
 *
 * $Id: yocto_buzzer.js 27092 2017-04-06 20:59:34Z seb $
 *
...
class YBuzzer extends _yocto_api.YFunction {
    ...
    addNotesToPlaySeq(notes) {
        ...
        return _asyncToGenerator(function* () {
            ...
            num = 0;
            typ = 3;
            ascNotes = _this15._yapi.imm_str2bin(notes);
            ...
            while (i < notesLen) {
                ...
                if ((ch == 32 || i + 1 == notesLen) && (note > -99 || typ != 3)) {
                    ...
                    if (typ == 0) {
                        yield _this15.addPulseToPlaySeq(0, ms);
                    } else {
                        ...
                        if (typ == 5) {
                            yield _this15.addPulseToPlaySeq(prevFreq, ms16);
                            yield _this15.addFreqMoveToPlaySeq(freq, 8 * ms16);
                            yield _this15.addPulseToPlaySeq(freq, ms - 9 * ms16);
                        } else {
                            yield _this15.addPulseToPlaySeq(freq, ms - rest);
                            if (rest > 0) {
                                yield _this15.addPulseToPlaySeq(0, rest);
                            }
                        }
                        prevFreq = freq;
                        prevPitch = pitch;
    ...
    startPlaySeq() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this16.sendCommand('S');
        })();
    }
    ...
    stopPlaySeq() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this17.sendCommand('X');
        })();
    }
    ...
    resetPlaySeq() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this18.sendCommand('Z');
        })();
    }
    ...
    oncePlaySeq() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this19.sendCommand('s');
        })();
    }
    ...
    pulse(frequency, duration) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this20.set_command('P' + String(Math.round(frequency)) + ',' + String(Math.round(duration)));
        })();
    }
    ...
    freqMove(frequency, duration) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this21.set_command('F' + String(Math.round(frequency)) + ',' + String(Math.round(duration)));
        })();
    }
    ...
    volumeMove(volume, duration) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this22.set_command('V' + String(Math.round(volume)) + ',' + String(Math.round(duration)));
        })();
    }
    ...
    playNotes(notes) {
        ...
        return _asyncToGenerator(function* () {
            yield _this23.resetPlaySeq();
            yield _this23.addNotesToPlaySeq(notes);
            return yield _this23.oncePlaySeq();
        })();
    }
