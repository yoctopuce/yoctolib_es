/*********************************************************************
 *
 * $Id: yocto_spiport.js 26669 2017-02-28 13:40:47Z seb $
 *
...
exports.YSpiPortProxy = exports.YSpiPort = exports.Y_SPIMODE_INVALID = exports.Y_PROTOCOL_INVALID = exports.Y_COMMAND_INVALID = exports.Y_STARTUPJOB_INVALID = exports.Y_CURRENTJOB_INVALID = exports.Y_LASTMSG_INVALID = exports.Y_TXMSGCOUNT_INVALID = exports.Y_RXMSGCOUNT_INVALID = exports.Y_ERRCOUNT_INVALID = exports.Y_TXCOUNT_INVALID = exports.Y_RXCOUNT_INVALID = exports.Y_SHITFTSAMPLING_INVALID = exports.Y_SHITFTSAMPLING_ON = exports.Y_SHITFTSAMPLING_OFF = exports.Y_SSPOLARITY_INVALID = exports.Y_SSPOLARITY_ACTIVE_HIGH = exports.Y_SSPOLARITY_ACTIVE_LOW = exports.Y_VOLTAGELEVEL_INVALID = exports.Y_VOLTAGELEVEL_RS485 = exports.Y_VOLTAGELEVEL_RS232 = exports.Y_VOLTAGELEVEL_TTL5VR = exports.Y_VOLTAGELEVEL_TTL5V = exports.Y_VOLTAGELEVEL_TTL3VR = exports.Y_VOLTAGELEVEL_TTL3V = exports.Y_VOLTAGELEVEL_OFF = undefined;
exports.yFindSpiPort = yFindSpiPort;
exports.yFirstSpiPort = yFirstSpiPort;
...
var Y_SSPOLARITY_ACTIVE_LOW = exports.Y_SSPOLARITY_ACTIVE_LOW = 0;
var Y_SSPOLARITY_ACTIVE_HIGH = exports.Y_SSPOLARITY_ACTIVE_HIGH = 1;
var Y_SSPOLARITY_INVALID = exports.Y_SSPOLARITY_INVALID = -1;
var Y_SHITFTSAMPLING_OFF = exports.Y_SHITFTSAMPLING_OFF = 0;
var Y_SHITFTSAMPLING_ON = exports.Y_SHITFTSAMPLING_ON = 1;
var Y_SHITFTSAMPLING_INVALID = exports.Y_SHITFTSAMPLING_INVALID = -1;
...
var Y_SPIMODE_INVALID = exports.Y_SPIMODE_INVALID = _yocto_api.YAPI.INVALID_STRING;
...
class YSpiPort extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {string} **/
        this._spiMode = Y_SPIMODE_INVALID;
        /** @member {number} **/
        this._ssPolarity = Y_SSPOLARITY_INVALID;
        /** @member {number} **/
        this._shitftSampling = Y_SHITFTSAMPLING_INVALID;
        /** @member {number} **/
        this._rxptr = 0;
        /** @member {Uint8Array} **/
        ...
        this.imm_setConst({
            ...
            SPIMODE_INVALID: _yocto_api.YAPI.INVALID_STRING,
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            ...
            var res = new YSpiPortProxy(_this);
    ...
    set_spiMode(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this19._setAttr('spiMode', rest_val);
        })();
    }
    ...
    set_ssPolarity(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this21._setAttr('ssPolarity', rest_val);
        })();
    }
    ...
    set_shitftSampling(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this23._setAttr('shitftSampling', rest_val);
        })();
    }
    ...
    static FindSpiPort(func) {
        /** @type {YFunction} **/
        let obj;
        obj = _yocto_api.YFunction._FindFromCache('SpiPort', func);
        if (obj == null) {
            obj = new YSpiPort(_yocto_api.YAPI, func);
            _yocto_api.YFunction._AddToCache('SpiPort', func, obj);
        }
        return obj;
    }
    ...
    static FindSpiPortInContext(yctx, func) {
        /** @type {YFunction} **/
        let obj;
        obj = _yocto_api.YFunction._FindFromCacheInContext(yctx, 'SpiPort', func);
        if (obj == null) {
    ...
    sendCommand(text) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this24.set_command(text);
        })();
    }
    ...
    reset() {
        ...
        return _asyncToGenerator(function* () {
            _this25._rxptr = 0;
            _this25._rxbuffptr = 0;
            _this25._rxbuff = new Uint8Array(0);
            // may throw an exception
            return yield _this25.sendCommand('Z');
        })();
    }
    ...
    writeByte(code) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this26.sendCommand('$' + ('00' + code.toString(16)).slice(-2));
        })();
    }
    ...
    writeArray(byteList) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            res = yield _this29._upload('txdata', buff);
            return res;
        })();
    }
    ...
    writeHex(hexString) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            res = yield _this30._upload('txdata', buff);
            return res;
        })();
    }
    ...
    writeLine(text) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {number} **/
            let ch;
            buff = _this31._yapi.imm_str2bin(text + '\r\n');
            ...
            if (bufflen < 100) {
                ...
                if (idx >= bufflen) {
                    return yield _this31.sendCommand('!' + text);
                }
            }
            // send string using file upload
            return yield _this31._upload('txdata', buff);
        })();
    }
    ...
    readByte() {
        ...
        return _asyncToGenerator(function* () {
            ...
            bufflen = _this32._rxbuff.length;
            if (_this32._rxptr >= _this32._rxbuffptr && _this32._rxptr < _this32._rxbuffptr + bufflen) {
                res = _this32._rxbuff[_this32._rxptr - _this32._rxbuffptr];
                _this32._rxptr = _this32._rxptr + 1;
                return res;
            }

            // try to preload more than one byte to speed-up byte-per-byte access
            currpos = _this32._rxptr;
            reqlen = 1024;
            buff = yield _this32.readBin(reqlen);
            bufflen = buff.length;
            if (_this32._rxptr == currpos + bufflen) {
                res = buff[0];
                _this32._rxptr = currpos + 1;
                _this32._rxbuffptr = currpos;
                _this32._rxbuff = buff;
                return res;
            }
            // mixed bidirectional data, retry with a smaller block
            _this32._rxptr = currpos;
            reqlen = 16;
            buff = yield _this32.readBin(reqlen);
            bufflen = buff.length;
            if (_this32._rxptr == currpos + bufflen) {
            ...
            // may throw an exception
            buff = yield _this32._download('rxdata.bin?pos=' + String(Math.round(_this32._rxptr)) + '&len=1');
            ...
            if (bufflen == 0) {
                return _this32._yapi.NO_MORE_DATA;
            }
            res = buff[0];
            return res;
        })();
    ...
    readStr(nChars) {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this33._yapi.imm_bin2str(buff).substr(0, bufflen);
            return res;
        })();
    }
    ...
    readArray(nChars) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            buff = yield _this35._download('rxdata.bin?pos=' + String(Math.round(_this35._rxptr)) + '&len=' + String(Math.round(nChars)));
            bufflen = buff.length - 1;
            endpos = 0;
            mult = 1;
            while (bufflen > 0 && buff[bufflen] != 64) {
    ...
    readHex(nBytes) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            buff = yield _this36._download('rxdata.bin?pos=' + String(Math.round(_this36._rxptr)) + '&len=' + String(Math.round(nBytes)));
            bufflen = buff.length - 1;
            endpos = 0;
            mult = 1;
            while (bufflen > 0 && buff[bufflen] != 64) {
    ...
    readLine() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            url = 'rxmsg.json?pos=' + String(Math.round(_this37._rxptr)) + '&len=1&maxw=1';
            ...
            res = _this37.imm_json_get_string(_this37._yapi.imm_str2bin(msgarr[0]));
            return res;
        })();
    }
    ...
    readMessages(pattern, maxWait) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let idx;
            // may throw an exception
            url = 'rxmsg.json?pos=' + String(Math.round(_this38._rxptr)) + '&maxw=' + String(Math.round(maxWait)) + '&pat=' + pattern;
            ...
            idx = 0;
            while (idx < msglen) {
                res.push(_this38.imm_json_get_string(_this38._yapi.imm_str2bin(msgarr[idx])));
                idx = idx + 1;
            }
            return res;
        })();
    ...
    read_avail() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            buff = yield _this41._download('rxcnt.bin?pos=' + String(Math.round(_this41._rxptr)));
            bufflen = buff.length - 1;
            while (bufflen > 0 && buff[bufflen] != 64) {
                bufflen = bufflen - 1;
            }
            res = _this41._yapi.imm_atoi(_this41._yapi.imm_bin2str(buff).substr(0, bufflen));
            return res;
        })();
    }
    ...
    queryLine(query, maxWait) {
        ...
        return _asyncToGenerator(function* () {
            ...
            msgbin = yield _this42._download(url);
            msgarr = _this42.imm_json_get_array(msgbin);
            msglen = msgarr.length;
            if (msglen == 0) {
                return '';
            }
            // last element of array is the new position
            msglen = msglen - 1;
            _this42._rxptr = _this42._yapi.imm_atoi(msgarr[msglen]);
            if (msglen == 0) {
                return '';
            }
            res = _this42.imm_json_get_string(_this42._yapi.imm_str2bin(msgarr[0]));
            return res;
        })();
    }
    ...
    uploadJob(jobfile, jsonDef) {
        ...
        return _asyncToGenerator(function* () {
            yield _this43._upload(jobfile, _this43._yapi.imm_str2bin(jsonDef));
            return _this43._yapi.SUCCESS;
        })();
    }
    ...
    selectJob(jobfile) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this44.set_currentJob(jobfile);
        })();
    }
    ...
    set_SS(val) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this45.sendCommand('S' + String(Math.round(val)));
        })();
    }
    ...
    static FirstSpiPort() {
        /** @type {string|null} **/
        let next_hwid = _yocto_api.YAPI.imm_getFirstHardwareId('SpiPort');
        if (next_hwid == null) return null;
...
class YSpiPortProxy extends _yocto_api.YFunctionProxy {
    ...
    _asyncInit() {
        ...
        return _asyncToGenerator(function* () {
            _this46.liveFunc._nextByte = _yocto_api.YAPI.NO_MORE_DATA;
            _this46.liveFunc._nextStr = null;
            _this46.liveFunc._nextBin = null;
            _this46.liveFunc._nextArray = null;
            _this46.liveFunc._nextHex = null;
            _this46.liveFunc._nextLine = null;
            _this46.liveFunc._nextMessages = null;
            _this46.liveFunc._nextAvail = null;
        })();
    }
    ...
    readByte() {
        ...
        if (res == _yocto_api.YAPI.NO_MORE_DATA) {
            this.liveFunc.readByte().then(function (nextByte) {
                _this47.liveFunc._nextByte = nextByte;
            });
        } else {
    ...
    readStr(nChars) {
        ...
        if (!res) {
            this.liveFunc.readStr(nChars).then(function (nextStr) {
                _this48.liveFunc._nextStr = nextStr;
            });
            res = '';
        } else {
    ...
    readBin(nChars) {
        ...
        if (!res) {
            this.liveFunc.readBin(nChars).then(function (nextBin) {
                _this49.liveFunc._nextBin = nextBin;
            });
    ...
    readArray(nChars) {
        ...
        if (!res) {
            this.liveFunc.readArray(nChars).then(function (nextArray) {
                _this50.liveFunc._nextArray = nextArray;
            });
            res = [];
        } else {
    ...
    readHex(nBytes) {
        ...
        if (!res) {
            this.liveFunc.readHex(nBytes).then(function (nextHex) {
                _this51.liveFunc._nextHex = nextHex;
            });
            res = '';
        } else {
    ...
    readLine() {
        ...
        if (!res) {
            this.liveFunc.readLine().then(function (nextLine) {
                _this52.liveFunc._nextLine = nextLine;
            });
            res = '';
        } else {
    ...
    readMessages(pattern, maxWait) {
        ...
        if (!res) {
            this.liveFunc.readMessages(pattern, maxWait).then(function (nextMessages) {
                _this53.liveFunc._nextMessages = nextMessages;
            });
            res = [];
        } else {
    ...
    /**
     * Changes the current internal stream position to the specified value. This function
     * does not affect the device, it only changes the value stored in the YSpiPort object
     * for the next read operations.
     *
     * @param absPos {number} : the absolute position index for next read operations.
     *
    ...
    /**
     * Returns the current absolute stream position pointer of the YSpiPort object.
     *
     * @return {number} the absolute position index for next read operations.
     */
    read_tell() {
    ...
    /**
     * Returns the number of bytes available to read in the input buffer starting from the
     * current absolute stream position pointer of the YSpiPort object.
     *
     * @return {number} the number of bytes available to read
     */
    read_avail() {
        ...
        if (!res) {
            this.liveFunc.read_avail().then(function (nextAvail) {
                _this54.liveFunc._nextAvail = nextAvail;
            });
            res = '';
        } else {
...
exports.YSpiPortProxy = YSpiPortProxy; //--- (generated code: SpiPort functions)
