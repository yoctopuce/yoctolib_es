...
class YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return new YFunctionProxy(_this7);
        })();
    }
...
class YModule extends YFunction {
    ...
    loadUrl(str_url) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!dev) return null;
            /** @type {YHTTPRequest} **/
            let yreq = yield _this48._yapi.devRequest(dev.imm_getRootUrl(), 'GET ' + str_url);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this48._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    get_logicalName() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            var dev = _this49.imm_getDev();
            if (dev != null && _this49._cache._expiration <= _this49._yapi.GetTickCount()) {
                return dev._logicalName;
            }
            /** @type {string|null} **/
            var json_val = yield _this49._getAttr('logicalName');
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this50._cacheExpiration <= _this50._yapi.GetTickCount()) {
                yield _this50.load(_this50._yapi.defaultCacheValidity);
            }
            return new YModuleProxy(_this50);
        })();
    }
    ...
    get_productRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this54._productRelease;
        })();
    }
    ...
    get_firmwareRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this55._firmwareRelease;
        })();
    }
    ...
    get_persistentSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this56._persistentSettings;
        })();
    }
    ...
    set_persistentSettings(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this57._setAttr('persistentSettings', rest_val);
        })();
    }
    ...
    set_luminosity(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this59._setAttr('luminosity', rest_val);
        })();
    }
    ...
    set_beacon(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this61._setAttr('beacon', rest_val);
        })();
    }
    ...
    get_usbCurrent() {
        ...
        return _asyncToGenerator(function* () {
            if (_this63._cacheExpiration <= _this63._yapi.GetTickCount()) {
                if ((yield _this63.load(_this63._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_USBCURRENT_INVALID;
                }
            }
            return _this63._usbCurrent;
        })();
    }
    ...
    get_rebootCountdown() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this64._rebootCountdown;
        })();
    }
    ...
    set_rebootCountdown(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this65._setAttr('rebootCountdown', rest_val);
        })();
    }
    ...
    set_userVar(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this67._setAttr('userVar', rest_val);
        })();
    }
    ...
    saveToFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this68.set_persistentSettings(Y_PERSISTENTSETTINGS_SAVED);
        })();
    }
    ...
    revertFromFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this69.set_persistentSettings(Y_PERSISTENTSETTINGS_LOADED);
        })();
    }
    ...
    reboot(secBeforeReboot) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this70.set_rebootCountdown(secBeforeReboot);
        })();
    }
    ...
    triggerFirmwareUpdate(secBeforeReboot) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this71.set_rebootCountdown(-secBeforeReboot);
        })();
    }
    ...
    checkFirmware(path, onlynew) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let tmp_res;
            if (onlynew) {
                release = _this72._yapi.imm_atoi((yield _this72.get_firmwareRelease()));
            } else {
                release = 0;
            }
            //may throw an exception
            serial = yield _this72.get_serialNumber();
            tmp_res = yield YFirmwareUpdate.CheckFirmware(serial, path, release);
            if (tmp_res.indexOf('error:') == 0) {
                _this72._throw(YAPI_INVALID_ARGUMENT, tmp_res);
            }
            return tmp_res;
        })();
    }
    ...
    updateFirmware(path) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let settings;
            // may throw an exception
            serial = yield _this73.get_serialNumber();
            settings = yield _this73.get_allSettings();
            if (settings.length == 0) {
                _this73._throw(YAPI_IO_ERROR, 'Unable to get device settings');
                settings = _this73._yapi.imm_str2bin('error:Unable to get device settings');
            }
    ...
    get_allSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let templist = [];
            // may throw an exception
            settings = yield _this74._download('api.json');
            if (settings.length == 0) {
                return settings;
            }
            ext_settings = ', "extras":[';
            templist = yield _this74.get_functionIds('Temperature');
            sep = '';
            for (let ii in templist) {
                if (_this74._yapi.imm_atoi((yield _this74.get_firmwareRelease())) > 9000) {
                    url = 'api/' + templist[ii] + '/sensorType';
                    t_type = _this74._yapi.imm_bin2str((yield _this74._download(url)));
                    if (t_type == 'RES_NTC') {
                        id = templist[ii].substr(11, templist[ii].length - 11);
                        temp_data_bin = yield _this74._download('extra.json?page=' + id);
                        if (temp_data_bin.length == 0) {
                            return temp_data_bin;
                        }
                        item = sep + '{"fid":"' + templist[ii] + '", "json":' + _this74._yapi.imm_bin2str(temp_data_bin) + '}\n';
            ...
            if (yield _this74.hasFunction('files')) {
                json = yield _this74._download('files.json?a=dir&f=');
                if (json.length == 0) {
                    return json;
                }
                filelist = _this74.imm_json_get_array(json);
                sep = '';
                for (let ii in filelist) {
                    name = _this74.imm_json_get_key(_this74._yapi.imm_str2bin(filelist[ii]), 'name');
                    if (name.length == 0) {
                        return _this74._yapi.imm_str2bin(name);
                    }
                    file_data_bin = yield _this74._download(_this74.imm_escapeAttr(name));
                    file_data = _this74._yapi.imm_bin2hexstr(file_data_bin);
            ...
            ext_settings = ext_settings + ']}';
            res = _this74._yapi.imm_str2bin('{ "api":') + settings + _this74._yapi.imm_str2bin(ext_settings);
            return res;
        })();
    }
    ...
    loadThermistorExtra(funcId, jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            yield _this75._download(url);
            // add records in growing resistance value
            values = _this75.imm_json_get_array(_this75._yapi.imm_str2bin(jsonExtra));
            ofs = 0;
            size = values.length;
            while (ofs + 1 < size) {
                curr = values[ofs];
    ...
    set_extraSettings(jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let data;
            extras = _this76.imm_json_get_array(_this76._yapi.imm_str2bin(jsonExtra));
            for (let ii in extras) {
                functionId = _this76.imm_get_json_path(extras[ii], 'fid');
                functionId = _this76.imm_decode_json_string(functionId);
                data = _this76.imm_get_json_path(extras[ii], 'json');
                if (yield _this76.hasFunction(functionId)) {
                    yield _this76.loadThermistorExtra(functionId, data);
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    set_allSettingsAndFiles(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let json_extra;
            json = _this77._yapi.imm_bin2str(settings);
            json_api = _this77.imm_get_json_path(json, 'api');
            if (json_api == '') {
                return yield _this77.set_allSettings(settings);
            }
            json_extra = _this77.imm_get_json_path(json, 'extras');
            if (!(json_extra == '')) {
                yield _this77.set_extraSettings(json_extra);
            }
            yield _this77.set_allSettings(_this77._yapi.imm_str2bin(json_api));
            if (yield _this77.hasFunction('files')) {
                /** @type {string[]} **/
                let files = [];
                /** @type {string} **/
                let res;
                ...
                /** @type {string} **/
                let data;
                down = yield _this77._download('files.json?a=format');
                res = _this77.imm_get_json_path(_this77._yapi.imm_bin2str(down), 'res');
                res = _this77.imm_decode_json_string(res);
                if (!(res == 'ok')) {
                    return _this77._throw(YAPI_IO_ERROR, 'format failed', YAPI_IO_ERROR);
                }
                json_files = _this77.imm_get_json_path(json, 'files');
                files = _this77.imm_json_get_array(_this77._yapi.imm_str2bin(json_files));
                for (let ii in files) {
                    name = _this77.imm_get_json_path(files[ii], 'name');
                    name = _this77.imm_decode_json_string(name);
                    data = _this77.imm_get_json_path(files[ii], 'data');
                    data = _this77.imm_decode_json_string(data);
                    yield _this77._upload(name, _this77._yapi.imm_hexstr2bin(data));;
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    hasFunction(funcId) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let fid;
            // may throw an exception
            count = yield _this78.functionCount();
            i = 0;
            while (i < count) {
                fid = yield _this78.functionId(i);
                if (fid == funcId) {
                    return true;
                }
                i = i + 1;
    ...
    get_functionIds(funType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res = [];
            // may throw an exception
            count = yield _this79.functionCount();
            i = 0;
            while (i < count) {
                ftype = yield _this79.functionType(i);
                if (ftype == funType) {
                    res.push((yield _this79.functionId(i)));
                } else {
                    ftype = yield _this79.functionBaseType(i);
                    if (ftype == funType) {
                        res.push((yield _this79.functionId(i)));
                    }
                }
    ...
    calibScale(unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (unit_name == 'C') {
                ...
                if (_this80._yapi.imm_atoi(sensorType) < 8) {
                    return 16;
                } else {
                    return 100;
                }
    ...
    calibConvert(param, currentFuncValue, unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            paramVer = yield _this81.calibVersion(param);
            funVer = yield _this81.calibVersion(currentFuncValue);
            funScale = yield _this81.calibScale(unit_name, sensorType);
            funOffset = yield _this81.calibOffset(unit_name);
            paramScale = funScale;
            paramOffset = funOffset;
            if (funVer < 3) {
                if (funVer == 2) {
                    words = _this81._yapi.imm_decodeWords(currentFuncValue);
                    ...
                    if (funVer == 1) {
                        if (currentFuncValue == '' || _this81._yapi.imm_atoi(currentFuncValue) > 10) {
                            funScale = 0;
                        }
                    }
                }
            ...
            if (paramVer < 3) {
                if (paramVer == 2) {
                    words = _this81._yapi.imm_decodeWords(param);
                    if (words[0] == 1366 && words[1] == 12500) {
                        paramScale = 1;
                        paramOffset = 0;
                    } else {
                    ...
                    if (paramVer == 1) {
                        ...
                        for (let ii in words_str) {
                            words.push(_this81._yapi.imm_atoi(words_str[ii]));
                        }
                        if (param == '' || words[0] > 10) {
                            paramScale = 0;
                        }
                ...
                while (i < calibData.length) {
                    if (paramScale > 0) {
                        ...
                        calibData[i] = _this81._yapi.imm_decimalToDouble(Math.round(calibData[i]));
                    }
                    i = i + 1;
                }
            } else {
                iCalib = _this81._yapi.imm_decodeFloats(param);
            ...
            if (funVer >= 3) {
                ...
                if (funVer >= 1) {
                    ...
                    while (i < 2 * nPoints) {
                        if (funScale == 0) {
                            wordVal = _this81._yapi.imm_doubleToDecimal(Math.round(calibData[i]));
                        } else {
    ...
    set_allSettings(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {boolean} **/
            let found;
            tmp = _this82._yapi.imm_bin2str(settings);
            tmp = _this82.imm_get_json_path(tmp, 'api');
            if (!(tmp == '')) {
                settings = _this82._yapi.imm_str2bin(tmp);
            }
            oldval = '';
            newval = '';
            old_json_flat = _this82.imm_flattenJsonStruct(settings);
            old_dslist = _this82.imm_json_get_array(old_json_flat);
            for (let ii in old_dslist) {
                each_str = _this82.imm_json_get_string(_this82._yapi.imm_str2bin(old_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this82._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            // may throw an exception
            actualSettings = yield _this82._download('api.json');
            actualSettings = _this82.imm_flattenJsonStruct(actualSettings);
            new_dslist = _this82.imm_json_get_array(actualSettings);
            for (let ii in new_dslist) {
                each_str = _this82.imm_json_get_string(_this82._yapi.imm_str2bin(new_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this82._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            while (i < new_jpath.length) {
                ...
                if (do_update) {
                    if (attr == 'calibrationParam') {
                        ...
                        newval = yield _this82.calibConvert(old_calib, new_val_arr[i], unit_name, sensorType);
                        url = 'api/' + fun + '.json?' + attr + '=' + _this82.imm_escapeAttr(newval);
                        yield _this82._download(url);
                    } else {
                        url = 'api/' + fun + '.json?' + attr + '=' + _this82.imm_escapeAttr(oldval);
                        if (attr == 'resolution') {
            ...
            for (let ii in restoreLast) {
                yield _this82._download(restoreLast[ii]);;
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    download(pathname) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this83._download(pathname);
        })();
    }
    ...
    get_icon2d() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this84._download('icon2d.png');
        })();
    }
    ...
    get_lastLogs() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let content;
            // may throw an exception
            content = yield _this85._download('logs.txt');
            return _this85._yapi.imm_bin2str(content);
        })();
    }
...
class YSensor extends YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this86._cacheExpiration <= _this86._yapi.GetTickCount()) {
                yield _this86.load(_this86._yapi.defaultCacheValidity);
            }
            return new YSensorProxy(_this86);
        })();
    }
    ...
    get_currentValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = yield _this88._applyCalibration(_this88._currentRawValue);
            if (res == Y_CURRENTVALUE_INVALID) {
                res = _this88._currentValue;
            }
            res = res * _this88._iresol;
            return Math.round(res) / _this88._iresol;
        })();
    }
    ...
    set_lowestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this89._setAttr('lowestValue', rest_val);
        })();
    }
    ...
    get_lowestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this90._lowestValue * _this90._iresol;
    ...
    set_highestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this91._setAttr('highestValue', rest_val);
        })();
    }
    ...
    get_highestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this92._highestValue * _this92._iresol;
    ...
    get_currentRawValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this93._currentRawValue;
        })();
    }
    ...
    set_logFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this95._setAttr('logFrequency', rest_val);
        })();
    }
    ...
    get_reportFrequency() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this96._reportFrequency;
        })();
    }
    ...
    set_reportFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this97._setAttr('reportFrequency', rest_val);
        })();
    }
    ...
    get_calibrationParam() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this98._calibrationParam;
        })();
    }
    ...
    set_calibrationParam(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this99._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    set_resolution(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this100._setAttr('resolution', rest_val);
        })();
    }
    ...
    _parserHelper() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this103._caltyp = -1;
            _this103._scale = -1;
            _this103._isScal32 = false;
            _this103._calpar.length = 0;
            _this103._calraw.length = 0;
            _this103._calref.length = 0;
            // Store inverted resolution, to provide better rounding
            if (_this103._resolution > 0) {
                _this103._iresol = Math.round(1.0 / _this103._resolution);
            } else {
                _this103._iresol = 10000;
                _this103._resolution = 0.0001;
            }
            // Old format: supported when there is no calibration
            if (_this103._calibrationParam == '' || _this103._calibrationParam == '0') {
                _this103._caltyp = 0;
                return 0;
            }
            if (_this103._calibrationParam.indexOf(',') >= 0) {
                iCalib = _this103._yapi.imm_decodeFloats(_this103._calibrationParam);
                _this103._caltyp = parseInt(iCalib[0] / 1000, 10);
                if (_this103._caltyp > 0) {
                    if (_this103._caltyp < YOCTO_CALIB_TYPE_OFS) {
                        _this103._caltyp = -1;
                        return 0;
                    }
                    _this103.imm_calhdl = _this103._yapi.imm_getCalibrationHandler(_this103._caltyp);
                    if (!(_this103.imm_calhdl != null)) {
                        _this103._caltyp = -1;
                        return 0;
                    }
                }
                _this103._isScal = true;
                _this103._isScal32 = true;
                _this103._offset = 0;
                _this103._scale = 1000;
                maxpos = iCalib.length;
                _this103._calpar.length = 0;
                position = 1;
                while (position < maxpos) {
                    _this103._calpar.push(iCalib[position]);
                    position = position + 1;
                }
                _this103._calraw.length = 0;
                _this103._calref.length = 0;
                ...
                while (position + 1 < maxpos) {
                    ...
                    fRef = fRef / 1000.0;
                    _this103._calraw.push(fRaw);
                    _this103._calref.push(fRef);
                    position = position + 2;
                }
            } else {
                iCalib = _this103._yapi.imm_decodeWords(_this103._calibrationParam);
                if (iCalib.length < 2) {
                    _this103._caltyp = -1;
                    return 0;
                }
                _this103._isScal = iCalib[1] > 0;
                if (_this103._isScal) {
                    _this103._offset = iCalib[0];
                    if (_this103._offset > 32767) {
                        _this103._offset = _this103._offset - 65536;
                    }
                    _this103._scale = iCalib[1];
                    _this103._decexp = 0;
                } else {
                    _this103._offset = 0;
                    _this103._scale = 1;
                    _this103._decexp = 1.0;
                    position = iCalib[0];
                    while (position > 0) {
                        _this103._decexp = _this103._decexp * 10;
                        position = position - 1;
                    }
                }
                if (iCalib.length == 2) {
                ...
                _this103._caltyp = iCalib[2];
                _this103.imm_calhdl = _this103._yapi.imm_getCalibrationHandler(_this103._caltyp);
                if (_this103._caltyp <= 10) {
                    maxpos = _this103._caltyp;
                } else {
                    if (_this103._caltyp <= 20) {
                        maxpos = _this103._caltyp - 10;
                    } else {
                        maxpos = 5;
                    }
                }
                ...
                while (position + 1 < maxpos) {
                    ...
                    _this103._calpar.push(iRaw);
                    _this103._calpar.push(iRef);
                    if (_this103._isScal) {
                        fRaw = iRaw;
                        fRaw = (fRaw - _this103._offset) / _this103._scale;
                        fRef = iRef;
                        fRef = (fRef - _this103._offset) / _this103._scale;
                        _this103._calraw.push(fRaw);
                        _this103._calref.push(fRef);
                    } else {
                        _this103._calraw.push(_this103._yapi.imm_decimalToDouble(iRaw));
                        _this103._calref.push(_this103._yapi.imm_decimalToDouble(iRef));
                    }
                    position = position + 2;
                }
            }
    ...
    isSensorReady() {
        ...
        return _asyncToGenerator(function* () {
            if (!(yield _this104.isOnline())) {
                return false;
            }
            if (!(_this104._sensorState == 0)) {
                return false;
            }
            return true;
        })();
    ...
    startDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this105._download('api/dataLogger/recording?recording=1');
            if (!(res.length > 0)) {
                return _this105._throw(YAPI_IO_ERROR, 'unable to start datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    stopDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this106._download('api/dataLogger/recording?recording=0');
            if (!(res.length > 0)) {
                return _this106._throw(YAPI_IO_ERROR, 'unable to stop datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    get_recordedData(startTime, endTime) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let funit;
            // may throw an exception
            funcid = yield _this107.get_functionId();
            funit = yield _this107.get_unit();
            return new YDataSet(_this107, funcid, funit, startTime, endTime);
        })();
    }
    ...
    registerTimedReportCallback(callback) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this108._timedReportCallbackSensor = callback;
            return 0;
        })();
    }
    ...
    _invokeTimedReportCallback(value) {
        ...
        return _asyncToGenerator(function* () {
            if (_this109._timedReportCallbackSensor != null) {
                yield _this109._timedReportCallbackSensor(_this109, value);
            } else {}
            return 0;
        })();
    }
    ...
    calibrateFromPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            // may throw an exception
            rest_val = yield _this110._encodeCalibrationPoints(rawValues, refValues);
            return yield _this110._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    loadCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this111._scale == 0) {
                if ((yield _this111.load(_this111._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_DEVICE_NOT_FOUND;
                }
            }
            if (_this111._caltyp < 0) {
                _this111._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return YAPI_NOT_SUPPORTED;
            }
            rawValues.length = 0;
            refValues.length = 0;
            for (let ii in _this111._calraw) {
                rawValues.push(_this111._calraw[ii]);
            }
            for (let ii in _this111._calref) {
                refValues.push(_this111._calref[ii]);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    _encodeCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (npt != refValues.length) {
                _this112._throw(YAPI_INVALID_ARGUMENT, 'Invalid calibration parameters (size mismatch)');
            ...
            // Load function parameters if not yet loaded
            if (_this112._scale == 0) {
                if ((yield _this112.load(_this112._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_INVALID_STRING;
                }
            }
            // Detect old firmware
            if (_this112._caltyp < 0 || _this112._scale < 0) {
                _this112._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return '0';
            }
            if (_this112._isScal32) {
                ...
                if (_this112._isScal) {
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = Math.round(rawValues[idx] * _this112._scale + _this112._offset);
                        iRef = Math.round(refValues[idx] * _this112._scale + _this112._offset);
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = _this112._yapi.imm_doubleToDecimal(rawValues[idx]);
                        iRef = _this112._yapi.imm_doubleToDecimal(refValues[idx]);
                        res = res + ',' + String(Math.round(iRaw)) + ',' + String(Math.round(iRef));
                        idx = idx + 1;
                    }
                }
    ...
    _applyCalibration(rawValue) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!(_this113.imm_calhdl != null)) {
                return Y_CURRENTVALUE_INVALID;
            }
            return _this113.imm_calhdl(rawValue, _this113._caltyp, _this113._calpar, _this113._calraw, _this113._calref);
        })();
    }
    ...
    _decodeTimedReport(timestamp, report) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {number} **/
            let maxVal;
            startTime = _this114._prevTimedReport;
            endTime = timestamp;
            _this114._prevTimedReport = endTime;
            if (startTime == 0) {
                startTime = endTime;
            }
            if (report[0] == 2) {
                if (report.length <= 5) {
                    ...
                    if (_this114._caltyp != 0) {
                        if (_this114.imm_calhdl != null) {
                            avgVal = _this114.imm_calhdl(avgVal, _this114._caltyp, _this114._calpar, _this114._calraw, _this114._calref);
                        }
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                    ...
                    if (_this114._caltyp != 0) {
                        if (_this114.imm_calhdl != null) {
                            avgVal = _this114.imm_calhdl(avgVal, _this114._caltyp, _this114._calpar, _this114._calraw, _this114._calref);
                            minVal = _this114.imm_calhdl(minVal, _this114._caltyp, _this114._calpar, _this114._calraw, _this114._calref);
                            maxVal = _this114.imm_calhdl(maxVal, _this114._caltyp, _this114._calpar, _this114._calraw, _this114._calref);
                        }
                    }
                }
            } else {
                if (report[0] == 0) {
                    ...
                    if (_this114._isScal) {
                        avgVal = _this114.imm_decodeVal(avgRaw);
                    } else {
                        if ((byteVal & 0x80) != 0) {
                            avgRaw = avgRaw - poww;
                        }
                        avgVal = _this114.imm_decodeAvg(avgRaw);
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                } else {
                    ...
                    minVal = _this114.imm_decodeVal(minRaw);
                    avgVal = _this114.imm_decodeAvg(avgRaw);
                    maxVal = _this114.imm_decodeVal(maxRaw);
                }
            }
...
class YDataStream {
    ...
    loadStream() {
        ...
        return _asyncToGenerator(function* () {
            return _this115.imm_parseStream((yield _this115._parent._download(_this115.imm_get_url())));
        })();
    }
    ...
    get_startTime() {
        ...
        return _asyncToGenerator(function* () {
            return _this118._utcStamp - parseInt(+new Date() / 1000, 10);
        })();
    }
    ...
    get_dataSamplesIntervalMs() {
        ...
        return _asyncToGenerator(function* () {
            return parseInt(3600000 / _this120._samplesPerHour, 10);
        })();
    }
    ...
    get_dataSamplesInterval() {
        ...
        return _asyncToGenerator(function* () {
            return 3600.0 / _this121._samplesPerHour;
        })();
    }
    ...
    get_rowCount() {
        ...
        return _asyncToGenerator(function* () {
            if (_this122._nRows != 0 && _this122._isClosed) {
                return _this122._nRows;
            }
            yield _this122.loadStream();
            return _this122._nRows;
        })();
    }
    ...
    get_columnCount() {
        ...
        return _asyncToGenerator(function* () {
            if (_this123._nCols != 0) {
                return _this123._nCols;
            }
            yield _this123.loadStream();
            return _this123._nCols;
        })();
    }
    ...
    get_columnNames() {
        ...
        return _asyncToGenerator(function* () {
            if (_this124._columnNames.length != 0) {
                return _this124._columnNames;
            }
    ...
    get_duration() {
        ...
        return _asyncToGenerator(function* () {
            if (_this128._isClosed) {
                return _this128._duration;
            }
            return parseInt(+new Date() / 1000, 10) - _this128._utcStamp;
        })();
    }
    ...
    get_dataRows() {
        ...
        return _asyncToGenerator(function* () {
            if (_this129._values.length == 0 || !_this129._isClosed) {
                yield _this129.loadStream();
            }
            return _this129._values;
        })();
    }
    ...
    get_data(row, col) {
        ...
        return _asyncToGenerator(function* () {
            if (_this130._values.length == 0 || !_this130._isClosed) {
                yield _this130.loadStream();
            }
            if (row >= _this130._values.length) {
                return Y_DATA_INVALID;
            }
            if (col >= _this130._values[row].length) {
                return Y_DATA_INVALID;
            }
            return _this130._values[row][col];
        })();
    }
...
class YDataSet {
    ...
    processMore(progress, data) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let maxCol;
            // may throw an exception
            if (progress != _this131._progress) {
                return _this131._progress;
            }
            if (_this131._progress < 0) {
                strdata = _this131._yapi.imm_bin2str(data);
                if (strdata == '{}') {
                    _this131._parent._throw(YAPI_VERSION_MISMATCH, 'device firmware is too old');
                    return YAPI_VERSION_MISMATCH;
                }
                return yield _this131._parse(strdata);
            }
            stream = _this131._streams[_this131._progress];
            stream.imm_parseStream(data);
            dataRows = yield stream.get_dataRows();
            _this131._progress = _this131._progress + 1;
            if (dataRows.length == 0) {
                return yield _this131.get_progress();
            }
            ...
            for (let ii in dataRows) {
                if (tim >= _this131._startTime && (_this131._endTime == 0 || tim <= _this131._endTime)) {
                    _this131._measures.push(new YMeasure(tim - itv, tim, dataRows[ii][minCol], dataRows[ii][avgCol], dataRows[ii][maxCol]));
                }
                tim = tim + itv;
            }
    ...
    get_hardwareId() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YModule} **/
            let mo;
            if (!(_this133._hardwareId == '')) {
                return _this133._hardwareId;
            }
            mo = yield _this133._parent.get_module();
            _this133._hardwareId = (yield mo.get_serialNumber()) + '.' + (yield _this133.get_functionId());
            return _this133._hardwareId;
        })();
    }
    ...
    get_progress() {
        ...
        return _asyncToGenerator(function* () {
            if (_this138._progress < 0) {
                return 0;
            }
            // index not yet loaded
            if (_this138._progress >= _this138._streams.length) {
                return 100;
            }
            return parseInt((1 + (1 + _this138._progress) * 98) / (1 + _this138._streams.length), 10);
        })();
    }
    ...
    loadMore() {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YDataStream} **/
            let stream;
            if (_this139._progress < 0) {
                url = 'logger.json?id=' + _this139._functionId;
            } else {
                if (_this139._progress >= _this139._streams.length) {
                    return 100;
                } else {
                    stream = _this139._streams[_this139._progress];
                    url = stream.imm_get_url();
                }
            }
            return yield _this139.processMore(_this139._progress, (yield _this139._parent._download(url)));
        })();
    }
    ...
    get_measuresAt(measure) {
        ...
        return _asyncToGenerator(function* () {
            ...
            stream = null;
            for (let ii in _this142._streams) {
                if ((yield _this142._streams[ii].get_startTimeUTC()) == startUtc) {
                    stream = _this142._streams[ii];
                }
                ;;
            }
            if (stream == null) {
            ...
            for (let ii in dataRows) {
                if (tim >= _this142._startTime && (_this142._endTime == 0 || tim <= _this142._endTime)) {
    ...
    _parse(str_json) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!loadval) {
                // no data available
                _this144._progress = 0;
                return _this144;
            }

            _this144._functionId = loadval.id;
            _this144._unit = loadval.unit;
            if (loadval.calib) {
                _this144._calib = _this144._yapi.imm_decodeFloats(loadval.calib);
                _this144._calib[0] = parseInt(_this144._calib[0] / 1000);
            } else {
                _this144._calib = _this144._yapi.imm_decodeWords(loadval.cal);
            }
            _this144._summary = new YMeasure(0, 0, 0, 0, 0);
            _this144._streams = [];
            _this144._preview = [];
            _this144._measures = [];
            for (var i = 0; i < loadval.streams.length; i++) {
                var stream = _this144._parent.imm_findDataStream(_this144, loadval.streams[i]);
                ...
                if (_this144._startTime > 0 && streamEndTime <= _this144._startTime) {
                    // this stream is too early, drop it
                } else if (_this144._endTime > 0 && (yield stream.get_startTimeUTC()) > _this144._endTime) {
                        // this stream is too late, drop it
                    } else {
                            _this144._streams.push(stream);
                            ...
                            if (stream.isClosed() && (yield stream.get_startTimeUTC()) >= _this144._startTime && (_this144._endTime == 0 || streamEndTime <= _this144._endTime)) {
                                ...
                                _this144._preview.push(rec);
                            }
                        }
            }
            if (_this144._streams.length > 0 && summaryTotalTime > 0) {
                // update time boundaries with actual data
                if (_this144._startTime < startTime) {
                    _this144._startTime = startTime;
                }
                if (_this144._endTime == 0 || _this144._endTime > endTime) {
                    _this144._endTime = endTime;
                }
                _this144._summary = new YMeasure(_this144._startTime, _this144._endTime, summaryMinVal, summaryTotalAvg / summaryTotalTime, summaryMaxVal);
            }
            _this144._progress = 0;
            return _this144;
        })();
...
class YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this145.request('GET', _this145.urlInfo.url, '/api/module.json', null);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    hubUpdateDeviceList() {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YDevice} **/
            let hubDev = _this146._yapi.imm_getDevice(_this146.urlInfo.url);
            /** @type {number} **/
            let retcode = yield hubDev.refresh();
            if (retcode != YAPI_SUCCESS) {
                return _this146._throw(retcode, hubDev._lastErrorMsg, retcode);
            }
            /** @type {YHTTPRequest} **/
            let yreq = yield hubDev.requestAPI(_this146._yapi.defaultCacheValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
                return yreq;
            }
            let loadval = null;
            try {
                loadval = JSON.parse(_this146._yapi.imm_bin2str(yreq.bin_result));
            } catch (err) {}
            if (!loadval) {
                return _this146._throw(YAPI_IO_ERROR, 'Request failed, could not parse API result for ' + hubDev.imm_describe(), YAPI_IO_ERROR);
            }
            let whitePages = loadval['services']['whitePages'];
            let yellowPages = loadval['services']['yellowPages'];
            if (whitePages == undefined) {
                return _this146._throw(YAPI_INVALID_ARGUMENT, 'Device ' + hubDev.imm_describe() + ' is not a hub', YAPI_INVALID_ARGUMENT);
            }
            retcode = yield _this146._yapi.updateDeviceList_process(_this146, hubDev, whitePages, yellowPages);
            if (retcode != YAPI_SUCCESS) {
                return _this146._throw(_this146._yapi._lastErrorType, _this146._yapi._lastErrorMsg, _this146._yapi._lastErrorType);
            }

            // reset device list cache timeout for this hub
            _this146.devListExpires = _this146._yapi.GetTickCount() + _this146.devListValidity;
            return YAPI_SUCCESS;
        })();
    }
...
class YHttpHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this148.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '?len=' + _this148.notiflen.toString();
            if (_this148.notifPos > 0) {
                args += '&abs=' + _this148.notifPos.toString();
            }
            _this148.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this148.notbynRequest = new XMLHttpRequest();
                _this148.notbynRequest.open('GET', _this148.urlInfo.url + 'not.byn' + args, true, '', '');
                _this148.notbynRequest.overrideMimeType('text/plain; charset=x-user-defined');
                _this148.notbynRequest.onreadystatechange = function () {
                    if (_this148.disconnecting) {
                        return;
                    }
                    if (_this148.notbynRequest.readyState >= 3) {
                        resolve(YAPI_SUCCESS);
                        if (_this148.notbynRequest.readyState == 4 && parseInt(_this148.notbynRequest.status) != 200 && parseInt(_this148.notbynRequest.status) != 304) {
                            // connection error
                            if (_this148.retryDelay < 15000) _this148.retryDelay *= 2;
                            _this148.devListValidity = 500;
                            _this148.devListExpires = 0;
                            setTimeout(function () {
                                _this148.testHub(new YErrorMsg());
                            }, _this148.retryDelay);
                        } else {
                            // receiving data properly
                            if (_this148.notbynRequest.readyState == 3) {
                                // when using reconnection mode, ignore state 3
                                if (_this148.notiflen == 1) return;
                            }
                            let newlen = _this148.notbynRequest.responseText.length;
                            if (newlen > _this148.currPos) {
                                _this148._yapi.parseEvents(_this148, _this148.notbynRequest.responseText.substr(_this148.currPos, newlen - _this148.currPos));
                            }
                            // trigger immediately a new connection if closed in success
                            if (_this148.notbynRequest.readyState == 4 && parseInt(_this148.notbynRequest.status) != 0) {
                                _this148.currPos = 0;
                                _this148.testHub(new YErrorMsg());
                            }
                        }
                ...
                _this148.notbynRequest.send('');
            });
            return yield _this148.notbynOpenPromise;
        })();
    }
                ...
                httpRequest.onreadystatechange = function () {
                    if (httpRequest.readyState == 4) {
                        ...
                        if (httpRequest.status != 200 && httpRequest.status != 304) {
                            ...
                            yreq.bin_result = _this149._yapi.imm_str2bin(httpRequest.responseText);
                        }
                        resolve(yreq);
                    }
                };
...
class YHttpNodeHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this151.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '';
            if (_this151.notifPos > 0) {
                args = '?abs=' + _this151.notifPos.toString();
            }
            let options = {
                method: 'GET',
                hostname: _this151.urlInfo.host,
                port: _this151.urlInfo.port,
                path: '/not.byn' + args
            };
            _this151.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this151.notbynRequest = _this151.http.request(options, function (res) {
                    if (_this151.disconnecting) {
                        return;
                    }
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        if (_this151.retryDelay < 15000) _this151.retryDelay *= 2;
                        _this151.devListValidity = 500;
                        _this151.devListExpires = 0;
                        setTimeout(function () {
                        ...
                        res.on('data', function (chunk) {
                            // receiving data properly
                            _this151._yapi.parseEvents(_this151, _this151._yapi.imm_bin2str(chunk));
                        });
                        res.on('end', function () {
                            // trigger immediately a new connection if closed in success
                            _this151.currPos = 0;
                ...
                _this151.notbynRequest.on('error', function () {
                ...
                _this151.notbynRequest.end();
            });
            return yield _this151.notbynOpenPromise;
        })();
    }
    ...
    request(str_method, baseUrl, devUrl, obj_body) {
        ...
        return _asyncToGenerator(function* () {
            let options = {
                method: str_method,
                hostname: _this152.urlInfo.host,
                port: _this152.urlInfo.port,
                path: devUrl
            };
            let httpPromise = new Promise(function (resolve, reject) {
                let response = new Buffer(0);
                let httpRequest = _this152.http.request(options, function (res) {
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        let yreq = new YHTTPRequest(null);
                        yreq.errorType = YAPI_NOT_SUPPORTED;
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            _this153.imm_commonDisconnect();
            _this153.notbynRequest.abort();
        })();
    }
}
...
class YHttpCallbackHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            yield _this154.httpCallbackPromise;
            if (_this154._incomingMessage.method != 'POST') {
                errmsg.msg = 'HTTP POST expected';
                return YAPI_INVALID_ARGUMENT;
            }
            if (_this154._callbackData.length == 0) {
                errmsg.msg = 'Empty POST body';
                return YAPI_NO_MORE_DATA;
            }
            if (_this154.urlInfo.pass != '') {
                // callback data signed, verify signature
                if (!_this154._callbackCache.sign) {
                    errmsg.msg = 'missing signature from incoming YoctoHub (callback password required)';
                    _this154._callbackCache = [];
                    return YAPI_NO_MORE_DATA;
                }
                let sign = _this154._callbackCache['sign'];
                let pass = _this154.urlInfo.pass;
                let salt;
                if (pass.length == 32) {
                    salt = pass.toLowerCase();
                } else {
                    salt = _this154._yapi.imm_bin2hexstr(_this154._yapi.imm_yMD5(pass)).toLowerCase();
                }
                let patched = _this154._yapi.imm_bin2str(_this154._callbackData).replace(sign, salt);
                let check = _this154._yapi.imm_bin2hexstr(_this154._yapi.imm_yMD5(patched));
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_method == 'POST' && obj_body.length > 2) {
                ...
                if (endb > 2 && endb < 20 && obj_body[0] == 45 && obj_body[1] == 45) {
                    boundary = _this155._yapi.imm_bin2str(obj_body.subarray(2, endb));
                }
                _this155._serverResponse.write('\n@YoctoAPI:' + str_method + ' ' + devUrl + ' ' + obj_body.length + ':' + boundary + '\n');
                _this155._serverResponse.write(obj_body);
                ...
                if (devUrl.indexOf('?') == -1 || devUrl.indexOf('/logs.txt') != -1 || devUrl.indexOf('/logger.json') != -1 || devUrl.indexOf('/ping.txt') != -1 || devUrl.indexOf('/files.json?a=dir') != -1) {
                    ...
                    if (!_this155._callbackCache[devUrl]) {
                        ...
                        var jsonres = _this155._callbackCache[devUrl];
                        if (subfun) {
                            jsonres = jsonres[subfun[1]];
                        }
                        yreq.bin_result = _this155._yapi.imm_str2bin(JSON.stringify(jsonres));
                    }
                } else {
...
class YWebSocketHub extends YGenericHub {
    constructor(obj_yapi, var_urlInfo) {
        ...
        this._NB_TCP_CHANNEL = 8;
        this._HUB_TCP_CHANNEL = 1;
        this._DEVICE_TCP_CHANNEL = 0;
        this._DEVICE_ASYNC_TCP_CHANNEL = 2;
        this._WS_REQUEST_MAX_DURATION = 50000;
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this156.disconnecting || !_this156.websocket) {
                return YAPI_IO_ERROR;
            }
            // Open WebSocket connection
            _this156.imm_webSocketOpen(_this156.urlInfo.url + 'not.byn');
            _this156.websocketOpenPromise = new Promise(function (resolve, reject) {
                if (!_this156.websocket) {
                    resolve(YAPI_IO_ERROR);
                } else {
                    _this156.websocket.onmessage = function (evt) {
                        _this156._webSocketMsg(new Uint8Array(evt.data));
                        if (_this156._connectionState == _this156._WS_CONNECTED) {
                            resolve(YAPI_SUCCESS);
                        } else if (_this156._connectionState == _this156._WS_DEAD) {
                            console.log('WebSocket error: ' + _this156._session_error);
                            resolve(YAPI_IO_ERROR);
                        }
                    };
                }
            });
            _this156.websocket.onclose = function (evt) {
                _this156.websocket = null;
                if (_this156.retryDelay < 0) {
                    _this156.disconnecting = true;
                }
                if (_this156.disconnecting) {
                    return;
                }
                // connection error
                if (_this156.retryDelay < 15000) _this156.retryDelay *= 2;
                _this156.devListValidity = 500;
                _this156.devListExpires = 0;
                setTimeout(function () {
                    _this156.testHub(new YErrorMsg());
                }, _this156.retryDelay);
            };
            _this156.websocket.onerror = function (evt) {
                console.log('WebSocket error: ', evt);
                _this156.websocket.terminate();
                _this156.websocket = null;
                if (_this156.retryDelay < 0) {
                    _this156.disconnecting = true;
                }
            ...
            return yield _this156.websocketOpenPromise;
        })();
    }
    ...
    _webSocketMsg(arr_bytes) {
        ...
        return _asyncToGenerator(function* () {
            ...
            var text = '';
            if (ystream == _this157._YSTREAM_TCP_NOTIF) {
                for (let i = 1; i < arr_bytes.length; i++) {
                    text += String.fromCharCode(arr_bytes[i]);
                }
                yield _this157._yapi.parseEvents(_this157, text);
                return;
            }
            // Other types of messages
            var ws = _this157.websocket;
            var tcpchan = arr_bytes[0] & 7;
            if (ystream == _this157._YSTREAM_TCP || ystream == _this157._YSTREAM_TCP_CLOSE || ystream == _this157._YSTREAM_TCP_ASYNCCLOSE) {
                let tcp_end = arr_bytes.length;
                if (!_this157.tcpChan[tcpchan]) {
                    console.log('WS: Drop frame for closed tcpChan ' + tcpchan);
                    return;
                }
                if (ystream == _this157._YSTREAM_TCP_ASYNCCLOSE) {
                    // async close packet, check async signature byte
                    tcp_end--;
                    if (_this157.tcpChan[tcpchan].asyncId != arr_bytes[tcp_end]) {
                        console.log('WS: Incorrect async-close signature on tcpChan ' + tcpchan);
                    }
                }
                let oldArr = _this157.tcpChan[tcpchan].bin_result;
                let newArr = new Uint8Array(oldArr.length + tcp_end - 1);
                newArr.set(oldArr, 0);
                newArr.set(arr_bytes.subarray(1, tcp_end), oldArr.length);
                _this157.tcpChan[tcpchan].bin_result = newArr;

                // when the request is closed, post result to caller
                if (ystream == _this157._YSTREAM_TCP_CLOSE || ystream == _this157._YSTREAM_TCP_ASYNCCLOSE) {
                    if (ystream == _this157._YSTREAM_TCP_CLOSE) {
                        // regular close, ack by sending YSTREAM_TCP_CLOSE
                        let frame = new Uint8Array(1);
                        frame[0] = (_this157._YSTREAM_TCP_CLOSE << 3) + tcpchan;
                        _this157.websocket.send(frame);
                    }
                    // Pop request from tcp channel
                    let yreq = _this157.tcpChan[tcpchan];
                    _this157.tcpChan[tcpchan] = yreq.next;
                    ...
                    if (pos < 0) {
                        ...
                        let header = _this157._yapi.imm_bin2str(yreq.bin_result.subarray(0, pos));
                    ...
                    if (yreq.asyncId == 0) {
                        ...
                        if (yreq.errorType != YAPI_SUCCESS) {
                            console.log('WS async error: ' + yreq.errorMsg);
                        }
                    }
                }
                return;
            }
            if (ystream == _this157._YSTREAM_META) {
                let metatype = arr_bytes[1];
                switch (metatype) {
                    case _this157._USB_META_WS_ANNOUNCE:
                        if (arr_bytes.length < 1 + _this157._USB_META_WS_ANNOUNCE_SIZE) {
                            return;
                        }
                        _this157._remoteVersion = arr_bytes[2];
                        if (_this157._remoteVersion < 1) {
                            return;
                        }
                        // bytes 3 & 4 are reserved for future use
                        _this157._remoteNonce = arr_bytes[5] + (arr_bytes[6] << 8) + (arr_bytes[7] << 16) + (arr_bytes[8] << 24);
                        for (let i = 9; i < 9 + 20; i++) {
                            if (arr_bytes[i] == 0) {
                                _this157._remoteSerial = _this157._yapi.imm_bin2str(arr_bytes.subarray(9, i));
                                break;
                            }
                        }
                        _this157._nonce = parseInt(Math.random() * 0xffffffff);
                        _this157._connectionState = _this157._WS_AUTHENTICATING;
                        // send our authentication packet
                        let frame = new Uint8Array(1 + _this157._USB_META_WS_AUTHENTICATION_SIZE);
                        let version = 1,
                            flags = 0;
                        frame[0] = _this157._YSTREAM_META << 3;
                        frame[1] = _this157._USB_META_WS_AUTHENTICATION;
                        frame[2] = version;
                        if (_this157.urlInfo.pass != '') {
                            flags = _this157._USB_META_WS_VALID_SHA1;
                            let sha1 = _this157.imm_computeAuth(_this157.urlInfo.user, _this157.urlInfo.pass, _this157._remoteSerial, _this157._remoteNonce);
                        ...
                        frame[3] = flags & 0xff;
                        frame[4] = flags >>> 8;
                        frame[5] = _this157._nonce & 0xff;
                        frame[6] = _this157._nonce >>> 8 & 0xff;
                        frame[7] = _this157._nonce >>> 16 & 0xff;
                        frame[8] = _this157._nonce >>> 24 & 0xff;
                        _this157.websocket.send(frame);
                        break;
                    case _this157._USB_META_WS_AUTHENTICATION:
                        if (_this157._connectionState != _this157._WS_AUTHENTICATING) {
                            return;
                        }
                        if (arr_bytes.length < 1 + _this157._USB_META_WS_AUTHENTICATION_SIZE) {
                            return;
                        }
                        _this157._remoteVersion = arr_bytes[2];
                        if (_this157._remoteVersion < 1) {
                        ...
                        if ((inflags & _this157._USB_META_WS_VALID_SHA1) != 0) {
                            let remote_sha1 = arr_bytes.subarray(9, 29);
                            let sha1 = _this157.imm_computeAuth(_this157.urlInfo.user, _this157.urlInfo.pass, _this157._remoteSerial, _this157._nonce);
                            for (let i = 0; i < sha1.length; i++) {
                                if (sha1[i] != remote_sha1[i]) {
                                    // bad signature
                                    _this157._session_errno = 401;
                                    _this157._session_error = "Authentication failed";
                                    _this157._connectionState = _this157._WS_DEAD;
                                    return;
                                }
                            }
                            // Password verified OK
                            _this157._connectionState = _this157._WS_CONNECTED;
                        } else {
                            if (_this157.urlInfo.pass == '') {
                                ...
                                _this157._session_errno = 401;
                                _this157._session_error = "Password not set on remote hub";
                                _this157._connectionState = _this157._WS_DEAD;
                                return;
                            }
                        }
                        break;
                    case _this157._USB_META_WS_ERROR:
                        // drop reserved byte
                        _this157._session_errno = arr_bytes[3] + (arr_bytes[4] << 8);
                        if (_this157._session_errno == 401) {
                            _this157._session_error = "Authentication failed";
                        } else {
                            _this157._session_error = "Remote hub closed connection with error " + _this157._session_errno;
                        }
                        _this157._connectionState = _this157._WS_DEAD;
                        break;
                }
    ...
    request(method, baseUrl, devUrl, obj_body) {
        ...
        return _asyncToGenerator(function* () {
            let httpPromise = new Promise(function (resolve, reject) {
                ...
                let ws = _this158.websocket;
                let isAsync = _this158._remoteVersion > 0 && devUrl.slice(-2) == '&.';
                ...
                if (isAsync) {
                    yreq.asyncId = _this158.nextAsyncId++;
                    if (_this158.nextAsyncId >= 127) {
                        _this158.nextAsyncId = 48;
                    }
                }

                // Queue all requests on tcpChan 0 for now, to preserve request order
                let tcpchan = 0;
                let queue = _this158.tcpChan[tcpchan];
                if (queue) {
                    while (queue.next) {
                        queue = queue.next;
                    }
                ...
                while (pos < subReq.length) {
                    let framelen = 1 + subReq.length - pos;
                    if (framelen > 125) framelen = 125;
                    let datalen = framelen - 1;

                    if (isAsync && pos + datalen == subReq.length && framelen < 125) {
                        frame = new Uint8Array(framelen + 1);
                        frame[0] = 8 * _this158._YSTREAM_TCP_ASYNCCLOSE + tcpchan;
                        frame[framelen] = yreq.asyncId;
                        asyncCloseSet = true;
                    } else {
                        frame = new Uint8Array(framelen);
                        frame[0] = 8 * _this158._YSTREAM_TCP + tcpchan;
                    }
                    for (i = 0; i < datalen; i++) {
                        frame[1 + i] = subReq.charCodeAt(pos + i);
                    }
                    pos += datalen;
                    _this158.imm_webSocketSend(frame);
                }
...
class YAPIContext {
    ...
    _addHub(newhub) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this160._hubs.push(newhub);

            // If hub is not yet known, create a device object (synchronous call)
            var serial = _this160._snByUrl[newhub.urlInfo.url];
            if (!serial) {
                let dev = new YDevice(_this160, newhub.urlInfo.url, null, null);
                yield dev.refresh();
            }
        })();
    }
    ...
    _updateDeviceList_internal(bool_forceupdate, bool_invokecallbacks) {
        ...
        return _asyncToGenerator(function* () {
            if (_this161._firstArrival && bool_invokecallbacks && _this161._arrivalCallback) {
                bool_forceupdate = true;
            }
            if (bool_forceupdate) {
                for (let i = 0; i < _this161._hubs.length; i++) {
                    _this161._hubs[i].imm_forceUpdate();
                }
            }
            if (_this161._updateDevListStarted && _this161.GetTickCount() - _this161._updateDevListStarted < 30 * 1000) {
                return {
            ...
            try {
                ...
                _this161._updateDevListStarted = _this161.GetTickCount();

                // collect list of hubs which should be checked
                let hubs = [];
                for (let i = 0; i < _this161._hubs.length; i++) {
                    let hub = _this161._hubs[i];
                    let rootUrl = hub.urlInfo.url;
                    let hubDev = _this161.imm_getDevice(rootUrl);
                    if (!hubDev) continue;
                    if (hub.devListExpires <= _this161.GetTickCount()) {
                        hub.missing = [];
                        hubs.push(hub);
                    }
                }
                ...
                for (let serial in _this161._devs) {
                    let rooturl = _this161._devs[serial].imm_getRootUrl();
                ...
                if (bool_invokecallbacks) {
                    let nbEvents = _this161._pendingCallbacks.length;
                    for (let i = 0; i < nbEvents; i++) {
                        let evt = _this161._pendingCallbacks[i];
                        let serial = evt.slice(1);
                        switch (evt.charAt(0)) {
                            case '+':
                                if (_this161._arrivalCallback != undefined) {
                                    yield _this161._arrivalCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '/':
                                if (_this161._namechgCallback != undefined) {
                                    yield _this161._namechgCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '-':
                                if (_this161._removalCallback != undefined) {
                                    yield _this161._removalCallback(yFindModule(serial + '.module'));
                                }
                                _this161.imm_forgetDevice(_this161._devs[serial]);
                                break;
                        }
                    }
                    _this161._pendingCallbacks = _this161._pendingCallbacks.slice(nbEvents);
                    if (_this161._arrivalCallback != undefined && _this161._firstArrival) {
                        _this161._firstArrival = false;
                    }
                }
            } finally {
                _this161._updateDevListStarted = false;
            }
    ...
    updateDeviceList_process(hub, hubDev, whitePages, yellowPages) {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let classname in yellowPages) {
                ...
                let ftype = _this162._fnByType[classname];
                if (ftype == undefined) {
                    ftype = new YFunctionType(_this162, classname);
                    _this162._fnByType[classname] = ftype;
                }
            ...
            for (let devkey in whitePages) {
                ...
                var currdev = _this162._devs[serial];
                if (currdev && _this162._arrivalCallback != undefined && _this162._firstArrival) {
                    _this162._pendingCallbacks.push('+' + serial);
                }
                hub.serialByYdx[devydx] = serial;
                if (!currdev) {
                    // Add new device
                    //noinspection ObjectAllocationIgnored
                    new YDevice(_this162, rooturl, devinfo, yellowPages);
                    if (_this162._arrivalCallback != undefined) {
                        _this162._pendingCallbacks.push('+' + serial);
                    }
                } else if (currdev.imm_getLogicalName() != devinfo['logicalName']) {
                    // Reindex device from its own data
                    yield currdev.refresh();
                    if (_this162._namechgCallback != undefined) {
                        _this162._pendingCallbacks.push('/' + serial);
                    }
            ...
            for (serial in hub.missing) {
                if (hub.missing[serial]) {
                    if (_this162._removalCallback != undefined) {
                        _this162._pendingCallbacks.push('-' + serial);
                    } else {
                        _this162.imm_forgetDevice(_this162._devs[serial]);
                    }
                }
            }
        ...
        return _asyncToGenerator(function* () {
            ...
            for (var idx = 0; idx < nrows; idx++) {
                ...
                if (ev.length >= 3 && firstCode >= NOTIFY_NETPKT_FLUSHV2YDX && firstCode <= NOTIFY_NETPKT_TIMEAVGYDX) {
                    ...
                    if (serial && _this163._devs[serial]) {
                        var funcid = funydx == 0xf ? 'time' : _this163._devs[serial].imm_functionId(funydx);
                        if (funcid != '') {
                            value = ev.slice(3);
                            switch (firstCode) {
                                case NOTIFY_NETPKT_FUNCVALYDX:
                                    ...
                                    _this163.imm_setFunctionValue(serial + '.' + funcid, value);
                                    break;
                                ...
                                case NOTIFY_NETPKT_TIMEV2YDX:
                                    ...
                                    var dev = _this163._devs[serial];
                                    if (funcid == 'time') {
                                        var time = arr[1] + 0x100 * arr[2] + 0x10000 * arr[3] + 0x1000000 * arr[4];
                                        dev.imm_setDeviceTime(time + arr[5] / 250.0);
                                    } else {
                                        _this163.imm_setTimedReport(serial + '.' + funcid, dev.imm_getDeviceTime(), arr);
                                    }
                                    break;
                                case NOTIFY_NETPKT_FUNCV2YDX:
                                    var rawval = _this163.imm_decodeNetFuncValV2(value);
                                    if (rawval != null) {
                                        var decodedval = _this163.imm_decodePubVal(rawval[0], rawval, 1, 6);
                                        _this163.imm_setFunctionValue(serial + '.' + funcid, decodedval);
                                    }
                                    break;
                    ...
                    if (notype == '@') {
                        ...
                        case 5:
                            ...
                            if (parts.length > 2) {
                                ...
                                _this163.imm_setFunctionValue(parts[0] + '.' + parts[1], value[0]);
                            }
                            break;
                    }
                } else {
            ...
            if (_this163._forwardValues > 0) {
                yield _this163.HandleEvents(new YErrorMsg());
            }
        })();
    }
    ...
    _UpdateValueCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this164._ValueCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this164._ValueCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this164._ValueCallbackList.splice(index, 1);
            }
        })();
    }
    ...
    _UpdateTimedReportCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this165._TimedReportCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this165._TimedReportCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this165._TimedReportCallbackList.splice(index, 1);
            }
        })();
    }
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_device.substr(0, 7) == 'http://' || str_device.substr(0, 5) == 'ws://') {
                ...
                if (lines[0].substr(0, 12) != 'GET /not.byn') {
                    /** @type {string} **/
                    let serial = _this166._snByUrl[baseUrl];
                    if (serial) {
                        lockdev = _this166._devs[serial];
                    }
                }
            } else {
                lockdev = _this166.imm_getDevice(str_device);
                if (!lockdev) {
                ...
                if (lines[0] == 'GET /api.json') {
                    return yield lockdev.requestAPI(_this166.defaultCacheValidity);
                }
            ...
            /** @type {YGenericHub} **/
            let hub = _this166.imm_getHub(baseUrl);
            /** @type {string} **/
            let method = words[0];
            /** @type {string} **/
            let devUrl = words[1];
    ...
    _funcDev(str_className, str_func) {
        ...
        return _asyncToGenerator(function* () {
            var resolve = _this167.imm_funcDev_internal(str_className, str_func);
            if (resolve.errorType == YAPI_SUCCESS) {
                return resolve;
            } else if (resolve.errorType == YAPI_DEVICE_NOT_FOUND && _this167._hubs.length == 0) {
            ...
            var updRes = yield _this167._updateDeviceList_internal(true, false);
            if (updRes.errorType != YAPI_SUCCESS) {
                resolve.errorType = updRes.errorType;
                resolve.errorMsg = updRes.errorMsg;
                return resolve;
            }
            return _this167.imm_funcDev_internal(str_className, str_func);
        })();
    }
    ...
    funcRequest(str_className, str_func, str_extra) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let funcreq = yield _this168._funcDev(str_className, str_func);
            ...
            if (str_extra == '') {
                ...
                if (yreq != null) {
                    if (yreq.errorType != YAPI_SUCCESS) return yreq;
                    try {
                        let jsonData = JSON.parse(_this168.imm_bin2str(yreq.bin_result));
            ...
            if (!loadval) {
                ...
                /** @type {YHTTPRequest} **/
                yreq = yield _this168.devRequest(devreq.deviceid, httpreq);
                if (yreq.errorType != YAPI_SUCCESS) return yreq;
                ...
                try {
                    loadval = JSON.parse(_this168.imm_bin2str(yreq.bin_result));
                } catch (err) {
                    //console.log('RequestAPI parse error: ', err);
                }
            }
    ...
    HTTPRequest(str_device, str_request) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YHTTPRequest} **/
            let yreq = yield _this169.devRequest(str_device, str_request);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this169._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    GetAPIVersion() {
        return _asyncToGenerator(function* () {
            return (/* version number patched automatically */'1.10.23069'
            );
        })();
    }
    ...
    FreeAPI() {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let i = 0; i < _this170._hubs.length; i++) {
                _this170._hubs[i].disconnect();
            }
    ...
    DisableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this171.exceptionsDisabled = true;
        })();
    }
    ...
    EnableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this172.exceptionsDisabled = false;
        })();
    }
    ...
    RegisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this174.imm_parseRegisteredUrl(url);
            let newhub = _this174.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this174.imm_registerHub_internal(urlInfo);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                return _this174._throw(retcode, errmsg.msg, retcode);
            }
            yield _this174._addHub(newhub);

            // Update known device list
            let yreq = yield _this174._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this174._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
                return _this174._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    PreregisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this175.imm_parseRegisteredUrl(url);
            let newhub = _this175.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this175.imm_registerHub_internal(urlInfo);
            _this175._addHub(newhub);
    ...
    RegisterHubHttpCallback(incomingMessage, serverResponse, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this176.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this176.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YHttpCallbackHub(_this176, urlInfo, incomingMessage, serverResponse);
            yield newhub.httpCallbackPromise;
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                _this176._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                return _this176._throw(retcode, errmsg.msg, retcode);
            }
            yield _this176._addHub(newhub);

            // Update known device list
            let yreq = yield _this176._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this176._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
                return _this176._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    RegisterHubWebSocketCallback(ws, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this177.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this177.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YWebSocketCallbackHub(_this177, urlInfo, ws);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
    ...
    UnregisterHub(url) {
        ...
        return _asyncToGenerator(function* () {
            var urlInfo = _this178.imm_parseRegisteredUrl(url);
            var i, j;

            for (i = 0; i < _this178._hubs.length; i++) {
                if (_this178._hubs[i].urlInfo.url == urlInfo.url) {
                    _this178._hubs[i].disconnect();
                    for (j = 0; j < _this178._hubs[i].serialByYdx.length; j++) {
                        var serial = _this178._hubs[i].serialByYdx[j];
                        _this178.imm_forgetDevice(_this178._devs[serial]);
                    }
                    var before = _this178._hubs.slice(0, i);
                    if (i + 1 < _this178._hubs.length) {
                        var after = _this178._hubs.slice(i + 1);
                        _this178._hubs = before.concat(after);
                    }
                    _this178._hubs = before;
                    return;
                }
            }
        })();
    ...
    UpdateDeviceList(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var yreq = yield _this179._updateDeviceList_internal(false, true);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    HandleEvents(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var nEvents = _this180._data_events.length;
            for (var i = 0; i < nEvents; i++) {
                var evt = _this180._data_events[i];
                if (typeof evt[1] == 'string') {
                    ...
                    var dev = _this180.imm_getDevice(evt[0]._serial);
                    if (dev) {
            ...
            _this180._data_events = _this180._data_events.slice(nEvents);
    ...
    Sleep(ms_duration, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var end = _this181.GetTickCount() + ms_duration;
            yield _this181.HandleEvents(errmsg);
            while (_this181.GetTickCount() < end) {
                yield _this181._microSleep_internal();
                yield _this181.HandleEvents(errmsg);
            }
            return YAPI_SUCCESS;
        })();
    ...
    _setTimeout_internal(callback, endtime, args, errmsg) {
        ...
        if (delay < 0) {
            ...
            this.Sleep(delay, errmsg).then(function () {
                _this182._setTimeout_internal(callback, endtime, args);
            });
        } else {
            this.UpdateDeviceList(errmsg).then(function () {
                _this182.Sleep(90, errmsg).then(function () {
                    _this182._setTimeout_internal(callback, endtime, args);
                });
            });
        }
    ...
    RegisterDeviceArrivalCallback(arrivalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this183._arrivalCallback = arrivalCallback;
        })();
    }
    ...
    RegisterDeviceChangeCallback(changeCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this184._namechgCallback = changeCallback;
        })();
    }
    ...
    RegisterDeviceRemovalCallback(removalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this185._removalCallback = removalCallback;
        })();
    }
    ...
    RegisterCalibrationHandler(calibrationType, calibrationHandler) {
        ...
        return _asyncToGenerator(function* () {
            _this186._calibHandlers[calibrationType.toString()] = calibrationHandler;
        })();
    }
    ...
    ComputePSK(ssid, pass) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this187.imm_initshaw(pass, 0, 0, 0x3636, _shaw);
            _this187.imm_itershaw(sha1_init, _shaw);
            for (k = 0; k < 5; k++) inner[k] = _shaw[k];
            _shaw = new Uint32Array(80);
            _this187.imm_initshaw(pass, 0, 0, 0x5c5c, _shaw);
            _this187.imm_itershaw(sha1_init, _shaw);
            ...
            _shaw = new Uint32Array(80);
            _this187.imm_initshaw(ssid, 0, 1, 0, _shaw);

            for (iter = 0; iter < 8192;) {
                _this187.imm_itershaw(inner, _shaw);
                _shaw[5] = 0x80000000;
                for (k = 6; k < 15; k++) {
                    _shaw[k] = 0;
                }
                _shaw[15] = 8 * (64 + 20);
                _this187.imm_itershaw(outer, _shaw);
                shau[0] ^= _shaw[0];
                shau[1] ^= _shaw[1];
                shau[2] ^= _shaw[2];
                shau[3] ^= _shaw[3];
                ...
                if ((iter & 4095) == 0) {
                    ...
                    if (iter == 4096) {
                        for (k = 0; k < 5; k++) shau[k] = 0;
                        _shaw = new Uint32Array(80);
                        _this187.imm_initshaw(ssid, 2, 0, _shaw);
                    }
                }
            }
            var hex = '';
