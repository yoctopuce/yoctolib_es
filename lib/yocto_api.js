                        ...
                        case _this163._USB_META_ACK_UPLOAD:
                            ...
                            if (_this163.tcpChan[tcpchan]) {
                                ...
                                if (_this163._lastUploadAckTime[tcpchan] != 0 && ackBytes > _this163._lastUploadAckBytes[tcpchan]) {
                                    let deltaBytes = ackBytes - _this163._lastUploadAckBytes[tcpchan];
                                    let deltaTime = ackTime - _this163._lastUploadAckTime[tcpchan];
                                    ...
                                    //console.log("New rate: "+(this._uploadRate[tcpchan]/1000)+" KB/s (last "+parseInt(deltaBytes/1000)+"KB sent at "+(parseInt(newRate)/1000)+" KB/s)");
                                        ...
                                        _this163.imm_sendPendingRequest(0);
                                    }
                            }
                            break;
                    }
...
class YAPIContext {
    ...
    imm_GetAPIVersion() {
        return (/* version number patched automatically */'1.10.23658'
        );
    }
