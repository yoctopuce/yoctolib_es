...
class Y_MD5Ctx {
    ...
    _byteReverseIn() {
        for (let i = 0; i < 16; i++) {
            let a = this.in32[i];
            this.in32[i] = a >>> 24 | (a & 0xff) << 24 | (a & 0xff0000) >>> 8 | (a & 0xff00) << 8;
        }
    }
    ...
    _transform() {
        ...
        let MD5STEP = function (f, w, x, y, z, data, s) {
            w = w + f(x, y, z) + data & 0xffffffff;
            w = (w << s & 0xffffffff | w >>> 32 - s) >>> 0;
            return (w + x & 0xffffffff) >>> 0;
        };
        let a = this.buf[0];
        let b = this.buf[1];
        let c = this.buf[2];
    ...
    addData(buf) {
        ...
        let pos = 0;
        let t = this.bits[0];
        this.bits[0] = t + (len << 3) & 0xffffffff;
        if (this.bits[0] < t) {
            this.bits[1]++;
        }
        this.bits[1] += len >>> 29;
...
class YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this7._cacheExpiration <= _this7._yapi.GetTickCount()) {
                yield _this7.load(_this7._yapi.defaultCacheValidity);
            }
            var res = new YFunctionProxy(_this7);
    ...
    get_logicalName() {
        ...
        return _asyncToGenerator(function* () {
            if (_this8._cacheExpiration <= _this8._yapi.GetTickCount()) {
                if ((yield _this8.load(_this8._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_LOGICALNAME_INVALID;
                }
            }
            return _this8._logicalName;
        })();
    }
    ...
    set_logicalName(newval) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {string} **/
            let rest_val;
            if (!_this9._yapi.CheckLogicalName(newval)) {
                return _this9._throw(_this9._yapi.INVALID_ARGUMENT, 'Invalid name :' + newval, _this9._yapi.INVALID_ARGUMENT);
            }
            rest_val = newval;
            return yield _this9._setAttr('logicalName', rest_val);
        })();
    }
    ...
    get_advertisedValue() {
        ...
        return _asyncToGenerator(function* () {
            if (_this10._cacheExpiration <= _this10._yapi.GetTickCount()) {
                if ((yield _this10.load(_this10._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_ADVERTISEDVALUE_INVALID;
                }
            }
            return _this10._advertisedValue;
        })();
    }
    ...
    set_advertisedValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this11._setAttr('advertisedValue', rest_val);
        })();
    }
    ...
    registerValueCallback(callback) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let val;
            if (callback != null) {
                yield YFunction._UpdateValueCallbackList(_this12, true);
            } else {
                yield YFunction._UpdateValueCallbackList(_this12, false);
            }
            _this12._valueCallbackFunction = callback;
            // Immediately invoke value callback with current value
            if (callback != null && (yield _this12.isOnline())) {
                val = _this12._advertisedValue;
                if (!(val == '')) {
                    yield _this12._invokeValueCallback(val);
                }
            }
            return 0;
        })();
    ...
    _invokeValueCallback(value) {
        ...
        return _asyncToGenerator(function* () {
            if (_this13._valueCallbackFunction != null) {
                yield _this13._valueCallbackFunction(_this13, value);
            } else {}
            return 0;
        })();
    }
    ...
    muteValueCallbacks() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this14.set_advertisedValue('SILENT');
        })();
    }
    ...
    unmuteValueCallbacks() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this15.set_advertisedValue('');
        })();
    }
    ...
    describe() {
        ...
        return _asyncToGenerator(function* () {
            if (_this16._hwId != '') {
                return _this16._className + '(' + _this16._func + ')=' + _this16._hwId;
            }
            var resolve = _this16._yapi.imm_resolveFunction(_this16._className, _this16._func);
            if (resolve.errorType != YAPI_SUCCESS && resolve.result != _this16._func) {
                return _this16._className + '(' + _this16._func + ')=unresolved';
            }
            return _this16._className + '(' + _this16._func + ')=' + resolve.result;
        })();
    }
    ...
    get_hardwareId() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (resolve.errorType != YAPI_SUCCESS) {
                ...
                if (resolve.errorType != YAPI_SUCCESS) {
                    return _this17._throw(resolve.errorType, resolve.errorMsg, Y_HARDWAREID_INVALID);
                }
            }
    ...
    get_functionId() {
        ...
        return _asyncToGenerator(function* () {
            if (_this18._funId != '') {
                return _this18._funId;
            }
            var resolve = _this18._yapi.imm_resolveFunction(_this18._className, _this18._func);
            if (resolve.errorType != YAPI_SUCCESS) {
                yield _this18.isOnline();
                resolve = _this18._yapi.imm_resolveFunction(_this18._className, _this18._func);
                if (resolve.errorType != YAPI_SUCCESS) {
                    return _this18._throw(resolve.errorType, resolve.errorMsg, Y_FUNCTIONID_INVALID);
                }
            }
    ...
    get_friendlyName() {
        ...
        return _asyncToGenerator(function* () {
            var resolve = _this19._yapi.imm_getFriendlyNameFunction(_this19._className, _this19._func);
            if (resolve.errorType != YAPI_SUCCESS) {
                yield _this19.isOnline();
                resolve = _this19._yapi.imm_getFriendlyNameFunction(_this19._className, _this19._func);
                if (resolve.errorType != YAPI_SUCCESS) {
                    return _this19._throw(resolve.errorType, resolve.errorMsg, Y_FRIENDLYNAME_INVALID);
                }
            }
            return resolve.result;
        })();
    ...
    _parse(yreq, msValidity) {
        ...
        return _asyncToGenerator(function* () {
            ...
            yreq.obj_result['_expiration'] = _this20._yapi.GetTickCount() + msValidity;
            _this20._serial = yreq.obj_result.deviceid;
            _this20._funId = yreq.obj_result.functionid;
            _this20._hwId = yreq.obj_result.hwid;
            _this20._cache = yreq.obj_result;
            // process each attribute in turn for class-oriented processing
            for (var key in yreq.obj_result) {
                _this20.imm_parseAttr(key, yreq.obj_result[key]);
            }
            yield _this20._parserHelper();
        })();
    }
    ...
    isOnline_async(func, ctx) {
        ...
        this.isOnline().then(function (res) {
            func(ctx, _this21, res);
        }).catch(function (e) {
            func(ctx, _this21, false);
        });
    }
    ...
    load_async(ms_validiy, func, ctx) {
        ...
        this.load(ms_validiy).then(function (res) {
            func(ctx, _this22, YAPI_SUCCESS);
        }).catch(function (e) {
            func(ctx, _this22, _this22.get_errorType());
        });
    }
    ...
    _getAttr(str_attr) {
        ...
        return _asyncToGenerator(function* () {
            if (_this23._cacheExpiration <= _this23._yapi.GetTickCount()) {
                ...
                if ((yield _this23.load(_this23._yapi.defaultCacheValidity)) != YAPI_SUCCESS) return null;
            }
            if (typeof _this23._cache[str_attr] == 'undefined') {
                _this23._throw(YAPI_VERSION_MISMATCH, 'No such attribute ' + str_attr + ' in function', null);
            }
            return _this23._cache[str_attr];
        })();
    }
    ...
    _getFixedAttr(str_attr) {
        ...
        return _asyncToGenerator(function* () {
            if (_this24._cacheExpiration == 0) {
                // no cached value, load from device
                if ((yield _this24.load(_this24._yapi.defaultCacheValidity)) != YAPI_SUCCESS) return null;
            }
            if (typeof _this24._cache[str_attr] == 'undefined') {
                _this24._throw(YAPI_VERSION_MISMATCH, 'No such attribute ' + str_attr + ' in function', null);
            }
            return _this24._cache[str_attr];
        })();
    }
    ...
    _setAttr(str_attr, str_newval) {
        ...
        return _asyncToGenerator(function* () {
            if (str_newval == undefined) {
                return _this25._throw(YAPI_INVALID_ARGUMENT, 'Undefined value to set for attribute ' + str_attr, null);
            }
            var attrname = encodeURIComponent(str_attr);
            var attrval = _this25.imm_escapeAttr(str_newval);
            var extra = '/' + attrname + '?' + attrname + '=' + attrval + '&.';
            if (_this25._cacheExpiration != 0) {
                _this25._cacheExpiration = _this25._yapi.GetTickCount();
                _this25._cache._expiration = _this25._cacheExpiration;
            }
            yield _this25._yapi.funcRequest(_this25._className, _this25._func, extra);
    ...
    _download(str_path) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let devid = _this26._serial;
            if (devid == '') {
                devid = yield (yield _this26.module()).get_serialNumber();
            }
            if (devid == Y_SERIALNUMBER_INVALID) {
                return new Uint8Array(0);
            }
            /** @type {YHTTPRequest} **/
            let yreq = yield _this26._yapi.devRequest(devid, 'GET /' + str_path);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this26._throw(yreq.errorType, yreq.errorMsg, '');
            }
    ...
    _upload(str_path, bin_content) {
        ...
        return _asyncToGenerator(function* () {
            // get the device serial number
            var devid = _this27._serial;
            if (devid == '') {
                devid = yield (yield _this27.module()).get_serialNumber();
            }
            if (devid == Y_SERIALNUMBER_INVALID) {
                return _this27.get_errorType();
            }
            var httpreq = 'POST /upload.html';
            var len = bin_content.length;
            // convert to Uint8Array if needed
            if (typeof bin_content == 'string' || bin_content instanceof String) {
                bin_content = _this27._yapi.imm_str2bin(bin_content);
            } else if (bin_content instanceof Array) {
                bin_content = new Uint8Array(bin_content);
            }
            return yield _this27._yapi.devRequest(devid, httpreq, bin_content);
        })();
    }
        ...
        if (devid == '') {
            ...
            this.module().then(function (module) {
                return module.get_serialNumber().then(function () {
                    return _this28.wait_async(callback, context);
                });
            });
            return YAPI_SUCCESS;
        }
    ...
    isOnline() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this30._cacheExpiration > _this30._yapi.GetTickCount()) return true;

            // Check that the function is available without throwing exceptions
            /** @type {YFuncRequest} **/
            let yreq = yield _this30._yapi.funcRequest(_this30._className, _this30._func, '', _this30._yapi.defaultCacheValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
            ...
            yield _this30._parse(yreq, _this30._yapi.defaultCacheValidity);
    ...
    load(msValidity) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let yreq = yield _this31._yapi.funcRequest(_this31._className, _this31._func, '', msValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this31._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            yield _this31._parse(yreq, msValidity);
    ...
    clearCache() {
        ...
        return _asyncToGenerator(function* () {
            var devreq = yield _this32._yapi._funcDev(_this32._className, _this32._func);
            if (devreq.errorType != YAPI_SUCCESS) {
                return;
            }
            devreq.obj_result.device.imm_dropCache();
            if (_this32._cacheExpiration > 0) {
                _this32._cacheExpiration = _this32._yapi.GetTickCount();
            }
        })();
    }
    ...
    module() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this33._serial != '') {
                return YModule.FindModuleInContext(_this33._yapi, _this33._serial + '.module');
            }
            var hwid = _this33._func;
            var resolve;
            if (hwid.indexOf('.') < 0) {
                resolve = _this33._yapi.imm_resolveFunction(_this33._className, _this33._func);
                if (resolve.errorType == YAPI_SUCCESS) hwid = resolve.result;
            }
            var dotidx = hwid.indexOf('.');
            if (dotidx >= 0) {
                // resolution worked
                return YModule.FindModuleInContext(_this33._yapi, hwid.substr(0, dotidx) + '.module');
            }

            // device not resolved for now, force a communication for a last chance resolution
            if ((yield _this33.load(_this33._yapi.defaultCacheValidity)) == YAPI_SUCCESS) {
                resolve = _this33._yapi.imm_resolveFunction(_this33._className, _this33._func);
            ...
            return YModule.FindModuleInContext(_this33._yapi, 'module_of_' + _this33.className + '_' + _this33._func);
        })();
    }
    ...
    get_functionDescriptor() {
        ...
        return _asyncToGenerator(function* () {
            // try to resolve the function name to a device id without query
            if (_this35._hwId != '') {
                return _this35._hwId;
            }
            var hwid = _this35._func;
            if (hwid.indexOf('.') < 0) {
                var resolve = _this35._yapi.imm_resolveFunction(_this35._className, _this35._func);
                if (resolve.errorType != YAPI_SUCCESS) hwid = resolve.result;
            }
            var dotidx = hwid.indexOf('.');
            if (dotidx >= 0) {
...
class YFunctionProxy {
    ...
    isOnline_async(func, ctx) {
        ...
        this.liveFunc.isOnline().then(function (res) {
            func(ctx, _this39, res);
        }).catch(function (e) {
            func(ctx, _this39, false);
        });
    }
    ...
    load_async(ms_validiy, func, ctx) {
        ...
        this.liveFunc.load(ms_validiy).then(function (res) {
            func(ctx, _this40, YAPI_SUCCESS);
        }).catch(function (e) {
            func(ctx, _this40, _this40.get_errorType());
        });
    }
    ...
    _download(str_path) {
        ...
        return _asyncToGenerator(function* () {
            _this41.liveFunc._download(str_path);
    ...
    _upload(str_path, bin_content) {
        ...
        return _asyncToGenerator(function* () {
            _this42.liveFunc._upload(str_path, bin_content);
            return null;
        })();
    }
    ...
    wait_async(callback) {
        ...
        this.liveFunc.wait_async(function (ctx, obj) {
            callback(ctx, _this43);
        }, context);
    }
...
class YModule extends YFunction {
    ...
    loadUrl(str_url) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            let dev = _this50.imm_getDev();
            if (!dev) return null;
            /** @type {YHTTPRequest} **/
            let yreq = yield _this50._yapi.devRequest(dev.imm_getRootUrl(), 'GET ' + str_url);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this50._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    get_logicalName() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            var dev = _this51.imm_getDev();
            if (dev != null && _this51._cache._expiration <= _this51._yapi.GetTickCount()) {
                return dev._logicalName;
            }
            /** @type {string|null} **/
            var json_val = yield _this51._getAttr('logicalName');
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this52._cacheExpiration <= _this52._yapi.GetTickCount()) {
                yield _this52.load(_this52._yapi.defaultCacheValidity);
            }
            var res = new YModuleProxy(_this52);
            yield res._asyncInit();
            return res;
        })();
    }
    ...
    get_productName() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            let dev;
            if (_this53._cacheExpiration == 0) {
                dev = _this53.imm_getDev();
                if (!(dev == null)) {
    ...
    get_productRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this56._productRelease;
        })();
    }
    ...
    get_firmwareRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this57._firmwareRelease;
        })();
    }
    ...
    get_persistentSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this58._persistentSettings;
        })();
    }
    ...
    set_persistentSettings(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this59._setAttr('persistentSettings', rest_val);
        })();
    }
    ...
    get_luminosity() {
        ...
        return _asyncToGenerator(function* () {
            if (_this60._cacheExpiration <= _this60._yapi.GetTickCount()) {
                if ((yield _this60.load(_this60._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_LUMINOSITY_INVALID;
                }
            }
            return _this60._luminosity;
        })();
    }
    ...
    set_luminosity(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this61._setAttr('luminosity', rest_val);
        })();
    }
    ...
    get_beacon() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this62._cacheExpiration <= _this62._yapi.GetTickCount()) {
                dev = _this62.imm_getDev();
                if (!(dev == null)) {
                    return dev.imm_getBeacon();
                }
                if ((yield _this62.load(_this62._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_BEACON_INVALID;
                }
            }
            return _this62._beacon;
        })();
    }
    ...
    set_beacon(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this63._setAttr('beacon', rest_val);
        })();
    }
    ...
    get_upTime() {
        ...
        return _asyncToGenerator(function* () {
            if (_this64._cacheExpiration <= _this64._yapi.GetTickCount()) {
                if ((yield _this64.load(_this64._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_UPTIME_INVALID;
                }
            }
            return _this64._upTime;
        })();
    }
    ...
    set_rebootCountdown(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this67._setAttr('rebootCountdown', rest_val);
        })();
    }
    ...
    get_userVar() {
        ...
        return _asyncToGenerator(function* () {
            if (_this68._cacheExpiration <= _this68._yapi.GetTickCount()) {
                if ((yield _this68.load(_this68._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_USERVAR_INVALID;
                }
            }
            return _this68._userVar;
        })();
    }
    ...
    set_userVar(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this69._setAttr('userVar', rest_val);
        })();
    }
    ...
    saveToFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this70.set_persistentSettings(Y_PERSISTENTSETTINGS_SAVED);
        })();
    }
    ...
    revertFromFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this71.set_persistentSettings(Y_PERSISTENTSETTINGS_LOADED);
        })();
    }
    ...
    reboot(secBeforeReboot) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this72.set_rebootCountdown(secBeforeReboot);
        })();
    }
    ...
    triggerFirmwareUpdate(secBeforeReboot) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this73.set_rebootCountdown(-secBeforeReboot);
        })();
    }
    ...
    checkFirmware(path, onlynew) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let tmp_res;
            if (onlynew) {
                release = _this74._yapi.imm_atoi((yield _this74.get_firmwareRelease()));
            } else {
                release = 0;
            }
            //may throw an exception
            serial = yield _this74.get_serialNumber();
            tmp_res = yield YFirmwareUpdate.CheckFirmware(serial, path, release);
            if (tmp_res.indexOf('error:') == 0) {
                _this74._throw(YAPI_INVALID_ARGUMENT, tmp_res);
            }
            return tmp_res;
        })();
    }
    ...
    updateFirmware(path) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let settings;
            // may throw an exception
            serial = yield _this75.get_serialNumber();
            settings = yield _this75.get_allSettings();
            if (settings.length == 0) {
                _this75._throw(YAPI_IO_ERROR, 'Unable to get device settings');
                settings = _this75._yapi.imm_str2bin('error:Unable to get device settings');
            }
    ...
    get_allSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let templist = [];
            // may throw an exception
            settings = yield _this76._download('api.json');
            if (settings.length == 0) {
                return settings;
            }
            ext_settings = ', "extras":[';
            templist = yield _this76.get_functionIds('Temperature');
            sep = '';
            for (let ii in templist) {
                if (_this76._yapi.imm_atoi((yield _this76.get_firmwareRelease())) > 9000) {
                    url = 'api/' + templist[ii] + '/sensorType';
                    t_type = _this76._yapi.imm_bin2str((yield _this76._download(url)));
                    if (t_type == 'RES_NTC') {
                        id = templist[ii].substr(11, templist[ii].length - 11);
                        temp_data_bin = yield _this76._download('extra.json?page=' + id);
                        if (temp_data_bin.length == 0) {
                            return temp_data_bin;
                        }
                        item = sep + '{"fid":"' + templist[ii] + '", "json":' + _this76._yapi.imm_bin2str(temp_data_bin) + '}\n';
            ...
            if (yield _this76.hasFunction('files')) {
                json = yield _this76._download('files.json?a=dir&f=');
                if (json.length == 0) {
                    return json;
                }
                filelist = _this76.imm_json_get_array(json);
                sep = '';
                for (let ii in filelist) {
                    name = _this76.imm_json_get_key(_this76._yapi.imm_str2bin(filelist[ii]), 'name');
                    if (name.length == 0) {
                        return _this76._yapi.imm_str2bin(name);
                    }
                    file_data_bin = yield _this76._download(_this76.imm_escapeAttr(name));
                    file_data = _this76._yapi.imm_bin2hexstr(file_data_bin);
            ...
            ext_settings = ext_settings + ']}';
            res = _this76._yapi.imm_str2bin('{ "api":') + settings + _this76._yapi.imm_str2bin(ext_settings);
            return res;
        })();
    }
    ...
    loadThermistorExtra(funcId, jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            yield _this77._download(url);
            // add records in growing resistance value
            values = _this77.imm_json_get_array(_this77._yapi.imm_str2bin(jsonExtra));
            ofs = 0;
            size = values.length;
            while (ofs + 1 < size) {
                curr = values[ofs];
    ...
    set_extraSettings(jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let data;
            extras = _this78.imm_json_get_array(_this78._yapi.imm_str2bin(jsonExtra));
            for (let ii in extras) {
                functionId = _this78.imm_get_json_path(extras[ii], 'fid');
                functionId = _this78.imm_decode_json_string(functionId);
                data = _this78.imm_get_json_path(extras[ii], 'json');
                if (yield _this78.hasFunction(functionId)) {
                    yield _this78.loadThermistorExtra(functionId, data);
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    set_allSettingsAndFiles(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let json_extra;
            json = _this79._yapi.imm_bin2str(settings);
            json_api = _this79.imm_get_json_path(json, 'api');
            if (json_api == '') {
                return yield _this79.set_allSettings(settings);
            }
            json_extra = _this79.imm_get_json_path(json, 'extras');
            if (!(json_extra == '')) {
                yield _this79.set_extraSettings(json_extra);
            }
            yield _this79.set_allSettings(_this79._yapi.imm_str2bin(json_api));
            if (yield _this79.hasFunction('files')) {
                /** @type {string[]} **/
                let files = [];
                /** @type {string} **/
                let res;
                ...
                /** @type {string} **/
                let data;
                down = yield _this79._download('files.json?a=format');
                res = _this79.imm_get_json_path(_this79._yapi.imm_bin2str(down), 'res');
                res = _this79.imm_decode_json_string(res);
                if (!(res == 'ok')) {
                    return _this79._throw(YAPI_IO_ERROR, 'format failed', YAPI_IO_ERROR);
                }
                json_files = _this79.imm_get_json_path(json, 'files');
                files = _this79.imm_json_get_array(_this79._yapi.imm_str2bin(json_files));
                for (let ii in files) {
                    name = _this79.imm_get_json_path(files[ii], 'name');
                    name = _this79.imm_decode_json_string(name);
                    data = _this79.imm_get_json_path(files[ii], 'data');
                    data = _this79.imm_decode_json_string(data);
                    yield _this79._upload(name, _this79._yapi.imm_hexstr2bin(data));;
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    hasFunction(funcId) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let fid;
            // may throw an exception
            count = yield _this80.functionCount();
            i = 0;
            while (i < count) {
                fid = yield _this80.functionId(i);
                if (fid == funcId) {
                    return true;
                }
                i = i + 1;
    ...
    get_functionIds(funType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res = [];
            // may throw an exception
            count = yield _this81.functionCount();
            i = 0;
            while (i < count) {
                ftype = yield _this81.functionType(i);
                if (ftype == funType) {
                    res.push((yield _this81.functionId(i)));
                } else {
                    ftype = yield _this81.functionBaseType(i);
                    if (ftype == funType) {
                        res.push((yield _this81.functionId(i)));
                    }
                }
    ...
    calibScale(unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (unit_name == 'C') {
                ...
                if (_this82._yapi.imm_atoi(sensorType) < 8) {
                    return 16;
                } else {
                    return 100;
                }
    ...
    calibConvert(param, currentFuncValue, unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            paramVer = yield _this83.calibVersion(param);
            funVer = yield _this83.calibVersion(currentFuncValue);
            funScale = yield _this83.calibScale(unit_name, sensorType);
            funOffset = yield _this83.calibOffset(unit_name);
            paramScale = funScale;
            paramOffset = funOffset;
            if (funVer < 3) {
                if (funVer == 2) {
                    words = _this83._yapi.imm_decodeWords(currentFuncValue);
                    ...
                    if (funVer == 1) {
                        if (currentFuncValue == '' || _this83._yapi.imm_atoi(currentFuncValue) > 10) {
                            funScale = 0;
                        }
                    }
                }
            ...
            if (paramVer < 3) {
                if (paramVer == 2) {
                    words = _this83._yapi.imm_decodeWords(param);
                    if (words[0] == 1366 && words[1] == 12500) {
                        paramScale = 1;
                        paramOffset = 0;
                    } else {
                    ...
                    if (paramVer == 1) {
                        ...
                        for (let ii in words_str) {
                            words.push(_this83._yapi.imm_atoi(words_str[ii]));
                        }
                        if (param == '' || words[0] > 10) {
                            paramScale = 0;
                        }
                ...
                while (i < calibData.length) {
                    if (paramScale > 0) {
                        ...
                        calibData[i] = _this83._yapi.imm_decimalToDouble(Math.round(calibData[i]));
                    }
                    i = i + 1;
                }
            } else {
                iCalib = _this83._yapi.imm_decodeFloats(param);
            ...
            if (funVer >= 3) {
                ...
                if (funVer >= 1) {
                    ...
                    while (i < 2 * nPoints) {
                        if (funScale == 0) {
                            wordVal = _this83._yapi.imm_doubleToDecimal(Math.round(calibData[i]));
                        } else {
    ...
    set_allSettings(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {boolean} **/
            let found;
            tmp = _this84._yapi.imm_bin2str(settings);
            tmp = _this84.imm_get_json_path(tmp, 'api');
            if (!(tmp == '')) {
                settings = _this84._yapi.imm_str2bin(tmp);
            }
            oldval = '';
            newval = '';
            old_json_flat = _this84.imm_flattenJsonStruct(settings);
            old_dslist = _this84.imm_json_get_array(old_json_flat);
            for (let ii in old_dslist) {
                each_str = _this84.imm_json_get_string(_this84._yapi.imm_str2bin(old_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this84._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            // may throw an exception
            actualSettings = yield _this84._download('api.json');
            actualSettings = _this84.imm_flattenJsonStruct(actualSettings);
            new_dslist = _this84.imm_json_get_array(actualSettings);
            for (let ii in new_dslist) {
                each_str = _this84.imm_json_get_string(_this84._yapi.imm_str2bin(new_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this84._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            while (i < new_jpath.length) {
                ...
                if (do_update) {
                    if (attr == 'calibrationParam') {
                        ...
                        newval = yield _this84.calibConvert(old_calib, new_val_arr[i], unit_name, sensorType);
                        url = 'api/' + fun + '.json?' + attr + '=' + _this84.imm_escapeAttr(newval);
                        yield _this84._download(url);
                    } else {
                        url = 'api/' + fun + '.json?' + attr + '=' + _this84.imm_escapeAttr(oldval);
                        if (attr == 'resolution') {
            ...
            for (let ii in restoreLast) {
                yield _this84._download(restoreLast[ii]);;
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    download(pathname) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this85._download(pathname);
        })();
    }
    ...
    get_icon2d() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this86._download('icon2d.png');
        })();
    }
    ...
    get_lastLogs() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let content;
            // may throw an exception
            content = yield _this87._download('logs.txt');
            return _this87._yapi.imm_bin2str(content);
        })();
    }
...
class YSensor extends YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this88._cacheExpiration <= _this88._yapi.GetTickCount()) {
                yield _this88.load(_this88._yapi.defaultCacheValidity);
            }
            var res = new YSensorProxy(_this88);
            yield res._asyncInit();
            return res;
        })();
    }
    ...
    get_currentValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = yield _this90._applyCalibration(_this90._currentRawValue);
            if (res == Y_CURRENTVALUE_INVALID) {
                res = _this90._currentValue;
            }
            res = res * _this90._iresol;
            return Math.round(res) / _this90._iresol;
        })();
    }
    ...
    set_lowestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this91._setAttr('lowestValue', rest_val);
        })();
    }
    ...
    get_lowestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this92._lowestValue * _this92._iresol;
            return Math.round(res) / _this92._iresol;
        })();
    }
    ...
    set_highestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this93._setAttr('highestValue', rest_val);
        })();
    }
    ...
    get_highestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this94._highestValue * _this94._iresol;
            return Math.round(res) / _this94._iresol;
        })();
    }
    ...
    get_currentRawValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this95._currentRawValue;
        })();
    }
    ...
    set_logFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this97._setAttr('logFrequency', rest_val);
        })();
    }
    ...
    get_reportFrequency() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this98._reportFrequency;
        })();
    }
    ...
    set_reportFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this99._setAttr('reportFrequency', rest_val);
        })();
    }
    ...
    get_calibrationParam() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this100._calibrationParam;
        })();
    }
    ...
    set_resolution(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this102._setAttr('resolution', rest_val);
        })();
    }
    ...
    get_sensorState() {
        ...
        return _asyncToGenerator(function* () {
            if (_this104._cacheExpiration <= _this104._yapi.GetTickCount()) {
                if ((yield _this104.load(_this104._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_SENSORSTATE_INVALID;
                }
            }
            return _this104._sensorState;
        })();
    }
    ...
    _parserHelper() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this105._caltyp = -1;
            _this105._scale = -1;
            _this105._isScal32 = false;
            _this105._calpar.length = 0;
            _this105._calraw.length = 0;
            _this105._calref.length = 0;
            // Store inverted resolution, to provide better rounding
            if (_this105._resolution > 0) {
                _this105._iresol = Math.round(1.0 / _this105._resolution);
            } else {
                _this105._iresol = 10000;
                _this105._resolution = 0.0001;
            }
            // Old format: supported when there is no calibration
            if (_this105._calibrationParam == '' || _this105._calibrationParam == '0') {
                _this105._caltyp = 0;
                return 0;
            }
            if (_this105._calibrationParam.indexOf(',') >= 0) {
                iCalib = _this105._yapi.imm_decodeFloats(_this105._calibrationParam);
                _this105._caltyp = parseInt(iCalib[0] / 1000, 10);
                if (_this105._caltyp > 0) {
                    if (_this105._caltyp < YOCTO_CALIB_TYPE_OFS) {
                        _this105._caltyp = -1;
                        return 0;
                    }
                    _this105.imm_calhdl = _this105._yapi.imm_getCalibrationHandler(_this105._caltyp);
                    if (!(_this105.imm_calhdl != null)) {
                        _this105._caltyp = -1;
                        return 0;
                    }
                }
                _this105._isScal = true;
                _this105._isScal32 = true;
                _this105._offset = 0;
                _this105._scale = 1000;
                maxpos = iCalib.length;
                _this105._calpar.length = 0;
                position = 1;
                while (position < maxpos) {
                    _this105._calpar.push(iCalib[position]);
                    position = position + 1;
                }
                _this105._calraw.length = 0;
                _this105._calref.length = 0;
                ...
                while (position + 1 < maxpos) {
                    ...
                    fRef = fRef / 1000.0;
                    _this105._calraw.push(fRaw);
                    _this105._calref.push(fRef);
                    position = position + 2;
                }
            } else {
                iCalib = _this105._yapi.imm_decodeWords(_this105._calibrationParam);
                if (iCalib.length < 2) {
                    _this105._caltyp = -1;
                    return 0;
                }
                _this105._isScal = iCalib[1] > 0;
                if (_this105._isScal) {
                    _this105._offset = iCalib[0];
                    if (_this105._offset > 32767) {
                        _this105._offset = _this105._offset - 65536;
                    }
                    _this105._scale = iCalib[1];
                    _this105._decexp = 0;
                } else {
                    _this105._offset = 0;
                    _this105._scale = 1;
                    _this105._decexp = 1.0;
                    position = iCalib[0];
                    while (position > 0) {
                        _this105._decexp = _this105._decexp * 10;
                        position = position - 1;
                    }
                }
                if (iCalib.length == 2) {
                ...
                _this105._caltyp = iCalib[2];
                _this105.imm_calhdl = _this105._yapi.imm_getCalibrationHandler(_this105._caltyp);
                if (_this105._caltyp <= 10) {
                    maxpos = _this105._caltyp;
                } else {
                    if (_this105._caltyp <= 20) {
                        maxpos = _this105._caltyp - 10;
                    } else {
                        maxpos = 5;
                    }
                }
                ...
                while (position + 1 < maxpos) {
                    ...
                    _this105._calpar.push(iRaw);
                    _this105._calpar.push(iRef);
                    if (_this105._isScal) {
                        fRaw = iRaw;
                        fRaw = (fRaw - _this105._offset) / _this105._scale;
                        fRef = iRef;
                        fRef = (fRef - _this105._offset) / _this105._scale;
                        _this105._calraw.push(fRaw);
                        _this105._calref.push(fRef);
                    } else {
                        _this105._calraw.push(_this105._yapi.imm_decimalToDouble(iRaw));
                        _this105._calref.push(_this105._yapi.imm_decimalToDouble(iRef));
                    }
                    position = position + 2;
                }
            }
    ...
    isSensorReady() {
        ...
        return _asyncToGenerator(function* () {
            if (!(yield _this106.isOnline())) {
                return false;
            }
            if (!(_this106._sensorState == 0)) {
                return false;
            }
            return true;
        })();
    ...
    startDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this107._download('api/dataLogger/recording?recording=1');
            if (!(res.length > 0)) {
                return _this107._throw(YAPI_IO_ERROR, 'unable to start datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    stopDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this108._download('api/dataLogger/recording?recording=0');
            if (!(res.length > 0)) {
                return _this108._throw(YAPI_IO_ERROR, 'unable to stop datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    get_recordedData(startTime, endTime) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let funit;
            // may throw an exception
            funcid = yield _this109.get_functionId();
            funit = yield _this109.get_unit();
            return new YDataSet(_this109, funcid, funit, startTime, endTime);
        })();
    }
    ...
    registerTimedReportCallback(callback) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this110._timedReportCallbackSensor = callback;
            return 0;
        })();
    }
    ...
    _invokeTimedReportCallback(value) {
        ...
        return _asyncToGenerator(function* () {
            if (_this111._timedReportCallbackSensor != null) {
                yield _this111._timedReportCallbackSensor(_this111, value);
            } else {}
            return 0;
        })();
    }
    ...
    calibrateFromPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            // may throw an exception
            rest_val = yield _this112._encodeCalibrationPoints(rawValues, refValues);
            return yield _this112._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    loadCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this113._scale == 0) {
                if ((yield _this113.load(_this113._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_DEVICE_NOT_FOUND;
                }
            }
            if (_this113._caltyp < 0) {
                _this113._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return YAPI_NOT_SUPPORTED;
            }
            rawValues.length = 0;
            refValues.length = 0;
            for (let ii in _this113._calraw) {
                rawValues.push(_this113._calraw[ii]);
            }
            for (let ii in _this113._calref) {
                refValues.push(_this113._calref[ii]);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    _encodeCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (npt != refValues.length) {
                _this114._throw(YAPI_INVALID_ARGUMENT, 'Invalid calibration parameters (size mismatch)');
            ...
            // Load function parameters if not yet loaded
            if (_this114._scale == 0) {
                if ((yield _this114.load(_this114._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_INVALID_STRING;
                }
            }
            // Detect old firmware
            if (_this114._caltyp < 0 || _this114._scale < 0) {
                _this114._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return '0';
            }
            if (_this114._isScal32) {
                ...
                if (_this114._isScal) {
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = Math.round(rawValues[idx] * _this114._scale + _this114._offset);
                        iRef = Math.round(refValues[idx] * _this114._scale + _this114._offset);
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = _this114._yapi.imm_doubleToDecimal(rawValues[idx]);
                        iRef = _this114._yapi.imm_doubleToDecimal(refValues[idx]);
                        res = res + ',' + String(Math.round(iRaw)) + ',' + String(Math.round(iRef));
                        idx = idx + 1;
                    }
                }
    ...
    _applyCalibration(rawValue) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this115._caltyp == 0) {
                return rawValue;
            }
            if (_this115._caltyp < 0) {
                return Y_CURRENTVALUE_INVALID;
            }
            if (!(_this115.imm_calhdl != null)) {
                return Y_CURRENTVALUE_INVALID;
            }
            return _this115.imm_calhdl(rawValue, _this115._caltyp, _this115._calpar, _this115._calraw, _this115._calref);
        })();
    }
    ...
    _decodeTimedReport(timestamp, report) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {number} **/
            let maxVal;
            startTime = _this116._prevTimedReport;
            endTime = timestamp;
            _this116._prevTimedReport = endTime;
            if (startTime == 0) {
                startTime = endTime;
            }
            if (report[0] == 2) {
                if (report.length <= 5) {
                    ...
                    if (_this116._caltyp != 0) {
                        if (_this116.imm_calhdl != null) {
                            avgVal = _this116.imm_calhdl(avgVal, _this116._caltyp, _this116._calpar, _this116._calraw, _this116._calref);
                        }
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                    ...
                    if (_this116._caltyp != 0) {
                        if (_this116.imm_calhdl != null) {
                            avgVal = _this116.imm_calhdl(avgVal, _this116._caltyp, _this116._calpar, _this116._calraw, _this116._calref);
                            minVal = _this116.imm_calhdl(minVal, _this116._caltyp, _this116._calpar, _this116._calraw, _this116._calref);
                            maxVal = _this116.imm_calhdl(maxVal, _this116._caltyp, _this116._calpar, _this116._calraw, _this116._calref);
                        }
                    }
                }
            } else {
                if (report[0] == 0) {
                    ...
                    if (_this116._isScal) {
                        avgVal = _this116.imm_decodeVal(avgRaw);
                    } else {
                        if ((byteVal & 0x80) != 0) {
                            avgRaw = avgRaw - poww;
                        }
                        avgVal = _this116.imm_decodeAvg(avgRaw);
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                } else {
                    ...
                    minVal = _this116.imm_decodeVal(minRaw);
                    avgVal = _this116.imm_decodeAvg(avgRaw);
                    maxVal = _this116.imm_decodeVal(maxRaw);
                }
            }
...
class YDataStream {
    ...
    loadStream() {
        ...
        return _asyncToGenerator(function* () {
            return _this117.imm_parseStream((yield _this117._parent._download(_this117.imm_get_url())));
        })();
    }
    ...
    get_startTime() {
        ...
        return _asyncToGenerator(function* () {
            return _this120._utcStamp - parseInt(+new Date() / 1000, 10);
        })();
    }
    ...
    get_dataSamplesIntervalMs() {
        ...
        return _asyncToGenerator(function* () {
            return parseInt(3600000 / _this122._samplesPerHour, 10);
        })();
    }
    ...
    get_dataSamplesInterval() {
        ...
        return _asyncToGenerator(function* () {
            return 3600.0 / _this123._samplesPerHour;
        })();
    }
    ...
    get_rowCount() {
        ...
        return _asyncToGenerator(function* () {
            if (_this124._nRows != 0 && _this124._isClosed) {
                return _this124._nRows;
            }
            yield _this124.loadStream();
            return _this124._nRows;
        })();
    }
    ...
    get_columnCount() {
        ...
        return _asyncToGenerator(function* () {
            if (_this125._nCols != 0) {
                return _this125._nCols;
            }
            yield _this125.loadStream();
            return _this125._nCols;
        })();
    }
    ...
    get_columnNames() {
        ...
        return _asyncToGenerator(function* () {
            if (_this126._columnNames.length != 0) {
                return _this126._columnNames;
            }
            yield _this126.loadStream();
            return _this126._columnNames;
        })();
    }
    ...
    get_duration() {
        ...
        return _asyncToGenerator(function* () {
            if (_this130._isClosed) {
                return _this130._duration;
            }
            return parseInt(+new Date() / 1000, 10) - _this130._utcStamp;
        })();
    }
    ...
    get_dataRows() {
        ...
        return _asyncToGenerator(function* () {
            if (_this131._values.length == 0 || !_this131._isClosed) {
                yield _this131.loadStream();
            }
            return _this131._values;
        })();
    }
    ...
    get_data(row, col) {
        ...
        return _asyncToGenerator(function* () {
            if (_this132._values.length == 0 || !_this132._isClosed) {
                yield _this132.loadStream();
            }
            if (row >= _this132._values.length) {
                return Y_DATA_INVALID;
            }
            if (col >= _this132._values[row].length) {
                return Y_DATA_INVALID;
            }
            return _this132._values[row][col];
        })();
    }
...
class YDataSet {
    ...
    processMore(progress, data) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let maxCol;
            // may throw an exception
            if (progress != _this133._progress) {
                return _this133._progress;
            }
            if (_this133._progress < 0) {
                strdata = _this133._yapi.imm_bin2str(data);
                if (strdata == '{}') {
                    _this133._parent._throw(YAPI_VERSION_MISMATCH, 'device firmware is too old');
                    return YAPI_VERSION_MISMATCH;
                }
                return yield _this133._parse(strdata);
            }
            stream = _this133._streams[_this133._progress];
            stream.imm_parseStream(data);
            dataRows = yield stream.get_dataRows();
            _this133._progress = _this133._progress + 1;
            if (dataRows.length == 0) {
                return yield _this133.get_progress();
            }
            ...
            for (let ii in dataRows) {
                if (tim >= _this133._startTime && (_this133._endTime == 0 || tim <= _this133._endTime)) {
                    _this133._measures.push(new YMeasure(tim - itv, tim, dataRows[ii][minCol], dataRows[ii][avgCol], dataRows[ii][maxCol]));
                }
                tim = tim + itv;
            }
    ...
    get_hardwareId() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YModule} **/
            let mo;
            if (!(_this135._hardwareId == '')) {
                return _this135._hardwareId;
            }
            mo = yield _this135._parent.get_module();
            _this135._hardwareId = (yield mo.get_serialNumber()) + '.' + (yield _this135.get_functionId());
            return _this135._hardwareId;
        })();
    }
    ...
    get_progress() {
        ...
        return _asyncToGenerator(function* () {
            if (_this140._progress < 0) {
                return 0;
            }
            // index not yet loaded
            if (_this140._progress >= _this140._streams.length) {
                return 100;
            }
            return parseInt((1 + (1 + _this140._progress) * 98) / (1 + _this140._streams.length), 10);
        })();
    }
    ...
    loadMore() {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YDataStream} **/
            let stream;
            if (_this141._progress < 0) {
                url = 'logger.json?id=' + _this141._functionId;
            } else {
                if (_this141._progress >= _this141._streams.length) {
                    return 100;
                } else {
                    stream = _this141._streams[_this141._progress];
                    url = stream.imm_get_url();
                }
            }
            return yield _this141.processMore(_this141._progress, (yield _this141._parent._download(url)));
        })();
    }
    ...
    get_measuresAt(measure) {
        ...
        return _asyncToGenerator(function* () {
            ...
            stream = null;
            for (let ii in _this144._streams) {
                if ((yield _this144._streams[ii].get_startTimeUTC()) == startUtc) {
                    stream = _this144._streams[ii];
                }
                ;;
            }
            if (stream == null) {
            ...
            for (let ii in dataRows) {
                if (tim >= _this144._startTime && (_this144._endTime == 0 || tim <= _this144._endTime)) {
    ...
    _parse(str_json) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!loadval) {
                // no data available
                _this146._progress = 0;
                return _this146;
            }

            _this146._functionId = loadval.id;
            _this146._unit = loadval.unit;
            if (loadval.calib) {
                _this146._calib = _this146._yapi.imm_decodeFloats(loadval.calib);
                _this146._calib[0] = parseInt(_this146._calib[0] / 1000);
            } else {
                _this146._calib = _this146._yapi.imm_decodeWords(loadval.cal);
            }
            _this146._summary = new YMeasure(0, 0, 0, 0, 0);
            _this146._streams = [];
            _this146._preview = [];
            _this146._measures = [];
            for (var i = 0; i < loadval.streams.length; i++) {
                var stream = _this146._parent.imm_findDataStream(_this146, loadval.streams[i]);
                ...
                if (_this146._startTime > 0 && streamEndTime <= _this146._startTime) {
                    // this stream is too early, drop it
                } else if (_this146._endTime > 0 && (yield stream.get_startTimeUTC()) > _this146._endTime) {
                        // this stream is too late, drop it
                    } else {
                            _this146._streams.push(stream);
                            ...
                            if (stream.isClosed() && (yield stream.get_startTimeUTC()) >= _this146._startTime && (_this146._endTime == 0 || streamEndTime <= _this146._endTime)) {
                                ...
                                _this146._preview.push(rec);
                            }
                        }
            }
            if (_this146._streams.length > 0 && summaryTotalTime > 0) {
                // update time boundaries with actual data
                if (_this146._startTime < startTime) {
                    _this146._startTime = startTime;
                }
                if (_this146._endTime == 0 || _this146._endTime > endTime) {
                    _this146._endTime = endTime;
                }
                _this146._summary = new YMeasure(_this146._startTime, _this146._endTime, summaryMinVal, summaryTotalAvg / summaryTotalTime, summaryMaxVal);
            }
            _this146._progress = 0;
            return _this146;
        })();
...
class YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this147.request('GET', _this147.urlInfo.url, '/api/module.json', null);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    hubUpdateDeviceList() {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YDevice} **/
            let hubDev = _this148._yapi.imm_getDevice(_this148.urlInfo.url);
            /** @type {number} **/
            let retcode = yield hubDev.refresh();
            if (retcode != YAPI_SUCCESS) {
                return _this148._throw(retcode, hubDev._lastErrorMsg, retcode);
            }
            /** @type {YHTTPRequest} **/
            let yreq = yield hubDev.requestAPI(_this148._yapi.defaultCacheValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
                return yreq;
            }
            let loadval = null;
            try {
                loadval = JSON.parse(_this148._yapi.imm_bin2str(yreq.bin_result));
            } catch (err) {}
            if (!loadval) {
                return _this148._throw(YAPI_IO_ERROR, 'Request failed, could not parse API result for ' + hubDev.imm_describe(), YAPI_IO_ERROR);
            }
            let whitePages = loadval['services']['whitePages'];
            let yellowPages = loadval['services']['yellowPages'];
            if (whitePages == undefined) {
                return _this148._throw(YAPI_INVALID_ARGUMENT, 'Device ' + hubDev.imm_describe() + ' is not a hub', YAPI_INVALID_ARGUMENT);
            }
            retcode = yield _this148._yapi.updateDeviceList_process(_this148, hubDev, whitePages, yellowPages);
            if (retcode != YAPI_SUCCESS) {
                return _this148._throw(_this148._yapi._lastErrorType, _this148._yapi._lastErrorMsg, _this148._yapi._lastErrorType);
            }

            // reset device list cache timeout for this hub
            _this148.devListExpires = _this148._yapi.GetTickCount() + _this148.devListValidity;
            return YAPI_SUCCESS;
        })();
    }
...
class YHttpHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this150.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '?len=' + _this150.notiflen.toString();
            if (_this150.notifPos > 0) {
                args += '&abs=' + _this150.notifPos.toString();
            }
            _this150.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this150.notbynRequest = new XMLHttpRequest();
                _this150.notbynRequest.open('GET', _this150.urlInfo.url + 'not.byn' + args, true, '', '');
                _this150.notbynRequest.overrideMimeType('text/plain; charset=x-user-defined');
                _this150.notbynRequest.onreadystatechange = function () {
                    if (_this150.disconnecting) {
                        return;
                    }
                    if (_this150.notbynRequest.readyState >= 3) {
                        resolve(YAPI_SUCCESS);
                        if (_this150.notbynRequest.readyState == 4 && parseInt(_this150.notbynRequest.status) != 200 && parseInt(_this150.notbynRequest.status) != 304) {
                            // connection error
                            if (_this150.retryDelay < 15000) _this150.retryDelay *= 2;
                            _this150.devListValidity = 500;
                            _this150.devListExpires = 0;
                            setTimeout(function () {
                                _this150.testHub(new YErrorMsg());
                            }, _this150.retryDelay);
                        } else {
                            // receiving data properly
                            if (_this150.notbynRequest.readyState == 3) {
                                // when using reconnection mode, ignore state 3
                                if (_this150.notiflen == 1) return;
                            }
                            let newlen = _this150.notbynRequest.responseText.length;
                            if (newlen > _this150.currPos) {
                                _this150._yapi.parseEvents(_this150, _this150.notbynRequest.responseText.substr(_this150.currPos, newlen - _this150.currPos));
                            }
                            // trigger immediately a new connection if closed in success
                            if (_this150.notbynRequest.readyState == 4 && parseInt(_this150.notbynRequest.status) != 0) {
                                _this150.currPos = 0;
                                _this150.testHub(new YErrorMsg());
                            }
                        }
                ...
                _this150.notbynRequest.send('');
            });
            return yield _this150.notbynOpenPromise;
        })();
    }
                ...
                httpRequest.onreadystatechange = function () {
                    if (httpRequest.readyState == 4) {
                        ...
                        if (httpRequest.status != 200 && httpRequest.status != 304) {
                            ...
                            yreq.errorMsg = 'HTTP Error ' + httpRequest.status + ' on ' + baseUrl + devUrl;
                        } else {
                            yreq.bin_result = _this151._yapi.imm_str2bin(httpRequest.responseText);
                        }
                        resolve(yreq);
                    }
                };
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            _this152.imm_commonDisconnect();
            _this152.notbynRequest.abort();
        })();
    }
}
...
class YHttpNodeHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this153.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '';
            if (_this153.notifPos > 0) {
                args = '?abs=' + _this153.notifPos.toString();
            }
            let options = {
                method: 'GET',
                hostname: _this153.urlInfo.host,
                port: _this153.urlInfo.port,
                path: '/not.byn' + args
            };
            _this153.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this153.notbynRequest = _this153.http.request(options, function (res) {
                    if (_this153.disconnecting) {
                        return;
                    }
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        if (_this153.retryDelay < 15000) _this153.retryDelay *= 2;
                        _this153.devListValidity = 500;
                        _this153.devListExpires = 0;
                        setTimeout(function () {
                        ...
                        res.on('data', function (chunk) {
                            // receiving data properly
                            _this153._yapi.parseEvents(_this153, _this153._yapi.imm_bin2str(chunk));
                        });
                        res.on('end', function () {
                            // trigger immediately a new connection if closed in success
                            _this153.currPos = 0;
                ...
                _this153.notbynRequest.on('error', function () {
                ...
                _this153.notbynRequest.end();
            });
            return yield _this153.notbynOpenPromise;
        })();
    }
    ...
    request(str_method, baseUrl, devUrl, obj_body) {
        ...
        return _asyncToGenerator(function* () {
            let options = {
                method: str_method,
                hostname: _this154.urlInfo.host,
                port: _this154.urlInfo.port,
                path: devUrl
            };
            let httpPromise = new Promise(function (resolve, reject) {
                let response = new Buffer(0);
                let httpRequest = _this154.http.request(options, function (res) {
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        let yreq = new YHTTPRequest(null);
                        yreq.errorType = YAPI_NOT_SUPPORTED;
                        yreq.errorMsg = 'HTTP Error ' + res.statusCode.toString() + ' on ' + baseUrl + devUrl;
                        resolve(yreq);
                    } else {
                        res.on('data', function (chunk) {
                            // receiving data properly
...
class YHttpCallbackHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            yield _this156.httpCallbackPromise;
            if (_this156._incomingMessage.method != 'POST') {
                errmsg.msg = 'HTTP POST expected';
                return YAPI_INVALID_ARGUMENT;
            }
            if (_this156._callbackData.length == 0) {
                errmsg.msg = 'Empty POST body';
                return YAPI_NO_MORE_DATA;
            }
            if (_this156.urlInfo.pass != '') {
                // callback data signed, verify signature
                if (!_this156._callbackCache.sign) {
                    errmsg.msg = 'missing signature from incoming YoctoHub (callback password required)';
                    _this156._callbackCache = [];
                    return YAPI_NO_MORE_DATA;
                }
                let sign = _this156._callbackCache['sign'];
                let pass = _this156.urlInfo.pass;
                let salt;
                if (pass.length == 32) {
                    salt = pass.toLowerCase();
                } else {
                    salt = _this156._yapi.imm_bin2hexstr(_this156._yapi.imm_yMD5(pass)).toLowerCase();
                }
                let patched = _this156._yapi.imm_bin2str(_this156._callbackData).replace(sign, salt);
                let check = _this156._yapi.imm_bin2hexstr(_this156._yapi.imm_yMD5(patched));
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_method == 'POST' && obj_body.length > 2) {
                ...
                if (endb > 2 && endb < 20 && obj_body[0] == 45 && obj_body[1] == 45) {
                    boundary = _this157._yapi.imm_bin2str(obj_body.subarray(2, endb));
                }
                _this157._serverResponse.write('\n@YoctoAPI:' + str_method + ' ' + devUrl + ' ' + obj_body.length + ':' + boundary + '\n');
                _this157._serverResponse.write(obj_body);
                ...
                if (devUrl.indexOf('?') == -1 || devUrl.indexOf('/logs.txt') != -1 || devUrl.indexOf('/logger.json') != -1 || devUrl.indexOf('/ping.txt') != -1 || devUrl.indexOf('/files.json?a=dir') != -1) {
                    ...
                    if (!_this157._callbackCache[devUrl]) {
                        ...
                        var jsonres = _this157._callbackCache[devUrl];
                        if (subfun) {
                            jsonres = jsonres[subfun[1]];
                        }
                        yreq.bin_result = _this157._yapi.imm_str2bin(JSON.stringify(jsonres));
                    }
                } else {
...
class YWebSocketHub extends YGenericHub {
     ...
     **/
    imm_asyncWebSocketError(message) {
        this._yapi._throw(YAPI_IO_ERROR, 'WS: ' + message, null);
    }
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this158.imm_webSocketOpen(_this158.urlInfo.url + 'not.byn');
            _this158.websocketOpenPromise = new Promise(function (resolve, reject) {
                if (_this158.disconnecting) {
                    resolve(YAPI_IO_ERROR);
                } else {
                    _this158.websocket.onmessage = function (evt) {
                        _this158._webSocketMsg(new Uint8Array(evt.data));
                        if (_this158._connectionState == _this158._WS_CONNECTED) {
                            resolve(YAPI_SUCCESS);
                        } else if (_this158._connectionState == _this158._WS_DEAD) {
                            console.log('WebSocket error: ' + _this158._session_error);
                            resolve(YAPI_IO_ERROR);
                        }
                    };
                }
            });
            _this158.websocket.onclose = function (evt) {
                _this158.websocket = null;
                if (_this158.retryDelay < 0) {
                    _this158.disconnecting = true;
                }
                if (_this158.disconnecting) {
                    return;
                }
                // connection error
                if (_this158.retryDelay < 15000) _this158.retryDelay *= 2;
                _this158.devListValidity = 500;
                _this158.devListExpires = 0;
                setTimeout(function () {
                    _this158.testHub(new YErrorMsg());
                }, _this158.retryDelay);
            };
            _this158.websocket.onerror = function (evt) {
                console.log('WebSocket error: ', evt);
                _this158.websocket.terminate();
                _this158.websocket = null;
                if (_this158.retryDelay < 0) {
                    _this158.disconnecting = true;
                }
            ...
            return yield _this158.websocketOpenPromise;
        })();
    }
    ...
    _webSocketMsg(arr_bytes) {
        ...
        return _asyncToGenerator(function* () {
            ...
            var text = '';
            if (ystream == _this159._YSTREAM_TCP_NOTIF) {
                for (let i = 1; i < arr_bytes.length; i++) {
                    text += String.fromCharCode(arr_bytes[i]);
                }
                yield _this159._yapi.parseEvents(_this159, text);
                return;
            }
            // Other types of messages
            var ws = _this159.websocket;
            var tcpchan = arr_bytes[0] & 7;
            if (ystream == _this159._YSTREAM_TCP || ystream == _this159._YSTREAM_TCP_CLOSE || ystream == _this159._YSTREAM_TCP_ASYNCCLOSE) {
                let tcp_end = arr_bytes.length;
                let yreq = _this159.tcpChan[tcpchan];
                if (!yreq) {
                    _this159.imm_asyncWebSocketError('Drop frame for closed tcpChan ' + tcpchan);
                    return;
                }
                if (ystream == _this159._YSTREAM_TCP_ASYNCCLOSE) {
                    // async close packet, check async signature byte
                    tcp_end--;
                    if (yreq.asyncId == 0) {
                        _this159.imm_asyncWebSocketError('Asynchronous close received, sync reply request');
                        return;
                    } else if (yreq.asyncId != arr_bytes[tcp_end]) {
                        _this159.imm_asyncWebSocketError('Incorrect async-close signature on tcpChan ' + tcpchan);
                        return;
                    }
                }
                ...
                if (ystream == _this159._YSTREAM_TCP_CLOSE || ystream == _this159._YSTREAM_TCP_ASYNCCLOSE) {
                    // Pop request from tcp channel
                    _this159.tcpChan[tcpchan] = yreq.next;

                    // Handle synchronous close
                    if (ystream == _this159._YSTREAM_TCP_CLOSE) {
                        // synchronous close
                        if (yreq.asyncId != 0) {
                            _this159.imm_asyncWebSocketError('Synchronous close received, async ack expected');
                            return;
                        } else if (yreq.timeoutId) {
                            // request was not aborted, ack synchronous close by sending YSTREAM_TCP_CLOSE
                            let frame = new Uint8Array(1);
                            frame[0] = (_this159._YSTREAM_TCP_CLOSE << 3) + tcpchan;
                            _this159.websocket.send(frame);
                        }
                    }
                    ...
                    if (pos < 0) {
                        ...
                        let header = _this159._yapi.imm_bin2str(yreq.bin_result.subarray(0, pos));
                    ...
                    if (yreq.asyncId == 0) {
                        yreq.acceptor(yreq);
                        _this159.imm_sendPendingRequest(tcpchan);
                    } else {
                        // asynchronous request: log errors, but nothing else to be done
                        if (yreq.errorType != YAPI_SUCCESS) {
                            _this159.imm_asyncWebSocketError('Async request error: ' + yreq.errorMsg);
                        }
                    }
                }
                return;
            }
            if (ystream == _this159._YSTREAM_META) {
                let metatype = arr_bytes[1];
                switch (metatype) {
                    case _this159._USB_META_WS_ANNOUNCE:
                        if (arr_bytes.length < 1 + _this159._USB_META_WS_ANNOUNCE_SIZE) {
                            return;
                        }
                        _this159._remoteVersion = arr_bytes[2];
                        if (_this159._remoteVersion < 1) {
                            return;
                        }
                        // bytes 3 & 4 are reserved for future use
                        _this159._remoteNonce = arr_bytes[5] + (arr_bytes[6] << 8) + (arr_bytes[7] << 16) + (arr_bytes[8] << 24);
                        for (let i = 9; i < 9 + 20; i++) {
                            if (arr_bytes[i] == 0) {
                                _this159._remoteSerial = _this159._yapi.imm_bin2str(arr_bytes.subarray(9, i));
                                break;
                            }
                        }
                        _this159._nonce = parseInt(Math.random() * 0xffffffff);
                        _this159._connectionState = _this159._WS_AUTHENTICATING;
                        // send our authentication packet
                        let frame = new Uint8Array(1 + _this159._USB_META_WS_AUTHENTICATION_SIZE);
                        let version = 1,
                            flags = 0;
                        frame[0] = _this159._YSTREAM_META << 3;
                        frame[1] = _this159._USB_META_WS_AUTHENTICATION;
                        frame[2] = version;
                        if (_this159.urlInfo.pass != '') {
                            flags = _this159._USB_META_WS_VALID_SHA1;
                            let sha1 = _this159.imm_computeAuth(_this159.urlInfo.user, _this159.urlInfo.pass, _this159._remoteSerial, _this159._remoteNonce);
                        ...
                        frame[3] = flags & 0xff;
                        frame[4] = flags >>> 8;
                        frame[5] = _this159._nonce & 0xff;
                        frame[6] = _this159._nonce >>> 8 & 0xff;
                        frame[7] = _this159._nonce >>> 16 & 0xff;
                        frame[8] = _this159._nonce >>> 24 & 0xff;
                        _this159.websocket.send(frame);
                        break;
                    case _this159._USB_META_WS_AUTHENTICATION:
                        if (_this159._connectionState != _this159._WS_AUTHENTICATING) {
                            return;
                        }
                        if (arr_bytes.length < 1 + _this159._USB_META_WS_AUTHENTICATION_SIZE) {
                            return;
                        }
                        _this159._remoteVersion = arr_bytes[2];
                        if (_this159._remoteVersion < 1) {
                        ...
                        if ((inflags & _this159._USB_META_WS_VALID_SHA1) != 0) {
                            let remote_sha1 = arr_bytes.subarray(9, 29);
                            let sha1 = _this159.imm_computeAuth(_this159.urlInfo.user, _this159.urlInfo.pass, _this159._remoteSerial, _this159._nonce);
                            for (let i = 0; i < sha1.length; i++) {
                                if (sha1[i] != remote_sha1[i]) {
                                    // bad signature
                                    _this159._session_errno = 401;
                                    _this159._session_error = "Authentication failed";
                                    _this159._connectionState = _this159._WS_DEAD;
                                    return;
                                }
                            }
                            // Password verified OK
                            _this159._connectionState = _this159._WS_CONNECTED;
                        } else {
                            if (_this159.urlInfo.pass == '') {
                                ...
                                _this159._session_errno = 401;
                                _this159._session_error = "Password not set on remote hub";
                                _this159._connectionState = _this159._WS_DEAD;
                                return;
                            }
                        }
                        break;
                    case _this159._USB_META_WS_ERROR:
                        // drop reserved byte
                        _this159._session_errno = arr_bytes[3] + (arr_bytes[4] << 8);
                        if (_this159._session_errno == 401) {
                            _this159._session_error = "Authentication failed";
                        } else {
                            _this159._session_error = "Remote hub closed connection with error " + _this159._session_errno;
                        }
                        _this159._connectionState = _this159._WS_DEAD;
                        break;
                }
            ...
            _this159.imm_asyncWebSocketError('Unsupported message: ' + _this159._yapi.imm_bin2hexstr(arr_bytes));
        })();
    }
    ...
    request(method, baseUrl, devUrl, obj_body) {
        ...
        return _asyncToGenerator(function* () {
            let httpPromise = new Promise(function (resolve, reject) {
                ...
                let ws = _this160.websocket;
                let isAsync = _this160._remoteVersion > 0 && devUrl.slice(-2) == '&.';
                let yreq = new YHTTPRequest(new Uint8Array(0));

                yreq.acceptor = resolve;
                yreq.devUrl = devUrl;
                yreq.toBeSent = new Uint8Array(subReq.length + (obj_body ? obj_body.length : 0));
                for (let i = 0; i < subReq.length; i++) {
                    yreq.toBeSent[i] = subReq.charCodeAt(i);
                }
                if (obj_body) {
                    yreq.toBeSent.set(obj_body, subReq.length);
                }

                if (!ws || _this160.disconnecting) {
                    yreq.errorType = YAPI_IO_ERROR;
                ...
                if (isAsync) {
                    yreq.asyncId = _this160.nextAsyncId++;
                    if (_this160.nextAsyncId >= 127) {
                        _this160.nextAsyncId = 48;
                    }
                }

                // Queue all requests on tcpChan 0 for now, to preserve request order
                let tcpchan = 0;
                let queue = _this160.tcpChan[tcpchan];
                if (queue) {
                    while (queue.next) {
                        queue = queue.next;
                    }
                    ...
                    _this160.tcpChan[tcpchan] = yreq;
                }

                // Send request if possible
                _this160.imm_sendPendingRequest(tcpchan);
            });
    ...
    imm_sendPendingRequest(tcpchan) {
        ...
        while (yreq) {
            ...
            let pos = 0;
            let i, frame;
            while (pos < yreq.toBeSent.length) {
                let framelen = 1 + yreq.toBeSent.length - pos;
                ...
                frame.set(yreq.toBeSent.slice(pos, pos + datalen), 1);
                pos += datalen;
            ...
            yreq.timeoutId = setTimeout(function (chan, yr) {
                _this161.imm_abortRequest(chan, yr);
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this162.websocket.close();
            _this162.websocket = null;
        })();
    }
}
...
class YAPIContext {
    ...
    _addHub(newhub) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this163._hubs.push(newhub);

            // If hub is not yet known, create a device object (synchronous call)
            var serial = _this163._snByUrl[newhub.urlInfo.url];
            if (!serial) {
                let dev = new YDevice(_this163, newhub.urlInfo.url, null, null);
                yield dev.refresh();
            }
        })();
    }
    ...
    _updateDeviceList_internal(bool_forceupdate, bool_invokecallbacks) {
        ...
        return _asyncToGenerator(function* () {
            if (_this164._firstArrival && bool_invokecallbacks && _this164._arrivalCallback) {
                bool_forceupdate = true;
            }
            if (bool_forceupdate) {
                for (let i = 0; i < _this164._hubs.length; i++) {
                    _this164._hubs[i].imm_forceUpdate();
                }
            }
            if (_this164._updateDevListStarted && _this164.GetTickCount() - _this164._updateDevListStarted < 30 * 1000) {
                return {
            ...
            try {
                ...
                _this164._updateDevListStarted = _this164.GetTickCount();

                // collect list of hubs which should be checked
                let hubs = [];
                for (let i = 0; i < _this164._hubs.length; i++) {
                    let hub = _this164._hubs[i];
                    let rootUrl = hub.urlInfo.url;
                    let hubDev = _this164.imm_getDevice(rootUrl);
                    if (!hubDev) continue;
                    if (hub.devListExpires <= _this164.GetTickCount()) {
                        hub.missing = [];
                        hubs.push(hub);
                    }
                }
                ...
                for (let serial in _this164._devs) {
                    let rooturl = _this164._devs[serial].imm_getRootUrl();
                ...
                if (bool_invokecallbacks) {
                    let nbEvents = _this164._pendingCallbacks.length;
                    for (let i = 0; i < nbEvents; i++) {
                        let evt = _this164._pendingCallbacks[i];
                        let serial = evt.slice(1);
                        switch (evt.charAt(0)) {
                            case '+':
                                if (_this164._arrivalCallback != undefined) {
                                    yield _this164._arrivalCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '/':
                                if (_this164._namechgCallback != undefined) {
                                    yield _this164._namechgCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '-':
                                if (_this164._removalCallback != undefined) {
                                    yield _this164._removalCallback(yFindModule(serial + '.module'));
                                }
                                _this164.imm_forgetDevice(_this164._devs[serial]);
                                break;
                        }
                    }
                    _this164._pendingCallbacks = _this164._pendingCallbacks.slice(nbEvents);
                    if (_this164._arrivalCallback != undefined && _this164._firstArrival) {
                        _this164._firstArrival = false;
                    }
                }
            } finally {
                _this164._updateDevListStarted = false;
            }
    ...
    updateDeviceList_process(hub, hubDev, whitePages, yellowPages) {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let classname in yellowPages) {
                ...
                let ftype = _this165._fnByType[classname];
                if (ftype == undefined) {
                    ftype = new YFunctionType(_this165, classname);
                    _this165._fnByType[classname] = ftype;
                }
            ...
            for (let devkey in whitePages) {
                ...
                var currdev = _this165._devs[serial];
                if (currdev && _this165._arrivalCallback != undefined && _this165._firstArrival) {
                    _this165._pendingCallbacks.push('+' + serial);
                }
                hub.serialByYdx[devydx] = serial;
                if (!currdev) {
                    // Add new device
                    //noinspection ObjectAllocationIgnored
                    new YDevice(_this165, rooturl, devinfo, yellowPages);
                    if (_this165._arrivalCallback != undefined) {
                        _this165._pendingCallbacks.push('+' + serial);
                    }
                } else if (currdev.imm_getLogicalName() != devinfo['logicalName']) {
                    // Reindex device from its own data
                    yield currdev.refresh();
                    if (_this165._namechgCallback != undefined) {
                        _this165._pendingCallbacks.push('/' + serial);
                    }
            ...
            for (serial in hub.missing) {
                if (hub.missing[serial]) {
                    if (_this165._removalCallback != undefined) {
                        _this165._pendingCallbacks.push('-' + serial);
                    } else {
                        _this165.imm_forgetDevice(_this165._devs[serial]);
                    }
                }
            }
        ...
        return _asyncToGenerator(function* () {
            ...
            for (var idx = 0; idx < nrows; idx++) {
                ...
                if (ev.length >= 3 && firstCode >= NOTIFY_NETPKT_FLUSHV2YDX && firstCode <= NOTIFY_NETPKT_TIMEAVGYDX) {
                    ...
                    if (serial && _this166._devs[serial]) {
                        var funcid = funydx == 0xf ? 'time' : _this166._devs[serial].imm_functionId(funydx);
                        if (funcid != '') {
                            value = ev.slice(3);
                            switch (firstCode) {
                                case NOTIFY_NETPKT_FUNCVALYDX:
                                    ...
                                    _this166.imm_setFunctionValue(serial + '.' + funcid, value);
                                    break;
                                ...
                                case NOTIFY_NETPKT_TIMEV2YDX:
                                    ...
                                    var dev = _this166._devs[serial];
                                    if (funcid == 'time') {
                                        var time = arr[1] + 0x100 * arr[2] + 0x10000 * arr[3] + 0x1000000 * arr[4];
                                        dev.imm_setDeviceTime(time + arr[5] / 250.0);
                                    } else {
                                        _this166.imm_setTimedReport(serial + '.' + funcid, dev.imm_getDeviceTime(), arr);
                                    }
                                    break;
                                case NOTIFY_NETPKT_FUNCV2YDX:
                                    var rawval = _this166.imm_decodeNetFuncValV2(value);
                                    if (rawval != null) {
                                        var decodedval = _this166.imm_decodePubVal(rawval[0], rawval, 1, 6);
                                        _this166.imm_setFunctionValue(serial + '.' + funcid, decodedval);
                                    }
                                    break;
                    ...
                    if (notype == '@') {
                        ...
                        case 5:
                            ...
                            if (parts.length > 2) {
                                ...
                                _this166.imm_setFunctionValue(parts[0] + '.' + parts[1], value[0]);
                            }
                            break;
                    }
                } else {
            ...
            if (_this166._forwardValues > 0) {
                yield _this166.HandleEvents(new YErrorMsg());
            }
        })();
    }
    ...
    _UpdateValueCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this167._ValueCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this167._ValueCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this167._ValueCallbackList.splice(index, 1);
            }
        })();
    }
    ...
    _UpdateTimedReportCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this168._TimedReportCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this168._TimedReportCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this168._TimedReportCallbackList.splice(index, 1);
            }
        })();
    }
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_device.substr(0, 7) == 'http://' || str_device.substr(0, 5) == 'ws://') {
                ...
                if (lines[0].substr(0, 12) != 'GET /not.byn') {
                    /** @type {string} **/
                    let serial = _this169._snByUrl[baseUrl];
                    if (serial) {
                        lockdev = _this169._devs[serial];
                    }
                }
            } else {
                lockdev = _this169.imm_getDevice(str_device);
                if (!lockdev) {
                ...
                if (lines[0] == 'GET /api.json') {
                    return yield lockdev.requestAPI(_this169.defaultCacheValidity);
                }
            ...
            /** @type {YGenericHub} **/
            let hub = _this169.imm_getHub(baseUrl);
            /** @type {string} **/
            let method = words[0];
            /** @type {string} **/
            let devUrl = words[1];
    ...
    _funcDev(str_className, str_func) {
        ...
        return _asyncToGenerator(function* () {
            var resolve = _this170.imm_funcDev_internal(str_className, str_func);
            if (resolve.errorType == YAPI_SUCCESS) {
                return resolve;
            } else if (resolve.errorType == YAPI_DEVICE_NOT_FOUND && _this170._hubs.length == 0) {
            ...
            var updRes = yield _this170._updateDeviceList_internal(true, false);
            if (updRes.errorType != YAPI_SUCCESS) {
                resolve.errorType = updRes.errorType;
                resolve.errorMsg = updRes.errorMsg;
                return resolve;
            }
            return _this170.imm_funcDev_internal(str_className, str_func);
        })();
    }
    ...
    funcRequest(str_className, str_func, str_extra) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let funcreq = yield _this171._funcDev(str_className, str_func);
            ...
            if (str_extra == '') {
                ...
                if (yreq != null) {
                    if (yreq.errorType != YAPI_SUCCESS) return yreq;
                    try {
                        let jsonData = JSON.parse(_this171.imm_bin2str(yreq.bin_result));
            ...
            if (!loadval) {
                ...
                /** @type {YHTTPRequest} **/
                yreq = yield _this171.devRequest(devreq.deviceid, httpreq);
                if (yreq.errorType != YAPI_SUCCESS) return yreq;
                ...
                try {
                    loadval = JSON.parse(_this171.imm_bin2str(yreq.bin_result));
                } catch (err) {
                    //console.log('RequestAPI parse error: ', err);
                }
            }
    ...
    HTTPRequest(str_device, str_request) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YHTTPRequest} **/
            let yreq = yield _this172.devRequest(str_device, str_request);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this172._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    GetAPIVersion() {
        return _asyncToGenerator(function* () {
            return (/* version number patched automatically */'1.10.23100'
            );
        })();
    }
    ...
    DisableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this174.exceptionsDisabled = true;
        })();
    }
    ...
    EnableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this175.exceptionsDisabled = false;
        })();
    }
    ...
    RegisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this177.imm_parseRegisteredUrl(url);
            let newhub = _this177.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this177.imm_registerHub_internal(urlInfo);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                return _this177._throw(retcode, errmsg.msg, retcode);
            }
            yield _this177._addHub(newhub);

            // Update known device list
            let yreq = yield _this177._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this177._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
                return _this177._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    PreregisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this178.imm_parseRegisteredUrl(url);
            let newhub = _this178.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this178.imm_registerHub_internal(urlInfo);
            _this178._addHub(newhub);
    ...
    RegisterHubHttpCallback(incomingMessage, serverResponse, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this179.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this179.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YHttpCallbackHub(_this179, urlInfo, incomingMessage, serverResponse);
            yield newhub.httpCallbackPromise;
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                _this179._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                return _this179._throw(retcode, errmsg.msg, retcode);
            }
            yield _this179._addHub(newhub);

            // Update known device list
            let yreq = yield _this179._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this179._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
                return _this179._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    RegisterHubWebSocketCallback(ws, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this180.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this180.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YWebSocketCallbackHub(_this180, urlInfo, ws);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                return _this180._throw(retcode, errmsg.msg, retcode);
            }
            yield _this180._addHub(newhub);

            // Update known device list
            let yreq = yield _this180._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                }
                return _this180._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    UnregisterHub(url) {
        ...
        return _asyncToGenerator(function* () {
            var urlInfo = _this181.imm_parseRegisteredUrl(url);
            var i, j;

            for (i = 0; i < _this181._hubs.length; i++) {
                if (_this181._hubs[i].urlInfo.url == urlInfo.url) {
                    _this181._hubs[i].disconnect();
                    for (j = 0; j < _this181._hubs[i].serialByYdx.length; j++) {
                        var serial = _this181._hubs[i].serialByYdx[j];
                        _this181.imm_forgetDevice(_this181._devs[serial]);
                    }
                    var before = _this181._hubs.slice(0, i);
                    if (i + 1 < _this181._hubs.length) {
                        var after = _this181._hubs.slice(i + 1);
                        _this181._hubs = before.concat(after);
                    }
                    _this181._hubs = before;
                    return;
                }
            }
        })();
    ...
    UpdateDeviceList(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var yreq = yield _this182._updateDeviceList_internal(false, true);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) errmsg.msg = yreq.errorMsg;
                return _this182._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    HandleEvents(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var nEvents = _this183._data_events.length;
            for (var i = 0; i < nEvents; i++) {
                var evt = _this183._data_events[i];
                if (typeof evt[1] == 'string') {
                    ...
                    var dev = _this183.imm_getDevice(evt[0]._serial);
                    if (dev) {
            ...
            _this183._data_events = _this183._data_events.slice(nEvents);
    ...
    Sleep(ms_duration, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var end = _this184.GetTickCount() + ms_duration;
            yield _this184.HandleEvents(errmsg);
            while (_this184.GetTickCount() < end) {
                yield _this184._microSleep_internal();
                yield _this184.HandleEvents(errmsg);
            }
            return YAPI_SUCCESS;
        })();
    ...
    _setTimeout_internal(callback, endtime, args, errmsg) {
        ...
        if (delay < 0) {
            ...
            this.Sleep(delay, errmsg).then(function () {
                _this185._setTimeout_internal(callback, endtime, args);
            });
        } else {
            this.UpdateDeviceList(errmsg).then(function () {
                _this185.Sleep(90, errmsg).then(function () {
                    _this185._setTimeout_internal(callback, endtime, args);
                });
            });
        }
    ...
    RegisterDeviceArrivalCallback(arrivalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this186._arrivalCallback = arrivalCallback;
        })();
    }
    ...
    RegisterDeviceChangeCallback(changeCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this187._namechgCallback = changeCallback;
        })();
    }
    ...
    RegisterDeviceRemovalCallback(removalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this188._removalCallback = removalCallback;
        })();
    }
    ...
    RegisterCalibrationHandler(calibrationType, calibrationHandler) {
        ...
        return _asyncToGenerator(function* () {
            _this189._calibHandlers[calibrationType.toString()] = calibrationHandler;
        })();
    }
    ...
    ComputePSK(ssid, pass) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this190.imm_initshaw(pass, 0, 0, 0x3636, _shaw);
            _this190.imm_itershaw(sha1_init, _shaw);
            for (k = 0; k < 5; k++) inner[k] = _shaw[k];
            _shaw = new Uint32Array(80);
            _this190.imm_initshaw(pass, 0, 0, 0x5c5c, _shaw);
            _this190.imm_itershaw(sha1_init, _shaw);
            ...
            _shaw = new Uint32Array(80);
            _this190.imm_initshaw(ssid, 0, 1, 0, _shaw);

            for (iter = 0; iter < 8192;) {
                _this190.imm_itershaw(inner, _shaw);
                _shaw[5] = 0x80000000;
                for (k = 6; k < 15; k++) {
                    _shaw[k] = 0;
                }
                _shaw[15] = 8 * (64 + 20);
                _this190.imm_itershaw(outer, _shaw);
                shau[0] ^= _shaw[0];
                shau[1] ^= _shaw[1];
                shau[2] ^= _shaw[2];
                shau[3] ^= _shaw[3];
                ...
                if ((iter & 4095) == 0) {
                    ...
                    if (iter == 4096) {
                        for (k = 0; k < 5; k++) shau[k] = 0;
                        _shaw = new Uint32Array(80);
                        _this190.imm_initshaw(ssid, 2, 0, _shaw);
                    }
                }
            }
            var hex = '';
