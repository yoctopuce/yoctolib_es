...
class YHTTPBody {
     ...
     */
    constructor(str_fname, bin_data) {
...
class YDevice {
    ...
    requestAPI(int_msValidity) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this31._yapi.devRequest(_this31._rootUrl, 'GET /api.json');
...
/**
 * YFirmwareUpdate Class: Object describing a loaded firmware file
 */
class YFirmwareFile {
    ...
    static imm_Parse(path, data) {
        ...
        switch (rev) {
            ...
            case BYN_REV_V5:
                ...
                if (!YFirmwareFile.imm_progCompatible(prog_version)) return null;
                getShort(); //skip pad
                ROM_nb_zone = getInt();
                datasize = getInt();
                if (ROM_nb_zone > MAX_ROM_ZONES_PER_FILES) return null;
...
class YFirmwareUpdate {
    ...
    _processMore(newupdate) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YFirmwareFile} **/
            let firmware = YFirmwareFile.imm_Parse(_this33._firmwarepath, bytes);
            ...
            yield hub.firmwareUpdate(_this33._serial, firmware, _this33._settings, function (percent, msg) {
                _this33.imm_progress(5 + percent * 80 / 100, msg);
            });
            _this33.imm_progress(80, 'Wait for the device to restart');
            let timeout = _this33._yapi.GetTickCount() + 30000;
    ...
    static checkFirmware_r(file, serial_base) {
        return _asyncToGenerator(function* () {
            if (YAPI._isNodeJS) {
                    ...
                    let dirPromise = new Promise(function (resolve, reject) {
                        ...
                        fs.readdir(dir, function (err, files) {
                            ...
                            let tasks = files.map(function (fname) {
                                ...
                                return YFirmwareUpdate.checkFirmware_r(join(dir, fname), serial_base);
                            });
            ...
            let firmware = YFirmwareFile.imm_Parse(file, bynfile);
    ...
    static CheckFirmware(serial, path, minrelease) {
        return _asyncToGenerator(function* () {
            ...
            if (typeof path == 'string' && path.indexOf('yoctopuce.com') >= 0) {
                ...
                /** @type {YFirmwareFile} **/
                let firmware = yield YFirmwareUpdate.checkFirmware_r(path, serial.substring(0, 8));
                if (firmware != null) {
     ...
     *
     * @return {string[]} an array of strings containing the serial list of module in "update" mode.
     */
...
class YFunction {
    ...
    _setAttr(str_attr, str_newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            yield _this55._yapi.funcRequest(_this55._className, _this55._func, extra);
    ...
    _download(str_path) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this56._yapi.devRequest(devid, 'GET /' + str_path);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    _upload(str_path, bin_content) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this58._yapi.devRequest(devid, httpreq, new YHTTPBody(str_path, bin_content));
        })();
    }
        ...
        if (devid == '') {
            ...
            this.module().then(function (module) {
                return module.get_serialNumber().then(function () {
                    return _this59.wait_async(callback, context);
                });
            });
            return YAPI_SUCCESS;
        }
    ...
    isOnline() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this61._cacheExpiration > _this61._yapi.GetTickCount()) return true;

            // Check that the function is available without throwing exceptions
            /** @type {YFuncRequest} **/
            let yreq = yield _this61._yapi.funcRequest(_this61._className, _this61._func, '', _this61._yapi.defaultCacheValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
            ...
            yield _this61._parse(yreq, _this61._yapi.defaultCacheValidity);
    ...
    load(msValidity) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let yreq = yield _this62._yapi.funcRequest(_this62._className, _this62._func, '', msValidity);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this62._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            yield _this62._parse(yreq, msValidity);
    ...
    clearCache() {
        ...
        return _asyncToGenerator(function* () {
            var devreq = yield _this63._yapi._funcDev(_this63._className, _this63._func);
            if (devreq.errorType != YAPI_SUCCESS) {
                return;
            }
            devreq.obj_result.device.imm_dropCache();
            if (_this63._cacheExpiration > 0) {
                _this63._cacheExpiration = _this63._yapi.GetTickCount();
            }
        })();
    }
    ...
    module() {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this64._serial != '') {
                return YModule.FindModuleInContext(_this64._yapi, _this64._serial + '.module');
            }
            var hwid = _this64._func;
            var resolve;
            if (hwid.indexOf('.') < 0) {
                resolve = _this64._yapi.imm_resolveFunction(_this64._className, _this64._func);
                if (resolve.errorType == YAPI_SUCCESS) hwid = resolve.result;
            }
            var dotidx = hwid.indexOf('.');
            if (dotidx >= 0) {
                // resolution worked
                return YModule.FindModuleInContext(_this64._yapi, hwid.substr(0, dotidx) + '.module');
            }
            ...
            return YModule.FindModuleInContext(_this64._yapi, 'module_of_' + _this64.className + '_' + _this64._func);
        })();
    }
    ...
    get_functionDescriptor() {
        ...
        return _asyncToGenerator(function* () {
            // try to resolve the function name to a device id without query
            if (_this66._hwId != '') {
                return _this66._hwId;
            }
            var hwid = _this66._func;
            if (hwid.indexOf('.') < 0) {
                var resolve = _this66._yapi.imm_resolveFunction(_this66._className, _this66._func);
                if (resolve.errorType != YAPI_SUCCESS) hwid = resolve.result;
            }
            var dotidx = hwid.indexOf('.');
            if (dotidx >= 0) {
...
class YFunctionProxy {
    ...
    isOnline_async(func, ctx) {
        ...
        this.liveFunc.isOnline().then(function (res) {
            func(ctx, _this70, res);
        }).catch(function (e) {
            func(ctx, _this70, false);
        });
    }
    ...
    load_async(ms_validiy, func, ctx) {
        ...
        this.liveFunc.load(ms_validiy).then(function (res) {
            func(ctx, _this71, YAPI_SUCCESS);
        }).catch(function (e) {
            func(ctx, _this71, _this71.get_errorType());
        });
    }
    ...
    _download(str_path) {
        ...
        return _asyncToGenerator(function* () {
            _this72.liveFunc._download(str_path);
    ...
    _upload(str_path, bin_content) {
        ...
        return _asyncToGenerator(function* () {
            _this73.liveFunc._upload(str_path, bin_content);
            return null;
        })();
    }
...
class YModule extends YFunction {
    ...
    get_logicalName() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            var dev = _this81.imm_getDev();
            if (dev != null && _this81._cache._expiration <= _this81._yapi.GetTickCount()) {
                return dev._logicalName;
            }
            /** @type {string|null} **/
            var json_val = yield _this81._getAttr('logicalName');
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this82._cacheExpiration <= _this82._yapi.GetTickCount()) {
                try {
                    yield _this82.load(_this82._yapi.defaultCacheValidity);
                } catch (e) {
                    // device might be offline
                }
            }
            var res = new YModuleProxy(_this82);
            yield res._asyncInit();
            return res;
        })();
    }
    ...
    get_productName() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YDevice} **/
            let dev;
            if (_this83._cacheExpiration == 0) {
                dev = _this83.imm_getDev();
                if (!(dev == null)) {
    ...
    get_productRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this86._productRelease;
        })();
    }
    ...
    get_firmwareRelease() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this87._firmwareRelease;
        })();
    }
    ...
    get_persistentSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this88._persistentSettings;
        })();
    }
    ...
    set_persistentSettings(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this89._setAttr('persistentSettings', rest_val);
        })();
    }
    ...
    set_luminosity(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this91._setAttr('luminosity', rest_val);
        })();
    }
    ...
    set_beacon(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this93._setAttr('beacon', rest_val);
        })();
    }
    ...
    get_rebootCountdown() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this96._rebootCountdown;
        })();
    }
    ...
    set_rebootCountdown(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this97._setAttr('rebootCountdown', rest_val);
        })();
    }
    ...
    set_userVar(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this99._setAttr('userVar', rest_val);
        })();
    }
    ...
    saveToFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this100.set_persistentSettings(Y_PERSISTENTSETTINGS_SAVED);
        })();
    }
    ...
    revertFromFlash() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this101.set_persistentSettings(Y_PERSISTENTSETTINGS_LOADED);
        })();
    }
    ...
    reboot(secBeforeReboot) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this102.set_rebootCountdown(secBeforeReboot);
        })();
    }
    ...
    checkFirmware(path, onlynew) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let tmp_res;
            if (onlynew) {
                release = _this104._yapi.imm_atoi((yield _this104.get_firmwareRelease()));
            } else {
                release = 0;
            }
            //may throw an exception
            serial = yield _this104.get_serialNumber();
            tmp_res = yield YFirmwareUpdate.CheckFirmware(serial, path, release);
            if (tmp_res.indexOf('error:') == 0) {
                _this104._throw(YAPI_INVALID_ARGUMENT, tmp_res);
            }
            return tmp_res;
        })();
    }
    ...
    updateFirmware(path) {
        ...
        return _asyncToGenerator(function* () {
            ...
            settings = yield _this105.get_allSettings();
            if (settings.length == 0) {
                _this105._throw(YAPI_IO_ERROR, 'Unable to get device settings');
                settings = _this105._yapi.imm_str2bin('error:Unable to get device settings');
            }
    ...
    get_allSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let templist = [];
            // may throw an exception
            settings = yield _this106._download('api.json');
            if (settings.length == 0) {
                return settings;
            }
            ext_settings = ', "extras":[';
            templist = yield _this106.get_functionIds('Temperature');
            sep = '';
            for (let ii in templist) {
                if (_this106._yapi.imm_atoi((yield _this106.get_firmwareRelease())) > 9000) {
                    url = 'api/' + templist[ii] + '/sensorType';
                    t_type = _this106._yapi.imm_bin2str((yield _this106._download(url)));
                    if (t_type == 'RES_NTC') {
                        id = templist[ii].substr(11, templist[ii].length - 11);
                        temp_data_bin = yield _this106._download('extra.json?page=' + id);
                        if (temp_data_bin.length == 0) {
                            return temp_data_bin;
                        }
                        item = sep + '{"fid":"' + templist[ii] + '", "json":' + _this106._yapi.imm_bin2str(temp_data_bin) + '}\n';
            ...
            if (yield _this106.hasFunction('files')) {
                json = yield _this106._download('files.json?a=dir&f=');
                if (json.length == 0) {
                    return json;
                }
                filelist = _this106.imm_json_get_array(json);
                sep = '';
                for (let ii in filelist) {
                    name = _this106.imm_json_get_key(_this106._yapi.imm_str2bin(filelist[ii]), 'name');
                    if (name.length > 0 && !(name == 'startupConf.json')) {
                        file_data_bin = yield _this106._download(_this106.imm_escapeAttr(name));
                        file_data = _this106._yapi.imm_bin2hexstr(file_data_bin);
            ...
            res = _this106._yapi.imm_str2bin('{ "api":' + _this106._yapi.imm_bin2str(settings) + ext_settings + ']}');
            return res;
        })();
    }
    ...
    loadThermistorExtra(funcId, jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            yield _this107._download(url);
            // add records in growing resistance value
            values = _this107.imm_json_get_array(_this107._yapi.imm_str2bin(jsonExtra));
            ofs = 0;
            size = values.length;
            while (ofs + 1 < size) {
                curr = values[ofs];
    ...
    set_extraSettings(jsonExtra) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let data;
            extras = _this108.imm_json_get_array(_this108._yapi.imm_str2bin(jsonExtra));
            for (let ii in extras) {
                functionId = _this108.imm_get_json_path(extras[ii], 'fid');
                functionId = _this108.imm_decode_json_string(functionId);
                data = _this108.imm_get_json_path(extras[ii], 'json');
                if (yield _this108.hasFunction(functionId)) {
                    yield _this108.loadThermistorExtra(functionId, data);
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    set_allSettingsAndFiles(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {string} **/
            let json_extra;
            json = _this109._yapi.imm_bin2str(settings);
            json_api = _this109.imm_get_json_path(json, 'api');
            if (json_api == '') {
                return yield _this109.set_allSettings(settings);
            }
            json_extra = _this109.imm_get_json_path(json, 'extras');
            if (!(json_extra == '')) {
                yield _this109.set_extraSettings(json_extra);
            }
            yield _this109.set_allSettings(_this109._yapi.imm_str2bin(json_api));
            if (yield _this109.hasFunction('files')) {
                ...
                /** @type {string} **/
                let data;
                down = yield _this109._download('files.json?a=format');
                res = _this109.imm_get_json_path(_this109._yapi.imm_bin2str(down), 'res');
                res = _this109.imm_decode_json_string(res);
                if (!(res == 'ok')) {
                    return _this109._throw(YAPI_IO_ERROR, 'format failed', YAPI_IO_ERROR);
                }
                json_files = _this109.imm_get_json_path(json, 'files');
                files = _this109.imm_json_get_array(_this109._yapi.imm_str2bin(json_files));
                for (let ii in files) {
                    name = _this109.imm_get_json_path(files[ii], 'name');
                    name = _this109.imm_decode_json_string(name);
                    data = _this109.imm_get_json_path(files[ii], 'data');
                    data = _this109.imm_decode_json_string(data);
                    yield _this109._upload(name, _this109._yapi.imm_hexstr2bin(data));;
                }
            }
            return YAPI_SUCCESS;
        })();
    ...
    hasFunction(funcId) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let fid;
            // may throw an exception
            count = yield _this110.functionCount();
            i = 0;
            while (i < count) {
                fid = yield _this110.functionId(i);
                if (fid == funcId) {
                    return true;
                }
                i = i + 1;
    ...
    get_functionIds(funType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res = [];
            // may throw an exception
            count = yield _this111.functionCount();
            i = 0;
            while (i < count) {
                ftype = yield _this111.functionType(i);
                if (ftype == funType) {
                    res.push((yield _this111.functionId(i)));
                } else {
                    ftype = yield _this111.functionBaseType(i);
                    if (ftype == funType) {
                        res.push((yield _this111.functionId(i)));
                    }
                }
    ...
    calibScale(unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (unit_name == 'C') {
                ...
                if (_this112._yapi.imm_atoi(sensorType) < 8) {
                    return 16;
                } else {
                    return 100;
                }
    ...
    calibConvert(param, currentFuncValue, unit_name, sensorType) {
        ...
        return _asyncToGenerator(function* () {
            ...
            paramVer = yield _this113.calibVersion(param);
            funVer = yield _this113.calibVersion(currentFuncValue);
            funScale = yield _this113.calibScale(unit_name, sensorType);
            funOffset = yield _this113.calibOffset(unit_name);
            paramScale = funScale;
            paramOffset = funOffset;
            if (funVer < 3) {
                if (funVer == 2) {
                    words = _this113._yapi.imm_decodeWords(currentFuncValue);
                    ...
                    if (funVer == 1) {
                        if (currentFuncValue == '' || _this113._yapi.imm_atoi(currentFuncValue) > 10) {
                            funScale = 0;
                        }
                    }
                }
            ...
            if (paramVer < 3) {
                if (paramVer == 2) {
                    words = _this113._yapi.imm_decodeWords(param);
                    if (words[0] == 1366 && words[1] == 12500) {
                        paramScale = 1;
                        paramOffset = 0;
                    } else {
                    ...
                    if (paramVer == 1) {
                        ...
                        for (let ii in words_str) {
                            words.push(_this113._yapi.imm_atoi(words_str[ii]));
                        }
                        if (param == '' || words[0] > 10) {
                            paramScale = 0;
                        }
                ...
                while (i < calibData.length) {
                    if (paramScale > 0) {
                        ...
                        calibData[i] = _this113._yapi.imm_decimalToDouble(Math.round(calibData[i]));
                    }
                    i = i + 1;
                }
            } else {
                iCalib = _this113._yapi.imm_decodeFloats(param);
            ...
            if (funVer >= 3) {
                ...
                if (funVer >= 1) {
                    ...
                    while (i < 2 * nPoints) {
                        if (funScale == 0) {
                            wordVal = _this113._yapi.imm_doubleToDecimal(Math.round(calibData[i]));
                        } else {
    ...
    set_allSettings(settings) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {boolean} **/
            let found;
            tmp = _this114._yapi.imm_bin2str(settings);
            tmp = _this114.imm_get_json_path(tmp, 'api');
            if (!(tmp == '')) {
                settings = _this114._yapi.imm_str2bin(tmp);
            }
            oldval = '';
            newval = '';
            old_json_flat = _this114.imm_flattenJsonStruct(settings);
            old_dslist = _this114.imm_json_get_array(old_json_flat);
            for (let ii in old_dslist) {
                each_str = _this114.imm_json_get_string(_this114._yapi.imm_str2bin(old_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this114._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            // may throw an exception
            actualSettings = yield _this114._download('api.json');
            actualSettings = _this114.imm_flattenJsonStruct(actualSettings);
            new_dslist = _this114.imm_json_get_array(actualSettings);
            for (let ii in new_dslist) {
                each_str = _this114.imm_json_get_string(_this114._yapi.imm_str2bin(new_dslist[ii]));
                leng = each_str.length;
                eqpos = each_str.indexOf('=');
                if (eqpos < 0 || leng == 0) {
                    _this114._throw(YAPI_INVALID_ARGUMENT, 'Invalid settings');
            ...
            while (i < new_jpath.length) {
                ...
                if (do_update) {
                    if (attr == 'calibrationParam') {
                        ...
                        newval = yield _this114.calibConvert(old_calib, new_val_arr[i], unit_name, sensorType);
                        url = 'api/' + fun + '.json?' + attr + '=' + _this114.imm_escapeAttr(newval);
                        yield _this114._download(url);
                    } else {
                        url = 'api/' + fun + '.json?' + attr + '=' + _this114.imm_escapeAttr(oldval);
                        if (attr == 'resolution') {
            ...
            for (let ii in restoreLast) {
                yield _this114._download(restoreLast[ii]);;
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    download(pathname) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this115._download(pathname);
        })();
    }
    ...
    get_icon2d() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this116._download('icon2d.png');
        })();
    }
    ...
    get_lastLogs() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let content;
            // may throw an exception
            content = yield _this117._download('logs.txt');
            return _this117._yapi.imm_bin2str(content);
        })();
    }
...
class YSensor extends YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this118._cacheExpiration <= _this118._yapi.GetTickCount()) {
                try {
                    yield _this118.load(_this118._yapi.defaultCacheValidity);
                } catch (e) {
                    // device might be offline
                }
            }
            var res = new YSensorProxy(_this118);
            yield res._asyncInit();
            return res;
        })();
    }
    ...
    get_unit() {
        ...
        return _asyncToGenerator(function* () {
            if (_this119._cacheExpiration <= _this119._yapi.GetTickCount()) {
                if ((yield _this119.load(_this119._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_UNIT_INVALID;
                }
            }
            return _this119._unit;
        })();
    }
    ...
    get_currentValue() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let res;
            if (_this120._cacheExpiration <= _this120._yapi.GetTickCount()) {
                if ((yield _this120.load(_this120._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_CURRENTVALUE_INVALID;
                }
            }
            res = yield _this120._applyCalibration(_this120._currentRawValue);
            if (res == Y_CURRENTVALUE_INVALID) {
                res = _this120._currentValue;
            }
            res = res * _this120._iresol;
            return Math.round(res) / _this120._iresol;
        })();
    }
    ...
    set_lowestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this121._setAttr('lowestValue', rest_val);
        })();
    }
    ...
    get_lowestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this122._lowestValue * _this122._iresol;
            return Math.round(res) / _this122._iresol;
        })();
    }
    ...
    set_highestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this123._setAttr('highestValue', rest_val);
        })();
    }
    ...
    get_highestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this124._highestValue * _this124._iresol;
    ...
    get_currentRawValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this125._currentRawValue;
        })();
    }
    ...
    set_logFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this127._setAttr('logFrequency', rest_val);
        })();
    }
    ...
    get_reportFrequency() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this128._reportFrequency;
        })();
    }
    ...
    set_reportFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this129._setAttr('reportFrequency', rest_val);
        })();
    }
    ...
    get_calibrationParam() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this130._calibrationParam;
        })();
    }
    ...
    set_calibrationParam(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this131._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    set_resolution(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this132._setAttr('resolution', rest_val);
        })();
    }
    ...
    _parserHelper() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this135._caltyp = -1;
            _this135._scale = -1;
            _this135._isScal32 = false;
            _this135._calpar.length = 0;
            _this135._calraw.length = 0;
            _this135._calref.length = 0;
            // Store inverted resolution, to provide better rounding
            if (_this135._resolution > 0) {
                _this135._iresol = Math.round(1.0 / _this135._resolution);
            } else {
                _this135._iresol = 10000;
                _this135._resolution = 0.0001;
            }
            // Old format: supported when there is no calibration
            if (_this135._calibrationParam == '' || _this135._calibrationParam == '0') {
                _this135._caltyp = 0;
                return 0;
            }
            if (_this135._calibrationParam.indexOf(',') >= 0) {
                iCalib = _this135._yapi.imm_decodeFloats(_this135._calibrationParam);
                _this135._caltyp = parseInt(iCalib[0] / 1000, 10);
                if (_this135._caltyp > 0) {
                    if (_this135._caltyp < YOCTO_CALIB_TYPE_OFS) {
                        _this135._caltyp = -1;
                        return 0;
                    }
                    _this135.imm_calhdl = _this135._yapi.imm_getCalibrationHandler(_this135._caltyp);
                    if (!(_this135.imm_calhdl != null)) {
                        _this135._caltyp = -1;
                        return 0;
                    }
                }
                _this135._isScal = true;
                _this135._isScal32 = true;
                _this135._offset = 0;
                _this135._scale = 1000;
                maxpos = iCalib.length;
                _this135._calpar.length = 0;
                position = 1;
                while (position < maxpos) {
                    _this135._calpar.push(iCalib[position]);
                    position = position + 1;
                }
                _this135._calraw.length = 0;
                _this135._calref.length = 0;
                ...
                while (position + 1 < maxpos) {
                    ...
                    fRef = fRef / 1000.0;
                    _this135._calraw.push(fRaw);
                    _this135._calref.push(fRef);
                    position = position + 2;
                }
            } else {
                iCalib = _this135._yapi.imm_decodeWords(_this135._calibrationParam);
                if (iCalib.length < 2) {
                    _this135._caltyp = -1;
                    return 0;
                }
                _this135._isScal = iCalib[1] > 0;
                if (_this135._isScal) {
                    _this135._offset = iCalib[0];
                    if (_this135._offset > 32767) {
                        _this135._offset = _this135._offset - 65536;
                    }
                    _this135._scale = iCalib[1];
                    _this135._decexp = 0;
                } else {
                    _this135._offset = 0;
                    _this135._scale = 1;
                    _this135._decexp = 1.0;
                    position = iCalib[0];
                    while (position > 0) {
                        _this135._decexp = _this135._decexp * 10;
                        position = position - 1;
                    }
                }
                if (iCalib.length == 2) {
                ...
                _this135._caltyp = iCalib[2];
                _this135.imm_calhdl = _this135._yapi.imm_getCalibrationHandler(_this135._caltyp);
                if (_this135._caltyp <= 10) {
                    maxpos = _this135._caltyp;
                } else {
                    if (_this135._caltyp <= 20) {
                        maxpos = _this135._caltyp - 10;
                    } else {
                        maxpos = 5;
                    }
                }
                ...
                while (position + 1 < maxpos) {
                    ...
                    _this135._calpar.push(iRaw);
                    _this135._calpar.push(iRef);
                    if (_this135._isScal) {
                        fRaw = iRaw;
                        fRaw = (fRaw - _this135._offset) / _this135._scale;
                        fRef = iRef;
                        fRef = (fRef - _this135._offset) / _this135._scale;
                        _this135._calraw.push(fRaw);
                        _this135._calref.push(fRef);
                    } else {
                        _this135._calraw.push(_this135._yapi.imm_decimalToDouble(iRaw));
                        _this135._calref.push(_this135._yapi.imm_decimalToDouble(iRef));
                    }
                    position = position + 2;
                }
            }
    ...
    isSensorReady() {
        ...
        return _asyncToGenerator(function* () {
            if (!(yield _this136.isOnline())) {
                return false;
            }
            if (!(_this136._sensorState == 0)) {
                return false;
            }
            return true;
        })();
    ...
    startDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this137._download('api/dataLogger/recording?recording=1');
            if (!(res.length > 0)) {
                return _this137._throw(YAPI_IO_ERROR, 'unable to start datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    stopDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this138._download('api/dataLogger/recording?recording=0');
            if (!(res.length > 0)) {
                return _this138._throw(YAPI_IO_ERROR, 'unable to stop datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    get_recordedData(startTime, endTime) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let funit;
            // may throw an exception
            funcid = yield _this139.get_functionId();
            funit = yield _this139.get_unit();
            return new YDataSet(_this139, funcid, funit, startTime, endTime);
        })();
    }
    ...
    registerTimedReportCallback(callback) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this140._timedReportCallbackSensor = callback;
            return 0;
        })();
    }
    ...
    _invokeTimedReportCallback(value) {
        ...
        return _asyncToGenerator(function* () {
            if (_this141._timedReportCallbackSensor != null) {
                yield _this141._timedReportCallbackSensor(_this141, value);
            } else {}
            return 0;
        })();
    }
    ...
    calibrateFromPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            // may throw an exception
            rest_val = yield _this142._encodeCalibrationPoints(rawValues, refValues);
            return yield _this142._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    loadCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this143._scale == 0) {
                if ((yield _this143.load(_this143._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_DEVICE_NOT_FOUND;
                }
            }
            if (_this143._caltyp < 0) {
                _this143._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return YAPI_NOT_SUPPORTED;
            }
            rawValues.length = 0;
            refValues.length = 0;
            for (let ii in _this143._calraw) {
                rawValues.push(_this143._calraw[ii]);
            }
            for (let ii in _this143._calref) {
                refValues.push(_this143._calref[ii]);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    _encodeCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (npt != refValues.length) {
                _this144._throw(YAPI_INVALID_ARGUMENT, 'Invalid calibration parameters (size mismatch)');
            ...
            // Load function parameters if not yet loaded
            if (_this144._scale == 0) {
                if ((yield _this144.load(_this144._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_INVALID_STRING;
                }
            }
            // Detect old firmware
            if (_this144._caltyp < 0 || _this144._scale < 0) {
                _this144._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return '0';
            }
            if (_this144._isScal32) {
                ...
                if (_this144._isScal) {
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = Math.round(rawValues[idx] * _this144._scale + _this144._offset);
                        iRef = Math.round(refValues[idx] * _this144._scale + _this144._offset);
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = _this144._yapi.imm_doubleToDecimal(rawValues[idx]);
                        iRef = _this144._yapi.imm_doubleToDecimal(refValues[idx]);
                        res = res + ',' + String(Math.round(iRaw)) + ',' + String(Math.round(iRef));
                        idx = idx + 1;
                    }
                }
    ...
    _applyCalibration(rawValue) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this145._caltyp == 0) {
                return rawValue;
            }
            if (_this145._caltyp < 0) {
                return Y_CURRENTVALUE_INVALID;
            }
            if (!(_this145.imm_calhdl != null)) {
                return Y_CURRENTVALUE_INVALID;
            }
            return _this145.imm_calhdl(rawValue, _this145._caltyp, _this145._calpar, _this145._calraw, _this145._calref);
        })();
    }
    ...
    _decodeTimedReport(timestamp, report) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {number} **/
            let maxVal;
            startTime = _this146._prevTimedReport;
            endTime = timestamp;
            _this146._prevTimedReport = endTime;
            if (startTime == 0) {
                startTime = endTime;
            }
            if (report[0] == 2) {
                if (report.length <= 5) {
                    ...
                    if (_this146._caltyp != 0) {
                        if (_this146.imm_calhdl != null) {
                            avgVal = _this146.imm_calhdl(avgVal, _this146._caltyp, _this146._calpar, _this146._calraw, _this146._calref);
                        }
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                    ...
                    if (_this146._caltyp != 0) {
                        if (_this146.imm_calhdl != null) {
                            avgVal = _this146.imm_calhdl(avgVal, _this146._caltyp, _this146._calpar, _this146._calraw, _this146._calref);
                            minVal = _this146.imm_calhdl(minVal, _this146._caltyp, _this146._calpar, _this146._calraw, _this146._calref);
                            maxVal = _this146.imm_calhdl(maxVal, _this146._caltyp, _this146._calpar, _this146._calraw, _this146._calref);
                        }
                    }
                }
            } else {
                if (report[0] == 0) {
                    ...
                    if (_this146._isScal) {
                        avgVal = _this146.imm_decodeVal(avgRaw);
                    } else {
                        if ((byteVal & 0x80) != 0) {
                            avgRaw = avgRaw - poww;
                        }
                        avgVal = _this146.imm_decodeAvg(avgRaw);
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                } else {
                    ...
                    minVal = _this146.imm_decodeVal(minRaw);
                    avgVal = _this146.imm_decodeAvg(avgRaw);
                    maxVal = _this146.imm_decodeVal(maxRaw);
                }
            }
...
class YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this147.request('GET', '/api/module.json', null, 0);
            if (yreq.errorType != YAPI_SUCCESS) {
        ...
        return _asyncToGenerator(function* () {
            ...
            try {
                ...
                if (whitePages == undefined) {
                    return _this148._throw(YAPI_IO_ERROR, 'Device ' + hubDev.imm_describe() + ' is not a hub', YAPI_IO_ERROR);
                }
    ...
    getBootloaders() {
        ...
        return _asyncToGenerator(function* () {
            let yreq = yield _this149.request('GET', '/flash.json?a=list', null, 1);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this149._throw(yreq.errorType, yreq.errorMsg, []);
            }
    ...
    firmwareUpdate(serial, firmware, settings, progress) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let _throw = function (msg) {
                return _this150._throw(YAPI.IO_ERROR, msg, [msg]);
            };
            ...
            let json = JSON.parse(_this150._yapi.imm_bin2str(yreq.bin_result));
            let ownSerial = json.serialNumber;
            if (serial == ownSerial && !(ownSerial.slice(0, 7) == 'VIRTHUB')) {
                use_self_flash = true;
            } else {
                // check if subdevice support self flashing
                yreq = yield _this150.request('GET', '/bySerial/' + serial + '/flash.json?a=state', null, 0);
                if (yreq.errorType == YAPI_SUCCESS) {
                    use_self_flash = true;
                    baseUrl = '/bySerial/' + serial;
                }
            }
            progress(5, 'Start bootloader');
            let bootloaders = yield _this150.getBootloaders();
            ...
            yreq = yield _this150.request('POST', baseUrl + '/upload.html', new YHTTPBody('firmware', firmware.imm_getData()), 0);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _throw('Firmware upload failed: ' + yreq.errorMsg);
            }
            yreq = yield _this150.request('GET', baseUrl + '/flash.json?a=state', null, 0);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _throw('Cannot check state of firmware upload');
            }
            json = JSON.parse(_this150._yapi.imm_bin2str(yreq.bin_result));
            if (json['state'] != 'valid') {
            ...
            if (use_self_flash) {
                ...
                yreq = yield _this150.request('POST', baseUrl + '/upload.html', new YHTTPBody('startupConf.json', settings), 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Failed to save settings on hub');
                }
                yreq = yield _this150.request('POST', baseUrl + '/upload.html', new YHTTPBody('firmwareConf', settings), 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Failed to save settings on hub');
                }
            }
            ...
            if (use_self_flash) {
                ...
                yield _this150.request('GET', baseUrl + '/api/module/rebootCountdown?rebootCountdown=-1003', null, 0);
                yield _this150._yapi.Sleep(7000);
            } else {
                // reboot device to bootloader if needed
                if (need_reboot) {
                    // reboot subdevice
                    yield _this150.request('GET', '/bySerial/' + serial + '/api/module/rebootCountdown?rebootCountdown=-2', null, 0);
                }
                ...
                do {
                    let list = _this150.getBootloaders();
                    for (i = 0; i < bootloaders.length; i++) {
                        let bl = bootloaders[i];
                        if (bl == serial) {
                            found = true;
                    ...
                    if (!found) {
                        yield _this150._yapi.Sleep(500);
                    }
                } while (!found && YAPI.GetTickCount() < timeout);
                //start flash
                progress(45, 'Flash firmware');
                yreq = yield _this150.request('GET', '/flash.json?a=flash&s=' + serial, null, 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Cannot check state of firmware flash');
                }
                return JSON.parse(_this150._yapi.imm_bin2str(yreq.bin_result));
            }
            return null;
        })();
    }
...
class YHttpHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this152.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '?len=' + _this152.notiflen.toString();
            if (_this152.notifPos > 0) {
                args += '&abs=' + _this152.notifPos.toString();
            }
            _this152.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this152.notbynRequest = new XMLHttpRequest();
                _this152.notbynRequest.open('GET', _this152.urlInfo.url + 'not.byn' + args, true, '', '');
                _this152.notbynRequest.overrideMimeType('text/plain; charset=x-user-defined');
                _this152.notbynRequest.onreadystatechange = function () {
                    if (_this152.disconnecting) {
                        return;
                    }
                    if (_this152.notbynRequest.readyState >= 3) {
                        resolve(YAPI_SUCCESS);
                        if (_this152.notbynRequest.readyState == 4 && parseInt(_this152.notbynRequest.status) != 200 && parseInt(_this152.notbynRequest.status) != 304) {
                            // connection error
                            if (_this152.retryDelay < 15000) _this152.retryDelay *= 2;
                            _this152.devListValidity = 500;
                            _this152.devListExpires = 0;
                            setTimeout(function () {
                            ...
                            if (_this152.notbynRequest.readyState == 3) {
                                ...
                                if (_this152.notiflen == 1) return;
                            }
                            let newlen = _this152.notbynRequest.responseText.length;
                            if (newlen > _this152.currPos) {
                                _this152._yapi.parseEvents(_this152, _this152.notbynRequest.responseText.substr(_this152.currPos, newlen - _this152.currPos));
                            }
                            // trigger immediately a new connection if closed in success
                            if (_this152.notbynRequest.readyState == 4 && parseInt(_this152.notbynRequest.status) != 0) {
                                _this152.currPos = 0;
                                _this152.testHub(new YErrorMsg());
                            }
                        }
                ...
                _this152.notbynRequest.send('');
            });
            return yield _this152.notbynOpenPromise;
        })();
    }
    ...
    request(method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            let httpPromise = new Promise(function (resolve, reject) {
                let prefix = _this153.urlInfo.url.slice(0, -1);
                let httpRequest = new XMLHttpRequest();
                httpRequest.open(method, prefix + devUrl, true, _this153.urlInfo.user, _this153.urlInfo.pass);
                httpRequest.onreadystatechange = function () {
                    if (httpRequest.readyState == 4) {
                        ...
                        if (httpRequest.status != 200 && httpRequest.status != 304) {
                            ...
                            yreq.bin_result = _this153._yapi.imm_str2bin(httpRequest.responseText);
                        }
                        resolve(yreq);
                    }
                };
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            _this154.imm_commonDisconnect();
            _this154.notbynRequest.abort();
        })();
    }
}
...
class YHttpNodeHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let args = '';
            if (_this155.notifPos > 0) {
                args = '?abs=' + _this155.notifPos.toString();
            }
            let options = {
                method: 'GET',
                hostname: _this155.urlInfo.host,
                port: _this155.urlInfo.port,
                path: '/not.byn' + args
            };
            _this155.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this155.notbynRequest = _this155.http.request(options, function (res) {
                    if (_this155.disconnecting) {
                        return;
                    }
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        ...
                        res.on('data', function (chunk) {
                            // receiving data properly
                            _this155._yapi.parseEvents(_this155, _this155._yapi.imm_bin2str(chunk));
                        });
                        res.on('end', function () {
                            // trigger immediately a new connection if closed in success
                            _this155.currPos = 0;
                ...
                _this155.notbynRequest.on('error', function () {
                ...
                _this155.notbynRequest.end();
            });
            return yield _this155.notbynOpenPromise;
        })();
    }
    ...
    request(str_method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            let options = {
                method: str_method,
                hostname: _this156.urlInfo.host,
                port: _this156.urlInfo.port,
                path: devUrl
            };
            if (obj_body) {
                options.boundary = _this156.imm_getBoundary();
                options.headers = { 'Content-Type': 'multipart/form-data; boundary=' + options.boundary };
            }
            let httpPromise = new Promise(function (resolve, reject) {
                let response = new Buffer(0);
                let httpRequest = _this156.http.request(options, function (res) {
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        let yreq = new YHTTPRequest(null);
                        yreq.errorType = YAPI_NOT_SUPPORTED;
                        yreq.errorMsg = 'HTTP Error ' + res.statusCode.toString() + ' on ' + _this156.urlInfo.url.slice(0, -1) + devUrl;
                        resolve(yreq);
                    } else {
                        res.on('data', function (chunk) {
                            // receiving data properly
                ...
                if (obj_body) {
                    httpRequest.write(new Buffer(_this156.imm_formEncodeBody(obj_body, options.boundary)));
                }
                httpRequest.end();
            });
            return httpPromise;
...
class YHttpCallbackHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            yield _this158.httpCallbackPromise;
            if (_this158._incomingMessage.method != 'POST') {
                errmsg.msg = 'HTTP POST expected';
                return YAPI_INVALID_ARGUMENT;
            }
            if (_this158._callbackData.length == 0) {
                errmsg.msg = 'Empty POST body';
                return YAPI_NO_MORE_DATA;
            }
            if (_this158.urlInfo.pass != '') {
                // callback data signed, verify signature
                if (!_this158._callbackCache.sign) {
                    errmsg.msg = 'missing signature from incoming YoctoHub (callback password required)';
                    _this158._callbackCache = [];
                    return YAPI_NO_MORE_DATA;
                }
                let sign = _this158._callbackCache['sign'];
                let pass = _this158.urlInfo.pass;
                let salt;
                if (pass.length == 32) {
                    salt = pass.toLowerCase();
                } else {
                    salt = _this158._yapi.imm_bin2hexstr(_this158._yapi.imm_yMD5(pass)).toLowerCase();
                }
                let patched = _this158._yapi.imm_bin2str(_this158._callbackData).replace(sign, salt);
                let check = _this158._yapi.imm_bin2hexstr(_this158._yapi.imm_yMD5(patched));
    ...
    request(str_method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_method == 'POST' && obj_body) {
                let boundary = _this159.imm_getBoundary();
                let body = _this159.imm_formEncodeBody(obj_body, boundary);
                _this159._serverResponse.write('\n@YoctoAPI:' + str_method + ' ' + devUrl + ' ' + body.length + ':' + boundary + '\n');
                _this159._serverResponse.write(new Buffer(body));
                ...
                if (devUrl.indexOf('?') == -1 || devUrl.indexOf('/logs.txt') != -1 || devUrl.indexOf('/logger.json') != -1 || devUrl.indexOf('/ping.txt') != -1 || devUrl.indexOf('/files.json?a=dir') != -1) {
                    ...
                    if (!_this159._callbackCache[devUrl]) {
                        ...
                        var jsonres = _this159._callbackCache[devUrl];
                        if (subfun) {
                            jsonres = jsonres[subfun[1]];
                        }
                        yreq.bin_result = _this159._yapi.imm_str2bin(JSON.stringify(jsonres));
                    }
                } else {
...
class YWebSocketHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this160.imm_webSocketOpen(_this160.urlInfo.url + 'not.byn');
            _this160.websocketOpenPromise = new Promise(function (resolve, reject) {
                if (_this160.disconnecting) {
                    resolve(YAPI_IO_ERROR);
                } else {
                    _this160.websocket.onmessage = function (evt) {
                        _this160._webSocketMsg(new Uint8Array(evt.data));
                        if (_this160._connectionState == _this160._WS_CONNECTED) {
                            resolve(YAPI_SUCCESS);
                        } else if (_this160._connectionState == _this160._WS_DEAD) {
                            console.log('WebSocket error: ' + _this160._session_error);
                            resolve(YAPI_IO_ERROR);
                        }
                    };
                }
            });
            _this160.websocket.onclose = function (evt) {
                _this160.websocket = null;
                if (_this160.retryDelay < 0) {
                    _this160.disconnecting = true;
                }
                if (_this160.disconnecting) {
                    return;
                }
                // connection error
                if (_this160.retryDelay < 15000) _this160.retryDelay *= 2;
                _this160.devListValidity = 500;
                _this160.devListExpires = 0;
                setTimeout(function () {
                    _this160.testHub(new YErrorMsg());
                }, _this160.retryDelay);
            };
            _this160.websocket.onerror = function (evt) {
                console.log('WebSocket error: ', evt);
                if (_this160.websocket.terminate) {
                    _this160.websocket.terminate();
                }
                _this160.websocket = null;
                if (_this160.retryDelay < 0) {
                    _this160.disconnecting = true;
            ...
            return yield _this160.websocketOpenPromise;
        })();
    }
    ...
    _webSocketMsg(arr_bytes) {
        ...
        return _asyncToGenerator(function* () {
            try {
                ...
                var text = '';
                if (ystream == _this161._YSTREAM_TCP_NOTIF) {
                    for (let i = 1; i < arr_bytes.length; i++) {
                        text += String.fromCharCode(arr_bytes[i]);
                    }
                    yield _this161._yapi.parseEvents(_this161, text);
                    return;
                }
                // Other types of messages
                var ws = _this161.websocket;
                var tcpchan = arr_bytes[0] & 7;
                if (ystream == _this161._YSTREAM_TCP || ystream == _this161._YSTREAM_TCP_CLOSE || ystream == _this161._YSTREAM_TCP_ASYNCCLOSE) {
                    let tcp_end = arr_bytes.length;
                    let yreq = _this161.tcpChan[tcpchan];
                    if (!yreq) {
                        _this161.imm_asyncWebSocketError('Drop frame for closed tcpChan ' + tcpchan);
                        return;
                    }
                    if (ystream == _this161._YSTREAM_TCP_ASYNCCLOSE) {
                        // async close packet, check async signature byte
                        tcp_end--;
                        if (yreq.asyncId == 0) {
                            _this161.imm_asyncWebSocketError('Asynchronous close received, sync reply request');
                            return;
                        } else if (yreq.asyncId != arr_bytes[tcp_end]) {
                            _this161.imm_asyncWebSocketError('Incorrect async-close signature on tcpChan ' + tcpchan);
                            return;
                        }
                    }
                    ...
                    if (ystream == _this161._YSTREAM_TCP_CLOSE || ystream == _this161._YSTREAM_TCP_ASYNCCLOSE) {
                        // Pop request from tcp channel
                        _this161.tcpChan[tcpchan] = yreq.next;

                        // Handle synchronous close
                        if (ystream == _this161._YSTREAM_TCP_CLOSE) {
                            // synchronous close
                            if (yreq.asyncId != 0) {
                                _this161.imm_asyncWebSocketError('Synchronous close received, async ack expected');
                                return;
                                ...
                                frame[0] = (_this161._YSTREAM_TCP_CLOSE << 3) + tcpchan;
                                _this161.websocket.send(frame);
                            }
                        }
                        ...
                        if (pos < 0) {
                            ...
                            let header = _this161._yapi.imm_bin2str(yreq.bin_result.subarray(0, pos));
                        ...
                        if (yreq.asyncId == 0) {
                            _this161.imm_sendPendingRequest(tcpchan);
                            yreq.acceptor(yreq);
                        } else {
                            // asynchronous request: log errors, but nothing else to be done
                            if (yreq.errorType != YAPI_SUCCESS) {
                                _this161.imm_asyncWebSocketError('Async request error: ' + yreq.errorMsg);
                            }
                        }
                    }
                    return;
                }
                if (ystream == _this161._YSTREAM_META) {
                    let metatype = arr_bytes[1];
                    switch (metatype) {
                        case _this161._USB_META_WS_ANNOUNCE:
                            if (arr_bytes.length < 1 + _this161._USB_META_WS_ANNOUNCE_SIZE) {
                                return;
                            }
                            _this161._remoteVersion = arr_bytes[2];
                            if (_this161._remoteVersion < 1) {
                                return;
                            }
                            // bytes 3 & 4 are reserved for future use
                            _this161._remoteNonce = arr_bytes[5] + (arr_bytes[6] << 8) + (arr_bytes[7] << 16) + (arr_bytes[8] << 24);
                            for (let i = 9; i < 9 + 20; i++) {
                                if (arr_bytes[i] == 0) {
                                    _this161._remoteSerial = _this161._yapi.imm_bin2str(arr_bytes.subarray(9, i));
                                    break;
                                }
                            }
                            _this161._nonce = parseInt(Math.random() * 0xffffffff);
                            _this161._connectionState = _this161._WS_AUTHENTICATING;
                            // send our authentication packet
                            let frame = new Uint8Array(1 + _this161._USB_META_WS_AUTHENTICATION_SIZE);
                            let version = 1,
                                flags = 0;
                            frame[0] = _this161._YSTREAM_META << 3;
                            frame[1] = _this161._USB_META_WS_AUTHENTICATION;
                            frame[2] = version;
                            if (_this161.urlInfo.pass != '') {
                                flags = _this161._USB_META_WS_VALID_SHA1;
                                let sha1 = _this161.imm_computeAuth(_this161.urlInfo.user, _this161.urlInfo.pass, _this161._remoteSerial, _this161._remoteNonce);
                            ...
                            frame[3] = flags & 0xff;
                            frame[4] = flags >>> 8;
                            frame[5] = _this161._nonce & 0xff;
                            frame[6] = _this161._nonce >>> 8 & 0xff;
                            frame[7] = _this161._nonce >>> 16 & 0xff;
                            frame[8] = _this161._nonce >>> 24 & 0xff;
                            _this161.websocket.send(frame);
                            break;
                        case _this161._USB_META_WS_AUTHENTICATION:
                            if (_this161._connectionState != _this161._WS_AUTHENTICATING) {
                                return;
                            }
                            if (arr_bytes.length < 1 + _this161._USB_META_WS_AUTHENTICATION_SIZE) {
                                return;
                            }
                            _this161._remoteVersion = arr_bytes[2];
                            if (_this161._remoteVersion < 1) {
                            ...
                            if ((inflags & _this161._USB_META_WS_VALID_SHA1) != 0) {
                                let remote_sha1 = arr_bytes.subarray(9, 29);
                                let sha1 = _this161.imm_computeAuth(_this161.urlInfo.user, _this161.urlInfo.pass, _this161._remoteSerial, _this161._nonce);
                                for (let i = 0; i < sha1.length; i++) {
                                    if (sha1[i] != remote_sha1[i]) {
                                        // bad signature
                                        _this161._session_errno = 401;
                                        _this161._session_error = 'Authentication failed';
                                        _this161._connectionState = _this161._WS_DEAD;
                                        return;
                                    }
                                }
                                // Password verified OK
                                _this161._connectionState = _this161._WS_CONNECTED;
                            } else {
                                if (_this161.urlInfo.pass == '') {
                                    ...
                                    _this161._session_errno = 401;
                                    _this161._session_error = 'Password not set on remote hub';
                                    _this161._connectionState = _this161._WS_DEAD;
                                    return;
                                }
                            }
                            break;
                        case _this161._USB_META_WS_ERROR:
                            // drop reserved byte
                            _this161._session_errno = arr_bytes[3] + (arr_bytes[4] << 8);
                            if (_this161._session_errno == 401) {
                                _this161._session_error = 'Authentication failed';
                            } else {
                                _this161._session_error = 'Remote hub closed connection with error ' + _this161._session_errno;
                            }
                            _this161._connectionState = _this161._WS_DEAD;
                            break;
                    }
                ...
                _this161.imm_asyncWebSocketError('Unsupported message: ' + _this161._yapi.imm_bin2hexstr(arr_bytes));
            } catch (e) {
    ...
    request(method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            if (_this162.logging) {
                _this162.imm_logrequest(method, devUrl, obj_body);
            }
            let httpPromise = new Promise(function (resolve, reject) {
                let subReq = method + ' ' + devUrl + ' \r\n\r\n';
                let ws = _this162.websocket;
                let isAsync = _this162._remoteVersion > 0 && devUrl.slice(-2) == '&.';
                let yreq = new YHTTPRequest(new Uint8Array(0));

                yreq.acceptor = resolve;
                yreq.devUrl = devUrl;
                if (obj_body) {
                    let boundary = _this162.imm_getBoundary();
                    let body = _this162.imm_formEncodeBody(obj_body, boundary);
                ...
                if (isAsync) {
                    yreq.asyncId = _this162.nextAsyncId++;
                    if (_this162.nextAsyncId >= 127) {
                        _this162.nextAsyncId = 48;
                    }
                }

                // Queue all requests on tcpChan 0 for now, to preserve request order
                let queue = _this162.tcpChan[tcpchan];
                if (queue) {
                    while (queue.next) {
                        queue = queue.next;
                    }
                    ...
                    _this162.tcpChan[tcpchan] = yreq;
                }

                // Send request if possible
                _this162.imm_sendPendingRequest(tcpchan);
            });
    ...
    imm_sendPendingRequest(tcpchan) {
        ...
        while (yreq) {
            ...
            yreq.timeoutId = setTimeout(function (chan, yr) {
                _this163.imm_abortRequest(chan, yr);
    ...
    imm_abortRequest(tcpchan, yreq) {
        this.imm_asyncWebSocketError('Timeout on ' + yreq.devUrl);
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            _this164.imm_commonDisconnect();
            _this164.websocket.close();
...
class YAPIContext {
    ...
    _addHub(newhub) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this165._hubs.push(newhub);

            // If hub is not yet known, create a device object (synchronous call)
            var serial = _this165._snByUrl[newhub.urlInfo.url];
            if (!serial) {
                let dev = new YDevice(_this165, newhub.urlInfo.url, null, null);
                yield dev.refresh();
            }
        })();
    }
    ...
    _updateDeviceList_internal(bool_forceupdate, bool_invokecallbacks) {
        ...
        return _asyncToGenerator(function* () {
            if (_this166._firstArrival && bool_invokecallbacks && _this166._arrivalCallback) {
                bool_forceupdate = true;
            }
            if (bool_forceupdate) {
                for (let i = 0; i < _this166._hubs.length; i++) {
                    _this166._hubs[i].imm_forceUpdate();
                }
            }
            if (_this166._updateDevListStarted && _this166.GetTickCount() - _this166._updateDevListStarted < 30 * 1000) {
                return {
            ...
            try {
                ...
                _this166._updateDevListStarted = _this166.GetTickCount();

                // collect list of hubs which should be checked
                let hubs = [];
                for (let i = 0; i < _this166._hubs.length; i++) {
                    let hub = _this166._hubs[i];
                    let rootUrl = hub.urlInfo.url;
                    let hubDev = _this166.imm_getDevice(rootUrl);
                    if (!hubDev) continue;
                    if (hub.devListExpires <= _this166.GetTickCount()) {
                        hub.missing = [];
                        hubs.push(hub);
                    }
                }
                ...
                for (let serial in _this166._devs) {
                    let rooturl = _this166._devs[serial].imm_getRootUrl();
                    for (let i = 0; i < hubs.length; i++) {
                ...
                if (bool_invokecallbacks) {
                    let nbEvents = _this166._pendingCallbacks.length;
                    for (let i = 0; i < nbEvents; i++) {
                        let evt = _this166._pendingCallbacks[i];
                        let serial = evt.slice(1);
                        switch (evt.charAt(0)) {
                            case '+':
                                if (_this166._arrivalCallback != undefined) {
                                    yield _this166._arrivalCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '/':
                                if (_this166._namechgCallback != undefined) {
                                    yield _this166._namechgCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '-':
                                if (_this166._removalCallback != undefined) {
                                    yield _this166._removalCallback(yFindModule(serial + '.module'));
                                }
                                _this166.imm_forgetDevice(_this166._devs[serial]);
                                break;
                        }
                    }
                    _this166._pendingCallbacks = _this166._pendingCallbacks.slice(nbEvents);
                    if (_this166._arrivalCallback != undefined && _this166._firstArrival) {
                        _this166._firstArrival = false;
                    }
                }
            } finally {
                _this166._updateDevListStarted = false;
            }
    ...
    updateDeviceList_process(hub, hubDev, whitePages, yellowPages) {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let classname in yellowPages) {
                ...
                let ftype = _this167._fnByType[classname];
                if (ftype == undefined) {
                    ftype = new YFunctionType(_this167, classname);
                    _this167._fnByType[classname] = ftype;
                }
            ...
            for (let devkey in whitePages) {
                ...
                var currdev = _this167._devs[serial];
                if (currdev && _this167._arrivalCallback != undefined && _this167._firstArrival) {
                    _this167._pendingCallbacks.push('+' + serial);
                }
                hub.serialByYdx[devydx] = serial;
                if (!currdev) {
                    // Add new device
                    //noinspection ObjectAllocationIgnored
                    new YDevice(_this167, rooturl, devinfo, yellowPages);
                    if (_this167._arrivalCallback != undefined) {
                        _this167._pendingCallbacks.push('+' + serial);
                    }
                } else if (currdev.imm_getLogicalName() != devinfo['logicalName']) {
                    // Reindex device from its own data
                    yield currdev.refresh();
                    if (_this167._namechgCallback != undefined) {
                        _this167._pendingCallbacks.push('/' + serial);
                    }
            ...
            for (serial in hub.missing) {
                if (hub.missing[serial]) {
                    if (_this167._removalCallback != undefined) {
                        _this167._pendingCallbacks.push('-' + serial);
                    } else {
                        _this167.imm_forgetDevice(_this167._devs[serial]);
                    }
                }
            }
        ...
        return _asyncToGenerator(function* () {
            ...
            for (var idx = 0; idx < nrows; idx++) {
                ...
                if (ev.length >= 3 && firstCode >= NOTIFY_NETPKT_FLUSHV2YDX && firstCode <= NOTIFY_NETPKT_TIMEAVGYDX) {
                    ...
                    if (serial && _this168._devs[serial]) {
                        var funcid = funydx == 0xf ? 'time' : _this168._devs[serial].imm_functionId(funydx);
                        if (funcid != '') {
                            value = ev.slice(3);
                            switch (firstCode) {
                                case NOTIFY_NETPKT_FUNCVALYDX:
                                    ...
                                    _this168.imm_setFunctionValue(serial + '.' + funcid, value);
                                    break;
                                ...
                                case NOTIFY_NETPKT_TIMEV2YDX:
                                    ...
                                    var dev = _this168._devs[serial];
                                    if (funcid == 'time') {
                                        var time = arr[1] + 0x100 * arr[2] + 0x10000 * arr[3] + 0x1000000 * arr[4];
                                        dev.imm_setDeviceTime(time + arr[5] / 250.0);
                                    } else {
                                        _this168.imm_setTimedReport(serial + '.' + funcid, dev.imm_getDeviceTime(), arr);
                                    }
                                    break;
                                case NOTIFY_NETPKT_FUNCV2YDX:
                                    var rawval = _this168.imm_decodeNetFuncValV2(value);
                                    if (rawval != null) {
                                        var decodedval = _this168.imm_decodePubVal(rawval[0], rawval, 1, 6);
                                        _this168.imm_setFunctionValue(serial + '.' + funcid, decodedval);
                                    }
                                    break;
                    ...
                    if (notype == '@') {
                        ...
                        case 5:
                            ...
                            if (parts.length > 2) {
                                ...
                                _this168.imm_setFunctionValue(parts[0] + '.' + parts[1], value[0]);
                            }
                            break;
                    }
                } else {
            ...
            if (_this168._forwardValues > 0) {
                yield _this168.HandleEvents(new YErrorMsg());
            }
        })();
    }
    ...
    _UpdateValueCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this169._ValueCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this169._ValueCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this169._ValueCallbackList.splice(index, 1);
            }
        })();
    }
    ...
    _UpdateTimedReportCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this170._TimedReportCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this170._TimedReportCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this170._TimedReportCallbackList.splice(index, 1);
            }
        })();
    }
    ...
    devRequest(str_device, str_request) {
        ...
        let obj_body = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
        let int_tcpchan = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
        return _asyncToGenerator(function* () {
            /** @type {string[]} **/
            ...
            if (str_device.substr(0, 7) == 'http://' || str_device.substr(0, 5) == 'ws://') {
                ...
                if (lines[0].substr(0, 12) != 'GET /not.byn') {
                    /** @type {string} **/
                    let serial = _this171._snByUrl[baseUrl];
                    if (serial) {
                        lockdev = _this171._devs[serial];
                    }
                }
            } else {
                lockdev = _this171.imm_getDevice(str_device);
                if (!lockdev) {
                ...
                if (lines[0] == 'GET /api.json') {
                    return yield lockdev.requestAPI(_this171.defaultCacheValidity);
                }
            ...
            /** @type {YGenericHub} **/
            let hub = _this171.imm_getHub(baseUrl);
            /** @type {string} **/
            let method = words[0];
            /** @type {string} **/
            let devUrl = words[1];
    ...
    _funcDev(str_className, str_func) {
        ...
        return _asyncToGenerator(function* () {
            var resolve = _this172.imm_funcDev_internal(str_className, str_func);
            if (resolve.errorType == YAPI_SUCCESS) {
                return resolve;
            } else if (resolve.errorType == YAPI_DEVICE_NOT_FOUND && _this172._hubs.length == 0) {
            ...
            var updRes = yield _this172._updateDeviceList_internal(true, false);
            if (updRes.errorType != YAPI_SUCCESS) {
                resolve.errorType = updRes.errorType;
                resolve.errorMsg = updRes.errorMsg;
                return resolve;
            }
            return _this172.imm_funcDev_internal(str_className, str_func);
        })();
    }
    ...
    funcRequest(str_className, str_func, str_extra) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let funcreq = _this173.imm_funcDev_internal(str_className, str_func);
            if (funcreq.errorType != YAPI_SUCCESS) {
                funcreq = yield _this173._funcDev(str_className, str_func);
                if (funcreq.errorType != YAPI_SUCCESS) {
                    return funcreq;
                }
            }
            ...
            if (str_extra == '') {
                ...
                if (yreq != null) {
                    if (yreq.errorType != YAPI_SUCCESS) return yreq;
                    try {
                        let jsonData = JSON.parse(_this173.imm_bin2str(yreq.bin_result));
            ...
            if (!loadval) {
                ...
                /** @type {YHTTPRequest} **/
                yreq = yield _this173.devRequest(devreq.deviceid, httpreq);
                if (yreq.errorType != YAPI_SUCCESS) return yreq;
                ...
                try {
                    loadval = JSON.parse(_this173.imm_bin2str(yreq.bin_result));
                } catch (err) {
                    //console.log('RequestAPI parse error: ', err);
                }
            }
    ...
    HTTPRequest(str_device, str_request) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YHTTPRequest} **/
            let yreq = yield _this174.devRequest(str_device, str_request);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this174._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    GetAPIVersion() {
        ...
        return _asyncToGenerator(function* () {
            return _this175.imm_GetAPIVersion();
        })();
    }

    imm_GetAPIVersion() {
        return (/* version number patched automatically */'1.10.23236'
        );
    }
    ...
    FreeAPI() {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let i = 0; i < _this176._hubs.length; i++) {
                _this176._hubs[i].disconnect();
            }
    ...
    DisableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this177.exceptionsDisabled = true;
        })();
    }
    ...
    EnableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this178.exceptionsDisabled = false;
        })();
    }
    ...
    RegisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this180.imm_parseRegisteredUrl(url);
            let newhub = _this180.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this180.imm_registerHub_internal(urlInfo);
            ...
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this180._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
    ...
    PreregisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this181.imm_parseRegisteredUrl(url);
            let newhub = _this181.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this181.imm_registerHub_internal(urlInfo);
            _this181._addHub(newhub);
    ...
    RegisterHubHttpCallback(incomingMessage, serverResponse, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this182.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this182.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YHttpCallbackHub(_this182, urlInfo, incomingMessage, serverResponse);
            yield newhub.httpCallbackPromise;
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                _this182._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                return _this182._throw(retcode, errmsg.msg, retcode);
            }
            yield _this182._addHub(newhub);

            // Update known device list
            let yreq = yield _this182._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this182._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
    ...
    RegisterHubWebSocketCallback(ws, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this183.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this183.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YWebSocketCallbackHub(_this183, urlInfo, ws);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                return _this183._throw(retcode, errmsg.msg, retcode);
            }
            yield _this183._addHub(newhub);

            // Update known device list
            let yreq = yield _this183._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                }
                return _this183._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    UnregisterHub(url) {
        ...
        return _asyncToGenerator(function* () {
            var urlInfo = _this184.imm_parseRegisteredUrl(url);
            var i, j;

            for (i = 0; i < _this184._hubs.length; i++) {
                if (_this184._hubs[i].urlInfo.url == urlInfo.url) {
                    _this184._hubs[i].disconnect();
                    for (j = 0; j < _this184._hubs[i].serialByYdx.length; j++) {
                        var serial = _this184._hubs[i].serialByYdx[j];
                        _this184.imm_forgetDevice(_this184._devs[serial]);
                    }
                    var before = _this184._hubs.slice(0, i);
                    if (i + 1 < _this184._hubs.length) {
                        var after = _this184._hubs.slice(i + 1);
                        _this184._hubs = before.concat(after);
                    }
                    _this184._hubs = before;
                    return;
                }
            }
        })();
    ...
    UpdateDeviceList(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var yreq = yield _this185._updateDeviceList_internal(false, true);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    HandleEvents(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var nEvents = _this186._data_events.length;
            for (var i = 0; i < nEvents; i++) {
                var evt = _this186._data_events[i];
                if (typeof evt[1] == 'string') {
                    ...
                    var dev = _this186.imm_getDevice(evt[0]._serial);
                    if (dev) {
            ...
            _this186._data_events = _this186._data_events.slice(nEvents);
    ...
    Sleep(ms_duration, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var end = _this187.GetTickCount() + ms_duration;
            yield _this187.HandleEvents(errmsg);
            while (_this187.GetTickCount() < end) {
                yield _this187._microSleep_internal();
                yield _this187.HandleEvents(errmsg);
            }
            return YAPI_SUCCESS;
        })();
    ...
    _setTimeout_internal(callback, endtime, args, errmsg) {
        ...
        if (delay < 0) {
            ...
            this.Sleep(delay, errmsg).then(function () {
                _this188._setTimeout_internal(callback, endtime, args);
            });
        } else {
            this.UpdateDeviceList(errmsg).then(function () {
                _this188.Sleep(90, errmsg).then(function () {
                    _this188._setTimeout_internal(callback, endtime, args);
                });
            });
        }
    ...
    RegisterDeviceArrivalCallback(arrivalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this189._arrivalCallback = arrivalCallback;
        })();
    }
    ...
    RegisterDeviceChangeCallback(changeCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this190._namechgCallback = changeCallback;
        })();
    }
    ...
    RegisterDeviceRemovalCallback(removalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this191._removalCallback = removalCallback;
        })();
    }
    ...
    RegisterCalibrationHandler(calibrationType, calibrationHandler) {
        ...
        return _asyncToGenerator(function* () {
            _this192._calibHandlers[calibrationType.toString()] = calibrationHandler;
        })();
    }
    ...
    ComputePSK(ssid, pass) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this193.imm_initshaw(pass, 0, 0, 0x3636, _shaw);
            _this193.imm_itershaw(sha1_init, _shaw);
            for (k = 0; k < 5; k++) inner[k] = _shaw[k];
            _shaw = new Uint32Array(80);
            _this193.imm_initshaw(pass, 0, 0, 0x5c5c, _shaw);
            _this193.imm_itershaw(sha1_init, _shaw);
            ...
            _shaw = new Uint32Array(80);
            _this193.imm_initshaw(ssid, 0, 1, 0, _shaw);

            for (iter = 0; iter < 8192;) {
                _this193.imm_itershaw(inner, _shaw);
                _shaw[5] = 0x80000000;
                for (k = 6; k < 15; k++) {
                    _shaw[k] = 0;
                }
                _shaw[15] = 8 * (64 + 20);
                _this193.imm_itershaw(outer, _shaw);
                shau[0] ^= _shaw[0];
                shau[1] ^= _shaw[1];
                shau[2] ^= _shaw[2];
                shau[3] ^= _shaw[3];
                ...
                if ((iter & 4095) == 0) {
                    ...
                    if (iter == 4096) {
                        for (k = 0; k < 5; k++) shau[k] = 0;
                        _shaw = new Uint32Array(80);
                        _this193.imm_initshaw(ssid, 2, 0, _shaw);
                    }
                }
            }
            var hex = '';
