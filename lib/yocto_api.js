/*********************************************************************
 *
 * $Id: yocto_api.js 27279 2017-04-25 15:42:35Z seb $
 *
...
class YModule extends YFunction {
    ...
    get_persistentSettings() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this91._persistentSettings;
            return res;
        })();
    }
...
class YSensor extends YFunction {
    ...
    get_currentValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = Math.round(res) / _this125._iresol;
            return res;
        })();
    }
    ...
    get_lowestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = Math.round(res) / _this127._iresol;
            return res;
        })();
    }
    ...
    get_highestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = Math.round(res) / _this129._iresol;
            return res;
        })();
    }
    ...
    get_calibrationParam() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this135._calibrationParam;
            return res;
        })();
    }
    ...
    calibrateFromPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = yield _this147._setAttr('calibrationParam', rest_val);
            return res;
        })();
    }
...
class YAPIContext {
    ...
    imm_GetAPIVersion() {
        return (/* version number patched automatically */'1.10.27439'
        );
    }
