/*********************************************************************
 *
 * $Id: yocto_api.js 23658 2016-03-30 17:00:37Z mvuilleu $
 *
...
class YSensor extends YFunction {
    ...
    get_syncProxy() {
        ...
        return _asyncToGenerator(function* () {
            if (_this120._cacheExpiration <= _this120._yapi.GetTickCount()) {
                try {
                    yield _this120.load(_this120._yapi.defaultCacheValidity);
                } catch (e) {
                    // device might be offline
                }
            }
            var res = new YSensorProxy(_this120);
            yield res._asyncInit();
            return res;
        })();
    }
    ...
    get_unit() {
        ...
        return _asyncToGenerator(function* () {
            if (_this121._cacheExpiration <= _this121._yapi.GetTickCount()) {
                if ((yield _this121.load(_this121._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return Y_UNIT_INVALID;
                }
            }
            return _this121._unit;
        })();
    }
    ...
    get_currentValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = yield _this122._applyCalibration(_this122._currentRawValue);
            if (res == Y_CURRENTVALUE_INVALID) {
                res = _this122._currentValue;
            }
            res = res * _this122._iresol;
    ...
    set_lowestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this123._setAttr('lowestValue', rest_val);
        })();
    }
    ...
    get_lowestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this124._lowestValue * _this124._iresol;
    ...
    set_highestValue(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this125._setAttr('highestValue', rest_val);
        })();
    }
    ...
    get_highestValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this126._highestValue * _this126._iresol;
    ...
    get_currentRawValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this127._currentRawValue;
        })();
    }
    ...
    set_logFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this129._setAttr('logFrequency', rest_val);
        })();
    }
    ...
    get_reportFrequency() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this130._reportFrequency;
        })();
    }
    ...
    set_reportFrequency(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this131._setAttr('reportFrequency', rest_val);
        })();
    }
    ...
    get_calibrationParam() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this132._calibrationParam;
        })();
    }
    ...
    set_calibrationParam(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this133._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    set_resolution(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this134._setAttr('resolution', rest_val);
        })();
    }
    ...
    _parserHelper() {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this137._caltyp = -1;
            _this137._scale = -1;
            _this137._isScal32 = false;
            _this137._calpar.length = 0;
            _this137._calraw.length = 0;
            _this137._calref.length = 0;
            // Store inverted resolution, to provide better rounding
            if (_this137._resolution > 0) {
                _this137._iresol = Math.round(1.0 / _this137._resolution);
            } else {
                _this137._iresol = 10000;
                _this137._resolution = 0.0001;
            }
            // Old format: supported when there is no calibration
            if (_this137._calibrationParam == '' || _this137._calibrationParam == '0') {
                _this137._caltyp = 0;
                return 0;
            }
            if (_this137._calibrationParam.indexOf(',') >= 0) {
                iCalib = _this137._yapi.imm_decodeFloats(_this137._calibrationParam);
                _this137._caltyp = parseInt(iCalib[0] / 1000, 10);
                if (_this137._caltyp > 0) {
                    if (_this137._caltyp < YOCTO_CALIB_TYPE_OFS) {
                        _this137._caltyp = -1;
                        return 0;
                    }
                    _this137.imm_calhdl = _this137._yapi.imm_getCalibrationHandler(_this137._caltyp);
                    if (!(_this137.imm_calhdl != null)) {
                        _this137._caltyp = -1;
                        return 0;
                    }
                }
                _this137._isScal = true;
                _this137._isScal32 = true;
                _this137._offset = 0;
                _this137._scale = 1000;
                maxpos = iCalib.length;
                _this137._calpar.length = 0;
                position = 1;
                while (position < maxpos) {
                    _this137._calpar.push(iCalib[position]);
                    position = position + 1;
                }
                _this137._calraw.length = 0;
                _this137._calref.length = 0;
                ...
                while (position + 1 < maxpos) {
                    ...
                    fRef = fRef / 1000.0;
                    _this137._calraw.push(fRaw);
                    _this137._calref.push(fRef);
                    position = position + 2;
                }
            } else {
                iCalib = _this137._yapi.imm_decodeWords(_this137._calibrationParam);
                if (iCalib.length < 2) {
                    _this137._caltyp = -1;
                    return 0;
                }
                _this137._isScal = iCalib[1] > 0;
                if (_this137._isScal) {
                    _this137._offset = iCalib[0];
                    if (_this137._offset > 32767) {
                        _this137._offset = _this137._offset - 65536;
                    }
                    _this137._scale = iCalib[1];
                    _this137._decexp = 0;
                } else {
                    _this137._offset = 0;
                    _this137._scale = 1;
                    _this137._decexp = 1.0;
                    position = iCalib[0];
                    while (position > 0) {
                        _this137._decexp = _this137._decexp * 10;
                        position = position - 1;
                    }
                }
                if (iCalib.length == 2) {
                ...
                _this137._caltyp = iCalib[2];
                _this137.imm_calhdl = _this137._yapi.imm_getCalibrationHandler(_this137._caltyp);
                if (_this137._caltyp <= 10) {
                    maxpos = _this137._caltyp;
                } else {
                    if (_this137._caltyp <= 20) {
                        maxpos = _this137._caltyp - 10;
                    } else {
                        maxpos = 5;
                    }
                }
                ...
                while (position + 1 < maxpos) {
                    ...
                    _this137._calpar.push(iRaw);
                    _this137._calpar.push(iRef);
                    if (_this137._isScal) {
                        fRaw = iRaw;
                        fRaw = (fRaw - _this137._offset) / _this137._scale;
                        fRef = iRef;
                        fRef = (fRef - _this137._offset) / _this137._scale;
                        _this137._calraw.push(fRaw);
                        _this137._calref.push(fRef);
                    } else {
                        _this137._calraw.push(_this137._yapi.imm_decimalToDouble(iRaw));
                        _this137._calref.push(_this137._yapi.imm_decimalToDouble(iRef));
                    }
                    position = position + 2;
                }
            }
    ...
    isSensorReady() {
        ...
        return _asyncToGenerator(function* () {
            if (!(yield _this138.isOnline())) {
                return false;
            }
            if (!(_this138._sensorState == 0)) {
                return false;
            }
            return true;
        })();
    ...
    startDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this139._download('api/dataLogger/recording?recording=1');
            if (!(res.length > 0)) {
                return _this139._throw(YAPI_IO_ERROR, 'unable to start datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    stopDataLogger() {
        ...
        return _asyncToGenerator(function* () {
            ...
            let res;
            // may throw an exception
            res = yield _this140._download('api/dataLogger/recording?recording=0');
            if (!(res.length > 0)) {
                return _this140._throw(YAPI_IO_ERROR, 'unable to stop datalogger', YAPI_IO_ERROR);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    get_recordedData(startTime, endTime) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let funit;
            // may throw an exception
            funcid = yield _this141.get_functionId();
            funit = yield _this141.get_unit();
            return new YDataSet(_this141, funcid, funit, startTime, endTime);
        })();
    }
    ...
    registerTimedReportCallback(callback) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this142._timedReportCallbackSensor = callback;
            return 0;
        })();
    }
    ...
    _invokeTimedReportCallback(value) {
        ...
        return _asyncToGenerator(function* () {
            if (_this143._timedReportCallbackSensor != null) {
                yield _this143._timedReportCallbackSensor(_this143, value);
            } else {}
            return 0;
        })();
    }
    ...
    calibrateFromPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            // may throw an exception
            rest_val = yield _this144._encodeCalibrationPoints(rawValues, refValues);
            return yield _this144._setAttr('calibrationParam', rest_val);
        })();
    }
    ...
    loadCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (_this145._scale == 0) {
                if ((yield _this145.load(_this145._yapi.defaultCacheValidity)) != YAPI_SUCCESS) {
                    return YAPI_DEVICE_NOT_FOUND;
                }
            }
            if (_this145._caltyp < 0) {
                _this145._throw(YAPI_NOT_SUPPORTED, 'Calibration parameters format mismatch. Please upgrade your library or firmware.');
                return YAPI_NOT_SUPPORTED;
            }
            rawValues.length = 0;
            refValues.length = 0;
            for (let ii in _this145._calraw) {
                rawValues.push(_this145._calraw[ii]);
            }
            for (let ii in _this145._calref) {
                refValues.push(_this145._calref[ii]);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    _encodeCalibrationPoints(rawValues, refValues) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (npt != refValues.length) {
                _this146._throw(YAPI_INVALID_ARGUMENT, 'Invalid calibration parameters (size mismatch)');
            ...
            if (_this146._isScal32) {
                ...
                if (_this146._isScal) {
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = Math.round(rawValues[idx] * _this146._scale + _this146._offset);
                        iRef = Math.round(refValues[idx] * _this146._scale + _this146._offset);
                    ...
                    idx = 0;
                    while (idx < npt) {
                        iRaw = _this146._yapi.imm_doubleToDecimal(rawValues[idx]);
                        iRef = _this146._yapi.imm_doubleToDecimal(refValues[idx]);
                        res = res + ',' + String(Math.round(iRaw)) + ',' + String(Math.round(iRef));
                        idx = idx + 1;
                    }
                }
    ...
    _applyCalibration(rawValue) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (!(_this147.imm_calhdl != null)) {
                return Y_CURRENTVALUE_INVALID;
            }
            return _this147.imm_calhdl(rawValue, _this147._caltyp, _this147._calpar, _this147._calraw, _this147._calref);
        })();
    }
    ...
    _decodeTimedReport(timestamp, report) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {number} **/
            let maxVal;
            startTime = _this148._prevTimedReport;
            endTime = timestamp;
            _this148._prevTimedReport = endTime;
            if (startTime == 0) {
                startTime = endTime;
            }
            if (report[0] == 2) {
                if (report.length <= 5) {
                    ...
                    if (_this148._caltyp != 0) {
                        if (_this148.imm_calhdl != null) {
                            avgVal = _this148.imm_calhdl(avgVal, _this148._caltyp, _this148._calpar, _this148._calraw, _this148._calref);
                        }
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                    ...
                    if (_this148._caltyp != 0) {
                        if (_this148.imm_calhdl != null) {
                            avgVal = _this148.imm_calhdl(avgVal, _this148._caltyp, _this148._calpar, _this148._calraw, _this148._calref);
                            minVal = _this148.imm_calhdl(minVal, _this148._caltyp, _this148._calpar, _this148._calraw, _this148._calref);
                            maxVal = _this148.imm_calhdl(maxVal, _this148._caltyp, _this148._calpar, _this148._calraw, _this148._calref);
                        }
                    }
                }
            } else {
                if (report[0] == 0) {
                    ...
                    if (_this148._isScal) {
                        avgVal = _this148.imm_decodeVal(avgRaw);
                    } else {
                        if ((byteVal & 0x80) != 0) {
                            avgRaw = avgRaw - poww;
                        }
                        avgVal = _this148.imm_decodeAvg(avgRaw);
                    }
                    minVal = avgVal;
                    maxVal = avgVal;
                } else {
                    ...
                    minVal = _this148.imm_decodeVal(minRaw);
                    avgVal = _this148.imm_decodeAvg(avgRaw);
                    maxVal = _this148.imm_decodeVal(maxRaw);
                }
            }
...
class YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            /** @type {YHTTPRequest} **/
            let yreq = yield _this149.request('GET', '/api/module.json', null, 0);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    hubUpdateDeviceList() {
        ...
        return _asyncToGenerator(function* () {
            ...
            try {
                /** @type {YDevice} **/
                let hubDev = _this150._yapi.imm_getDevice(_this150.urlInfo.url);
                hubDev.imm_dropCache();
                /** @type {number} **/
                let retcode = yield hubDev.refresh();
                if (retcode != YAPI_SUCCESS) {
                    return _this150._throw(retcode, hubDev._lastErrorMsg, retcode);
                }
                /** @type {YHTTPRequest} **/
                let yreq = yield hubDev.requestAPI(_this150._yapi.defaultCacheValidity);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return yreq;
                }
                let loadval = null;
                try {
                    loadval = JSON.parse(_this150._yapi.imm_bin2str(yreq.bin_result));
                } catch (err) {}
                if (!loadval) {
                    return _this150._throw(YAPI_IO_ERROR, 'Request failed, could not parse API result for ' + hubDev.imm_describe(), YAPI_IO_ERROR);
                }
                let whitePages = loadval['services']['whitePages'];
                let yellowPages = loadval['services']['yellowPages'];
                if (whitePages == undefined) {
                    return _this150._throw(YAPI_IO_ERROR, 'Device ' + hubDev.imm_describe() + ' is not a hub', YAPI_IO_ERROR);
                }
                retcode = yield _this150._yapi.updateDeviceList_process(_this150, hubDev, whitePages, yellowPages);
                if (retcode != YAPI_SUCCESS) {
                    return _this150._throw(_this150._yapi._lastErrorType, _this150._yapi._lastErrorMsg, _this150._yapi._lastErrorType);
                }

                // reset device list cache timeout for this hub
                _this150.devListExpires = _this150._yapi.GetTickCount() + _this150.devListValidity;
                return YAPI_SUCCESS;
            } catch (e) {
    ...
    getBootloaders() {
        ...
        return _asyncToGenerator(function* () {
            let yreq = yield _this151.request('GET', '/flash.json?a=list', null, 1);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this151._throw(yreq.errorType, yreq.errorMsg, []);
            }
    ...
    firmwareUpdate(serial, firmware, settings, progress) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let _throw = function (msg) {
                return _this152._throw(YAPI.IO_ERROR, msg, [msg]);
            };
            ...
            let json = JSON.parse(_this152._yapi.imm_bin2str(yreq.bin_result));
            ...
            if (ownSerial.slice(0, 7) == 'VIRTHUB') {
                ...
                yreq = yield _this152.request('GET', '/bySerial/' + serial + '/flash.json?a=state', null, 0);
                if (yreq.errorType == YAPI_SUCCESS) {
                    use_self_flash = true;
                    baseUrl = '/bySerial/' + serial;
                }
            }
            let bootloaders = yield _this152.getBootloaders();
            ...
            yreq = yield _this152.request('POST', baseUrl + '/upload.html', new YHTTPBody('firmware', firmware.imm_getData(), progressCb), 0);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _throw('Firmware upload failed: ' + yreq.errorMsg);
            }
            yreq = yield _this152.request('GET', baseUrl + '/flash.json?a=state', null, 0);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _throw('Cannot check state of firmware upload');
            }
            json = JSON.parse(_this152._yapi.imm_bin2str(yreq.bin_result));
            if (json['state'] != 'valid') {
            ...
            if (use_self_flash) {
                ...
                yreq = yield _this152.request('POST', baseUrl + '/upload.html', new YHTTPBody('startupConf.json', settings, null), 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Failed to save settings on hub');
                }
                progress(38, 'Save current settings');
                yreq = yield _this152.request('POST', baseUrl + '/upload.html', new YHTTPBody('firmwareConf', settings, null), 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Failed to save settings on hub');
                }
            }
            ...
            if (use_self_flash) {
                ...
                yield _this152.request('GET', baseUrl + '/api/module/rebootCountdown?rebootCountdown=-1003', null, 0);
                yield _this152._yapi.Sleep(7000);
            } else {
                // reboot device to bootloader if needed
                if (need_reboot) {
                    // reboot subdevice
                    yield _this152.request('GET', '/bySerial/' + serial + '/api/module/rebootCountdown?rebootCountdown=-2', null, 0);
                }
                ...
                do {
                    let list = _this152.getBootloaders();
                    for (i = 0; i < bootloaders.length; i++) {
                        let bl = bootloaders[i];
                        if (bl == serial) {
                            found = true;
                    ...
                    if (!found) {
                        yield _this152._yapi.Sleep(500);
                    }
                } while (!found && YAPI.GetTickCount() < timeout);
                //start flash
                progress(45, 'Flash firmware');
                yreq = yield _this152.request('GET', '/flash.json?a=flash&s=' + serial, null, 0);
                if (yreq.errorType != YAPI_SUCCESS) {
                    return _throw('Cannot check state of firmware flash');
                }
                return JSON.parse(_this152._yapi.imm_bin2str(yreq.bin_result));
            }
            return null;
        })();
    }
...
class YHttpHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this154.disconnecting) {
                return YAPI_IO_ERROR;
            }
            let args = '?len=' + _this154.notiflen.toString();
            if (_this154.notifPos > 0) {
                args += '&abs=' + _this154.notifPos.toString();
            }
            _this154.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this154.notbynRequest = new XMLHttpRequest();
                _this154.notbynRequest.open('GET', _this154.urlInfo.url + 'not.byn' + args, true, '', '');
                _this154.notbynRequest.overrideMimeType('text/plain; charset=x-user-defined');
                _this154.notbynRequest.onreadystatechange = function () {
                    if (_this154.disconnecting) {
                        return;
                    }
                    if (_this154.notbynRequest.readyState >= 3) {
                        resolve(YAPI_SUCCESS);
                        if (_this154.notbynRequest.readyState == 4 && parseInt(_this154.notbynRequest.status) != 200 && parseInt(_this154.notbynRequest.status) != 304) {
                            // connection error
                            if (_this154.retryDelay < 15000) _this154.retryDelay *= 2;
                            _this154.devListValidity = 500;
                            _this154.devListExpires = 0;
                            setTimeout(function () {
                                _this154.testHub(new YErrorMsg());
                            }, _this154.retryDelay);
                        } else {
                            // receiving data properly
                            if (_this154.notbynRequest.readyState == 3) {
                                // when using reconnection mode, ignore state 3
                                if (_this154.notiflen == 1) return;
                            }
                            let newlen = _this154.notbynRequest.responseText.length;
                            if (newlen > _this154.currPos) {
                                _this154._yapi.parseEvents(_this154, _this154.notbynRequest.responseText.substr(_this154.currPos, newlen - _this154.currPos));
                            }
                            // trigger immediately a new connection if closed in success
                            if (_this154.notbynRequest.readyState == 4 && parseInt(_this154.notbynRequest.status) != 0) {
                                _this154.currPos = 0;
                                _this154.testHub(new YErrorMsg());
                            }
                        }
                ...
                _this154.notbynRequest.send('');
            });
            return yield _this154.notbynOpenPromise;
        })();
    }
    ...
    request(method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            let httpPromise = new Promise(function (resolve, reject) {
                let prefix = _this155.urlInfo.url.slice(0, -1);
                let httpRequest = new XMLHttpRequest();
                httpRequest.open(method, prefix + devUrl, true, _this155.urlInfo.user, _this155.urlInfo.pass);
                httpRequest.onreadystatechange = function () {
                    if (httpRequest.readyState == 4) {
                        ...
                        if (httpRequest.status != 200 && httpRequest.status != 304) {
                            ...
                            yreq.bin_result = _this155._yapi.imm_str2bin(httpRequest.responseText);
                        }
                        resolve(yreq);
                    }
                };
...
class YHttpNodeHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let options = {
                method: 'GET',
                hostname: _this157.urlInfo.host,
                port: _this157.urlInfo.port,
                path: '/not.byn' + args
            };
            _this157.notbynOpenPromise = new Promise(function (resolve, reject) {
                _this157.notbynRequest = _this157.http.request(options, function (res) {
                    if (_this157.disconnecting) {
                        return;
                    }
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        if (_this157.retryDelay < 15000) _this157.retryDelay *= 2;
                        _this157.devListValidity = 500;
                        _this157.devListExpires = 0;
                        setTimeout(function () {
                        ...
                        res.on('data', function (chunk) {
                            // receiving data properly
                            _this157._yapi.parseEvents(_this157, _this157._yapi.imm_bin2str(chunk));
                        });
                        res.on('end', function () {
                            // trigger immediately a new connection if closed in success
                            _this157.currPos = 0;
                ...
                _this157.notbynRequest.on('error', function () {
    ...
    request(str_method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            let options = {
                method: str_method,
                hostname: _this158.urlInfo.host,
                port: _this158.urlInfo.port,
                path: devUrl
            };
            if (obj_body) {
                options.boundary = _this158.imm_getBoundary();
                options.headers = { 'Content-Type': 'multipart/form-data; boundary=' + options.boundary };
            }
            let httpPromise = new Promise(function (resolve, reject) {
                let response = new Buffer(0);
                let httpRequest = _this158.http.request(options, function (res) {
                    if (res.statusCode != 200 && res.statusCode != 304) {
                        // connection error
                        let yreq = new YHTTPRequest(null);
                        yreq.errorType = YAPI_NOT_SUPPORTED;
                        yreq.errorMsg = 'HTTP Error ' + res.statusCode.toString() + ' on ' + _this158.urlInfo.url.slice(0, -1) + devUrl;
                        resolve(yreq);
                    } else {
                        res.on('data', function (chunk) {
                            // receiving data properly
                ...
                if (obj_body) {
                    httpRequest.write(new Buffer(_this158.imm_formEncodeBody(obj_body, options.boundary)));
                }
                httpRequest.end();
            });
            return httpPromise;
...
class YHttpCallbackHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            yield _this160.httpCallbackPromise;
            if (_this160._incomingMessage.method != 'POST') {
                errmsg.msg = 'HTTP POST expected';
                return YAPI_INVALID_ARGUMENT;
            }
            if (_this160._callbackData.length == 0) {
                errmsg.msg = 'Empty POST body';
                return YAPI_NO_MORE_DATA;
            }
            if (_this160.urlInfo.pass != '') {
                // callback data signed, verify signature
                if (!_this160._callbackCache.sign) {
                    errmsg.msg = 'missing signature from incoming YoctoHub (callback password required)';
                    _this160._callbackCache = [];
                    return YAPI_NO_MORE_DATA;
                }
                let sign = _this160._callbackCache['sign'];
                let pass = _this160.urlInfo.pass;
                let salt;
                if (pass.length == 32) {
                    salt = pass.toLowerCase();
                } else {
                    salt = _this160._yapi.imm_bin2hexstr(_this160._yapi.imm_yMD5(pass)).toLowerCase();
                }
                let patched = _this160._yapi.imm_bin2str(_this160._callbackData).replace(sign, salt);
                let check = _this160._yapi.imm_bin2hexstr(_this160._yapi.imm_yMD5(patched));
    ...
    request(str_method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_method == 'POST' && obj_body) {
                let boundary = _this161.imm_getBoundary();
                let body = _this161.imm_formEncodeBody(obj_body, boundary);
                _this161._serverResponse.write('\n@YoctoAPI:' + str_method + ' ' + devUrl + ' ' + body.length + ':' + boundary + '\n');
                _this161._serverResponse.write(new Buffer(body));
                ...
                if (devUrl.indexOf('?') == -1 || devUrl.indexOf('/logs.txt') != -1 || devUrl.indexOf('/logger.json') != -1 || devUrl.indexOf('/ping.txt') != -1 || devUrl.indexOf('/files.json?a=dir') != -1) {
                    ...
                    if (!_this161._callbackCache[devUrl]) {
                        ...
                        var jsonres = _this161._callbackCache[devUrl];
                        if (subfun) {
                            jsonres = jsonres[subfun[1]];
                        }
                        yreq.bin_result = _this161._yapi.imm_str2bin(JSON.stringify(jsonres));
                    }
                } else {
...
class YWebSocketHub extends YGenericHub {
    ...
    testHub(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            if (_this162.disconnecting) {
                return YAPI_IO_ERROR;
            }
            // Open WebSocket connection
            _this162.imm_webSocketOpen(_this162.urlInfo.url + 'not.byn');
            _this162.websocketOpenPromise = new Promise(function (resolve, reject) {
                if (_this162.disconnecting) {
                    resolve(YAPI_IO_ERROR);
                } else {
                    _this162.websocket.onmessage = function (evt) {
                        _this162._webSocketMsg(new Uint8Array(evt.data));
                        if (_this162._connectionState == _this162._WS_CONNECTED) {
                            resolve(YAPI_SUCCESS);
                        } else if (_this162._connectionState == _this162._WS_DEAD) {
                            errmsg.msg = _this162._session_error;
                            console.log('WebSocket error: ' + _this162._session_error);
                            resolve(_this162._session_errno == 401 ? YAPI_UNAUTHORIZED : YAPI_IO_ERROR);
                            _this162.disconnect();
                        }
                    };
                }
            });
            _this162.websocket.onclose = function (evt) {
                _this162.websocket = null;
                if (_this162.retryDelay < 0) {
                    _this162.disconnecting = true;
                }
                if (_this162.disconnecting) {
                    return;
                }
                // connection error
                if (_this162.retryDelay < 15000) _this162.retryDelay *= 2;
                _this162.devListValidity = 500;
                _this162.devListExpires = 0;
                setTimeout(function () {
                    _this162.testHub(new YErrorMsg());
                }, _this162.retryDelay);
            };
            _this162.websocket.onerror = function (evt) {
                console.log('WebSocket error: ', evt);
                if (_this162.websocket.terminate) {
                    _this162.websocket.terminate();
                }
                _this162.websocket = null;
                if (_this162.retryDelay < 0) {
                    _this162.disconnecting = true;
            ...
            return yield _this162.websocketOpenPromise;
        })();
    }
    ...
    _webSocketMsg(arr_bytes) {
        ...
        return _asyncToGenerator(function* () {
            try {
                let reltime = (_this163._yapi.GetTickCount() - _this163._connectionTime) / 1000.0;
                let ystream = arr_bytes[0] >>> 3;
                var text = '';
                if (ystream == _this163._YSTREAM_TCP_NOTIF) {
                    //console.log(reltime+': TCP_NOTIF len='+arr_bytes.length);
                    for (let i = 1; i < arr_bytes.length; i++) {
                        text += String.fromCharCode(arr_bytes[i]);
                    }
                    yield _this163._yapi.parseEvents(_this163, text);
                    return;
                }
                // Other types of messages
                var ws = _this163.websocket;
                var tcpchan = arr_bytes[0] & 7;
                if (ystream == _this163._YSTREAM_TCP || ystream == _this163._YSTREAM_TCP_CLOSE || ystream == _this163._YSTREAM_TCP_ASYNCCLOSE) {
                    let tcp_end = arr_bytes.length;
                    let yreq = _this163.tcpChan[tcpchan];
                    //console.log(reltime+': TCP ystream='+ystream+' len='+arr_bytes.length);
                    if (!yreq) {
                        _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Drop frame for closed tcpChan ' + tcpchan);
                        return;
                    }
                    if (ystream == _this163._YSTREAM_TCP_ASYNCCLOSE) {
                        // async close packet, check async signature byte
                        tcp_end--;
                        if (yreq.asyncId == 0) {
                            _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Asynchronous close received, sync reply request');
                            return;
                        } else if (yreq.asyncId != arr_bytes[tcp_end]) {
                            _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Incorrect async-close signature on tcpChan ' + tcpchan);
                            return;
                        }
                    }
                    ...
                    if (ystream == _this163._YSTREAM_TCP_CLOSE || ystream == _this163._YSTREAM_TCP_ASYNCCLOSE) {
                        // Pop request from tcp channel
                        _this163.tcpChan[tcpchan] = yreq.next;

                        // Handle synchronous close
                        if (ystream == _this163._YSTREAM_TCP_CLOSE) {
                            // synchronous close
                            if (yreq.asyncId != 0) {
                                _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Synchronous close received, async ack expected');
                                return;
                            } else {
                                ...
                                if (yreq.timeoutId) {
                                    ...
                                    frame[0] = (_this163._YSTREAM_TCP_CLOSE << 3) + tcpchan;
                                    _this163.websocket.send(frame);
                                }
                            }
                        }
                        ...
                        if (pos < 0) {
                            ...
                            let header = _this163._yapi.imm_bin2str(yreq.bin_result.subarray(0, pos));
                        ...
                        if (yreq.asyncId == 0) {
                            _this163.imm_sendPendingRequest(tcpchan);
                            yreq.acceptor(yreq);
                        } else {
                            // asynchronous request: log errors, but nothing else to be done
                            if (yreq.errorType != YAPI_SUCCESS) {
                                _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Async request error: ' + yreq.errorMsg);
                            }
                        }
                    }
                    return;
                }
                if (ystream == _this163._YSTREAM_META) {
                    let metatype = arr_bytes[1];
                    //console.log(reltime+': META type='+metatype+' len='+arr_bytes.length);
                    switch (metatype) {
                        case _this163._USB_META_WS_ANNOUNCE:
                            if (arr_bytes.length < 1 + _this163._USB_META_WS_ANNOUNCE_SIZE) {
                                return;
                            }
                            _this163._remoteVersion = arr_bytes[2];
                            if (_this163._remoteVersion < 1) {
                                return;
                            }
                            var maxtcpws = (arr_bytes[3] << 4) + (arr_bytes[4] << 12);
                            if (maxtcpws > 0) {
                                _this163._tcpMaxWindowSize = maxtcpws;
                            }
                            _this163._remoteNonce = arr_bytes[5] + (arr_bytes[6] << 8) + (arr_bytes[7] << 16) + (arr_bytes[8] << 24);
                            for (let i = 9; i < 9 + 20; i++) {
                                if (arr_bytes[i] == 0) {
                                    _this163._remoteSerial = _this163._yapi.imm_bin2str(arr_bytes.subarray(9, i));
                                    break;
                                }
                            }
                            _this163._nonce = parseInt(Math.random() * 0xffffffff);
                            _this163._connectionTime = _this163._yapi.GetTickCount();
                            _this163._connectionState = _this163._WS_AUTHENTICATING;
                            // send our authentication packet
                            let frame = new Uint8Array(1 + _this163._USB_META_WS_AUTHENTICATION_SIZE);
                            let version = _this163._remoteVersion < 2 ? _this163._remoteVersion : 2;
                            let flags = 0;
                            frame[0] = _this163._YSTREAM_META << 3;
                            frame[1] = _this163._USB_META_WS_AUTHENTICATION;
                            frame[2] = version;
                            if (_this163.urlInfo.pass != '') {
                                flags = _this163._USB_META_WS_VALID_SHA1;
                                let sha1 = _this163.imm_computeAuth(_this163.urlInfo.user, _this163.urlInfo.pass, _this163._remoteSerial, _this163._remoteNonce);
                            ...
                            frame[3] = flags & 0xff;
                            frame[4] = flags >>> 8;
                            frame[5] = _this163._nonce & 0xff;
                            frame[6] = _this163._nonce >>> 8 & 0xff;
                            frame[7] = _this163._nonce >>> 16 & 0xff;
                            frame[8] = _this163._nonce >>> 24 & 0xff;
                            _this163.websocket.send(frame);
                            break;
                        case _this163._USB_META_WS_AUTHENTICATION:
                            if (_this163._connectionState != _this163._WS_AUTHENTICATING) {
                                return;
                            }
                            if (arr_bytes.length < 1 + _this163._USB_META_WS_AUTHENTICATION_SIZE) {
                                return;
                            }
                            _this163._tcpRoundTripTime = _this163._yapi.GetTickCount() - _this163._connectionTime + 1;
                            let uploadRate = parseInt(_this163._tcpMaxWindowSize * 1000 / _this163._tcpRoundTripTime);
                            ...
                            if ((inflags & _this163._USB_META_WS_RW) != 0) {
                                _this163._rwAccess = true;
                            }
                            if ((inflags & _this163._USB_META_WS_VALID_SHA1) != 0) {
                                let remote_sha1 = arr_bytes.subarray(9, 29);
                                let sha1 = _this163.imm_computeAuth(_this163.urlInfo.user, _this163.urlInfo.pass, _this163._remoteSerial, _this163._nonce);
                                for (let i = 0; i < sha1.length; i++) {
                                    if (sha1[i] != remote_sha1[i]) {
                                        // bad signature
                                        _this163._session_errno = 401;
                                        _this163._session_error = 'Authentication failed';
                                        _this163._connectionState = _this163._WS_DEAD;
                                        return;
                                    }
                                }
                                // Password verified OK
                                _this163._connectionState = _this163._WS_CONNECTED;
                            } else {
                                if (_this163.urlInfo.pass == '') {
                                    ...
                                    _this163._session_errno = 401;
                                    if (_this163.urlInfo.user == 'admin' && !_this163._rwAccess) {
                                        _this163._session_error = 'Authentication as admin failed';
                                    } else {
                                        _this163._session_error = 'Password not set on remote hub';
                                    }
                                    _this163._connectionState = _this163._WS_DEAD;
                                    return;
                                }
                            ...
                            break;
                        case _this163._USB_META_WS_ERROR:
                            _this163._session_errno = arr_bytes[3] + (arr_bytes[4] << 8);
                            if (_this163._session_errno == 401) {
                                _this163._session_error = 'Authentication failed';
                            } else {
                                _this163._session_error = 'Remote hub closed connection with error ' + _this163._session_errno;
                            }
                            _this163._connectionState = _this163._WS_DEAD;
                            break;
                        case _this163._USB_META_ACK_UPLOAD:
                            tcpchan = arr_bytes[2];
                            if (_this163.tcpChan[tcpchan]) {
                                let yreq = _this163.tcpChan[tcpchan];
                                let ackBytes = arr_bytes[3] + (arr_bytes[4] << 8) + (arr_bytes[5] << 16) + (arr_bytes[6] << 24);
                                let ackTime = _this163._yapi.GetTickCount();
                                if (_this163._lastUploadAckTime[tcpchan] != 0 && ackBytes > _this163._lastUploadAckBytes[tcpchan]) {
                                    _this163._lastUploadAckBytes[tcpchan] = ackBytes;
                                    _this163._lastUploadAckTime[tcpchan] = ackTime;
                                    let deltaBytes = ackBytes - _this163._lastUploadRateBytes[tcpchan];
                                    let deltaTime = ackTime - _this163._lastUploadRateTime[tcpchan];
                                    if (deltaTime < 500) break; // wait more
                                    if (deltaTime < 1000 && deltaBytes < 65536) break; // wait more
                                    _this163._lastUploadRateBytes[tcpchan] = ackBytes;
                                    _this163._lastUploadRateTime[tcpchan] = ackTime;
                                    if (yreq.progressCb && yreq.toBeSent) {
                                        yreq.progressCb(ackBytes, yreq.toBeSent.length);
                                    }
                                    let newRate = deltaBytes * 1000 / deltaTime;
                                    _this163._uploadRate[tcpchan] = parseInt(0.8 * _this163._uploadRate[tcpchan] + 0.3 * newRate); // +10% intentionally
                ...
                _this163.imm_asyncWebSocketError(YAPI_IO_ERROR, 'Unsupported message: ' + _this163._yapi.imm_bin2hexstr(arr_bytes));
            } catch (e) {
    ...
    request(method, devUrl, obj_body, tcpchan) {
        ...
        return _asyncToGenerator(function* () {
            if (_this164.logging) {
                _this164.imm_logrequest(method, devUrl, obj_body);
            }
            let httpPromise = new Promise(function (resolve, reject) {
                let subReq = method + ' ' + devUrl + ' \r\n\r\n';
                let ws = _this164.websocket;
                let isAsync = _this164._remoteVersion > 0 && devUrl.slice(-2) == '&.';
                ...
                if (isAsync) {
                    yreq.asyncId = _this164.nextAsyncId++;
                    if (_this164.nextAsyncId >= 127) {
                        _this164.nextAsyncId = 48;
                    }
                }

                // Queue all requests on tcpChan 0 for now, to preserve request order
                let queue = _this164.tcpChan[tcpchan];
                if (queue) {
                    while (queue.next) {
                        queue = queue.next;
                    }
                    ...
                    _this164.tcpChan[tcpchan] = yreq;
                }

                // Send request if possible
                _this164.imm_sendPendingRequest(tcpchan);
            });
    ...
    imm_sendPendingRequest(tcpchan) {
        ...
        while (yreq) {
            ...
            yreq.timeoutId = setTimeout(function (chan, yr) {
                _this165.imm_abortRequest(chan, yr);
    ...
    imm_abortRequest(tcpchan, yreq) {
        ...
        setTimeout(function (chan, yr) {
            _this166.imm_forgetRequest(chan, yr);
        }, 5000, tcpchan, yreq);
    ...
    disconnect() {
        ...
        return _asyncToGenerator(function* () {
            _this167.imm_commonDisconnect();
            _this167.websocket.close();
            _this167.websocket = null;
        })();
    }
}
...
class YAPIContext {
    ...
    _addHub(newhub) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this168._hubs.push(newhub);

            // If hub is not yet known, create a device object (synchronous call)
            var serial = _this168._snByUrl[newhub.urlInfo.url];
            if (!serial) {
                let dev = new YDevice(_this168, newhub.urlInfo.url, null, null);
                yield dev.refresh();
            }
        })();
    }
    ...
    _updateDeviceList_internal(bool_forceupdate, bool_invokecallbacks) {
        ...
        return _asyncToGenerator(function* () {
            if (_this169._firstArrival && bool_invokecallbacks && _this169._arrivalCallback) {
                bool_forceupdate = true;
            }
            if (bool_forceupdate) {
                for (let i = 0; i < _this169._hubs.length; i++) {
                    _this169._hubs[i].imm_forceUpdate();
                }
            }
            if (_this169._updateDevListStarted && _this169.GetTickCount() - _this169._updateDevListStarted < 30 * 1000) {
                return {
            ...
            try {
                ...
                _this169._updateDevListStarted = _this169.GetTickCount();

                // collect list of hubs which should be checked
                let hubs = [];
                for (let i = 0; i < _this169._hubs.length; i++) {
                    let hub = _this169._hubs[i];
                    let rootUrl = hub.urlInfo.url;
                    let hubDev = _this169.imm_getDevice(rootUrl);
                    if (!hubDev) continue;
                    if (hub.devListExpires <= _this169.GetTickCount()) {
                        hub.missing = [];
                        hubs.push(hub);
                    }
                }
                ...
                for (let serial in _this169._devs) {
                    let rooturl = _this169._devs[serial].imm_getRootUrl();
                    for (let i = 0; i < hubs.length; i++) {
                ...
                if (bool_invokecallbacks) {
                    let nbEvents = _this169._pendingCallbacks.length;
                    for (let i = 0; i < nbEvents; i++) {
                        let evt = _this169._pendingCallbacks[i];
                        let serial = evt.slice(1);
                        switch (evt.charAt(0)) {
                            case '+':
                                if (_this169._arrivalCallback != undefined) {
                                    yield _this169._arrivalCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '/':
                                if (_this169._namechgCallback != undefined) {
                                    yield _this169._namechgCallback(yFindModule(serial + '.module'));
                                }
                                break;
                            case '-':
                                if (_this169._removalCallback != undefined) {
                                    yield _this169._removalCallback(yFindModule(serial + '.module'));
                                }
                                _this169.imm_forgetDevice(_this169._devs[serial]);
                                break;
                        }
                    }
                    _this169._pendingCallbacks = _this169._pendingCallbacks.slice(nbEvents);
                    if (_this169._arrivalCallback != undefined && _this169._firstArrival) {
                        _this169._firstArrival = false;
                    }
                }
            } finally {
                _this169._updateDevListStarted = false;
            }
    ...
    updateDeviceList_process(hub, hubDev, whitePages, yellowPages) {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let classname in yellowPages) {
                ...
                let ftype = _this170._fnByType[classname];
                if (ftype == undefined) {
                    ftype = new YFunctionType(_this170, classname);
                    _this170._fnByType[classname] = ftype;
                }
            ...
            for (let devkey in whitePages) {
                ...
                var currdev = _this170._devs[serial];
                if (currdev && _this170._arrivalCallback != undefined && _this170._firstArrival) {
                    _this170._pendingCallbacks.push('+' + serial);
                }
                hub.serialByYdx[devydx] = serial;
                if (!currdev) {
                    // Add new device
                    //noinspection ObjectAllocationIgnored
                    new YDevice(_this170, rooturl, devinfo, yellowPages);
                    if (_this170._arrivalCallback != undefined) {
                        _this170._pendingCallbacks.push('+' + serial);
                    }
                } else if (currdev.imm_getLogicalName() != devinfo['logicalName']) {
                    // Reindex device from its own data
                    yield currdev.refresh();
                    if (_this170._namechgCallback != undefined) {
                        _this170._pendingCallbacks.push('/' + serial);
                    }
            ...
            for (serial in hub.missing) {
                if (hub.missing[serial]) {
                    if (_this170._removalCallback != undefined) {
                        _this170._pendingCallbacks.push('-' + serial);
                    } else {
                        _this170.imm_forgetDevice(_this170._devs[serial]);
                    }
                }
            }
        ...
        return _asyncToGenerator(function* () {
            ...
            for (var idx = 0; idx < nrows; idx++) {
                ...
                if (ev.length >= 3 && firstCode >= NOTIFY_NETPKT_FLUSHV2YDX && firstCode <= NOTIFY_NETPKT_TIMEAVGYDX) {
                    ...
                    if (serial && _this171._devs[serial]) {
                        var funcid = funydx == 0xf ? 'time' : _this171._devs[serial].imm_functionId(funydx);
                        if (funcid != '') {
                            value = ev.slice(3);
                            switch (firstCode) {
                                case NOTIFY_NETPKT_FUNCVALYDX:
                                    ...
                                    _this171.imm_setFunctionValue(serial + '.' + funcid, value);
                                    break;
                                ...
                                case NOTIFY_NETPKT_TIMEV2YDX:
                                    ...
                                    var dev = _this171._devs[serial];
                                    if (funcid == 'time') {
                                        var time = arr[1] + 0x100 * arr[2] + 0x10000 * arr[3] + 0x1000000 * arr[4];
                                        dev.imm_setDeviceTime(time + arr[5] / 250.0);
                                    } else {
                                        _this171.imm_setTimedReport(serial + '.' + funcid, dev.imm_getDeviceTime(), arr);
                                    }
                                    break;
                                case NOTIFY_NETPKT_FUNCV2YDX:
                                    var rawval = _this171.imm_decodeNetFuncValV2(value);
                                    if (rawval != null) {
                                        var decodedval = _this171.imm_decodePubVal(rawval[0], rawval, 1, 6);
                                        _this171.imm_setFunctionValue(serial + '.' + funcid, decodedval);
                                    }
                                    break;
                    ...
                    if (notype == '@') {
                        ...
                        case 5:
                            ...
                            if (parts.length > 2) {
                                ...
                                _this171.imm_setFunctionValue(parts[0] + '.' + parts[1], value[0]);
                            }
                            break;
                    }
                } else {
            ...
            if (_this171._forwardValues > 0) {
                yield _this171.HandleEvents(new YErrorMsg());
            }
        })();
    }
    ...
    _UpdateValueCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this172._ValueCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this172._ValueCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this172._ValueCallbackList.splice(index, 1);
            }
        })();
    }
    ...
    _UpdateTimedReportCallbackList(obj_func, bool_add) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let index = _this173._TimedReportCallbackList.indexOf(obj_func);
            if (bool_add) {
                yield obj_func.isOnline();
                if (index < 0) {
                    _this173._TimedReportCallbackList.push(obj_func);
                }
            } else if (index >= 0) {
                _this173._TimedReportCallbackList.splice(index, 1);
            }
        })();
    }
        ...
        return _asyncToGenerator(function* () {
            ...
            if (str_device.substr(0, 7) == 'http://' || str_device.substr(0, 5) == 'ws://') {
                ...
                if (lines[0].substr(0, 12) != 'GET /not.byn') {
                    /** @type {string} **/
                    let serial = _this174._snByUrl[baseUrl];
                    if (serial) {
                        lockdev = _this174._devs[serial];
                    }
                }
            } else {
                lockdev = _this174.imm_getDevice(str_device);
                if (!lockdev) {
                ...
                if (lines[0] == 'GET /api.json') {
                    return yield lockdev.requestAPI(_this174.defaultCacheValidity);
                }
            ...
            /** @type {YGenericHub} **/
            let hub = _this174.imm_getHub(baseUrl);
            /** @type {string} **/
            let method = words[0];
            /** @type {string} **/
            let devUrl = words[1];
    ...
    _funcDev(str_className, str_func) {
        ...
        return _asyncToGenerator(function* () {
            var resolve = _this175.imm_funcDev_internal(str_className, str_func);
            if (resolve.errorType == YAPI_SUCCESS) {
                return resolve;
            } else if (resolve.errorType == YAPI_DEVICE_NOT_FOUND && _this175._hubs.length == 0) {
            ...
            var updRes = yield _this175._updateDeviceList_internal(true, false);
            if (updRes.errorType != YAPI_SUCCESS) {
                resolve.errorType = updRes.errorType;
                resolve.errorMsg = updRes.errorMsg;
                return resolve;
            }
            return _this175.imm_funcDev_internal(str_className, str_func);
        })();
    }
    ...
    funcRequest(str_className, str_func, str_extra, int_msValidity) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YFuncRequest} **/
            let funcreq = _this176.imm_funcDev_internal(str_className, str_func);
            if (funcreq.errorType != YAPI_SUCCESS) {
                funcreq = yield _this176._funcDev(str_className, str_func);
                if (funcreq.errorType != YAPI_SUCCESS) {
                    return funcreq;
                }
            }
            ...
            if (str_extra == '') {
                ...
                if (yreq != null) {
                    if (yreq.errorType != YAPI_SUCCESS) return yreq;
                    try {
                        let jsonData = JSON.parse(_this176.imm_bin2str(yreq.bin_result));
            ...
            if (!loadval) {
                ...
                /** @type {YHTTPRequest} **/
                yreq = yield _this176.devRequest(devreq.deviceid, httpreq, null, 0);
                if (yreq.errorType != YAPI_SUCCESS) return yreq;
                ...
                try {
                    loadval = JSON.parse(_this176.imm_bin2str(yreq.bin_result));
                } catch (err) {
                    //console.log('RequestAPI parse error: ', err);
                }
            }
    ...
    HTTPRequest(str_device, str_request) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {YHTTPRequest} **/
            let yreq = yield _this177.devRequest(str_device, str_request, null, 0);
            if (yreq.errorType != YAPI_SUCCESS) {
                return _this177._throw(yreq.errorType, yreq.errorMsg, null);
            }
            return yreq.bin_result;
        })();
    }
    ...
    GetAPIVersion() {
        ...
        return _asyncToGenerator(function* () {
            return _this178.imm_GetAPIVersion();
        })();
    }

    imm_GetAPIVersion() {
        return (/* version number patched automatically */'1.10.23677'
        );
    }
    ...
    FreeAPI() {
        ...
        return _asyncToGenerator(function* () {
            ...
            for (let i = 0; i < _this179._hubs.length; i++) {
                _this179._hubs[i].disconnect();
            }
    ...
    DisableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this180.exceptionsDisabled = true;
        })();
    }
    ...
    EnableExceptions() {
        ...
        return _asyncToGenerator(function* () {
            _this181.exceptionsDisabled = false;
        })();
    }
    ...
    RegisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this183.imm_parseRegisteredUrl(url);
            let newhub = _this183.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this183.imm_registerHub_internal(urlInfo);
            ...
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                    _this183._serverResponse.write('\n!YoctoAPI:' + errmsg.msg + '\n');
                }
    ...
    PreregisterHub(url, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this184.imm_parseRegisteredUrl(url);
            let newhub = _this184.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = _this184.imm_registerHub_internal(urlInfo);
            _this184._addHub(newhub);
    ...
    RegisterHubHttpCallback(incomingMessage, serverResponse, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this185.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this185.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YHttpCallbackHub(_this185, urlInfo, incomingMessage, serverResponse);
    ...
    RegisterHubWebSocketCallback(ws, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            let urlInfo = _this186.imm_parseRegisteredUrl('http://callback:4444');
            let newhub = _this186.imm_getHub(urlInfo.url);
            if (newhub) {
                return YAPI_SUCCESS;
            }
            newhub = new YWebSocketCallbackHub(_this186, urlInfo, ws);
            let retcode = yield newhub.testHub(errmsg);
            if (retcode != YAPI_SUCCESS) {
                return _this186._throw(retcode, errmsg.msg, retcode);
            }
            yield _this186._addHub(newhub);

            // Update known device list
            let yreq = yield _this186._updateDeviceList_internal(true, false);
            if (yreq.errorType != YAPI_SUCCESS) {
                if (errmsg != undefined) {
                    errmsg.msg = yreq.errorMsg;
                }
                return _this186._throw(yreq.errorType, yreq.errorMsg, yreq.errorType);
            }
            return YAPI_SUCCESS;
        })();
    }
    ...
    UnregisterHub(url) {
        ...
        return _asyncToGenerator(function* () {
            var urlInfo = _this187.imm_parseRegisteredUrl(url);
            var i, j;

            for (i = 0; i < _this187._hubs.length; i++) {
                if (_this187._hubs[i].urlInfo.url == urlInfo.url) {
                    _this187._hubs[i].disconnect();
                    for (j = 0; j < _this187._hubs[i].serialByYdx.length; j++) {
                        var serial = _this187._hubs[i].serialByYdx[j];
                        _this187.imm_forgetDevice(_this187._devs[serial]);
                    }
                    var before = _this187._hubs.slice(0, i);
                    if (i + 1 < _this187._hubs.length) {
                        var after = _this187._hubs.slice(i + 1);
                        _this187._hubs = before.concat(after);
                    }
                    _this187._hubs = before;
                    return;
                }
            }
        })();
    ...
    UpdateDeviceList(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var yreq = yield _this188._updateDeviceList_internal(false, true);
            if (yreq.errorType != YAPI_SUCCESS) {
    ...
    HandleEvents(errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var nEvents = _this189._data_events.length;
            for (var i = 0; i < nEvents; i++) {
                var evt = _this189._data_events[i];
                if (typeof evt[1] == 'string') {
                    ...
                    var dev = _this189.imm_getDevice(evt[0]._serial);
                    if (dev) {
            ...
            _this189._data_events = _this189._data_events.slice(nEvents);
    ...
    Sleep(ms_duration, errmsg) {
        ...
        return _asyncToGenerator(function* () {
            var end = _this190.GetTickCount() + ms_duration;
            yield _this190.HandleEvents(errmsg);
            while (_this190.GetTickCount() < end) {
                yield _this190._microSleep_internal();
                yield _this190.HandleEvents(errmsg);
            }
            return YAPI_SUCCESS;
        })();
    ...
    _setTimeout_internal(callback, endtime, args, errmsg) {
        ...
        if (delay < 0) {
            ...
            this.Sleep(delay, errmsg).then(function () {
                _this191._setTimeout_internal(callback, endtime, args);
            });
        } else {
            this.UpdateDeviceList(errmsg).then(function () {
                _this191.Sleep(90, errmsg).then(function () {
                    _this191._setTimeout_internal(callback, endtime, args);
                });
            });
        }
    ...
    RegisterDeviceArrivalCallback(arrivalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this192._arrivalCallback = arrivalCallback;
        })();
    }
    ...
    RegisterDeviceChangeCallback(changeCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this193._namechgCallback = changeCallback;
        })();
    }
    ...
    RegisterDeviceRemovalCallback(removalCallback) {
        ...
        return _asyncToGenerator(function* () {
            _this194._removalCallback = removalCallback;
        })();
    }
    ...
    RegisterCalibrationHandler(calibrationType, calibrationHandler) {
        ...
        return _asyncToGenerator(function* () {
            _this195._calibHandlers[calibrationType.toString()] = calibrationHandler;
        })();
    }
    ...
    ComputePSK(ssid, pass) {
        ...
        return _asyncToGenerator(function* () {
            ...
            _this196.imm_initshaw(pass, 0, 0, 0x3636, _shaw);
            _this196.imm_itershaw(sha1_init, _shaw);
            for (k = 0; k < 5; k++) inner[k] = _shaw[k];
            _shaw = new Uint32Array(80);
            _this196.imm_initshaw(pass, 0, 0, 0x5c5c, _shaw);
            _this196.imm_itershaw(sha1_init, _shaw);
            ...
            _shaw = new Uint32Array(80);
            _this196.imm_initshaw(ssid, 0, 1, 0, _shaw);

            for (iter = 0; iter < 8192;) {
                _this196.imm_itershaw(inner, _shaw);
                _shaw[5] = 0x80000000;
                for (k = 6; k < 15; k++) {
                    _shaw[k] = 0;
                }
                _shaw[15] = 8 * (64 + 20);
                _this196.imm_itershaw(outer, _shaw);
                shau[0] ^= _shaw[0];
                shau[1] ^= _shaw[1];
                shau[2] ^= _shaw[2];
                shau[3] ^= _shaw[3];
                ...
                if ((iter & 4095) == 0) {
                    ...
                    if (iter == 4096) {
                        for (k = 0; k < 5; k++) shau[k] = 0;
                        _shaw = new Uint32Array(80);
                        _this196.imm_initshaw(ssid, 2, 0, _shaw);
                    }
                }
            }
            var hex = '';
