...
class YGenericSensor extends _yocto_api.YSensor {
    ...
    get_signalValue() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = Math.round(_this3._signalValue * 1000) / 1000;
            return res;
        })();
    }
