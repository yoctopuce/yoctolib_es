...
exports.YWirelessProxy = exports.YWireless = exports.Y_WLANCONFIG_INVALID = exports.Y_MESSAGE_INVALID = exports.Y_CHANNEL_INVALID = exports.Y_SSID_INVALID = exports.Y_LINKQUALITY_INVALID = exports.Y_WLANSTATE_INVALID = exports.Y_WLANSTATE_REJECTED = exports.Y_WLANSTATE_CONNECTED = exports.Y_WLANSTATE_SCANNING = exports.Y_WLANSTATE_DOWN = exports.Y_SECURITY_INVALID = exports.Y_SECURITY_WPA2 = exports.Y_SECURITY_WPA = exports.Y_SECURITY_WEP = exports.Y_SECURITY_OPEN = exports.Y_SECURITY_UNKNOWN = undefined;
...
var Y_WLANSTATE_DOWN = exports.Y_WLANSTATE_DOWN = 0;
var Y_WLANSTATE_SCANNING = exports.Y_WLANSTATE_SCANNING = 1;
var Y_WLANSTATE_CONNECTED = exports.Y_WLANSTATE_CONNECTED = 2;
var Y_WLANSTATE_REJECTED = exports.Y_WLANSTATE_REJECTED = 3;
var Y_WLANSTATE_INVALID = exports.Y_WLANSTATE_INVALID = -1;
...
class YWireless extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {number} **/
        this._wlanState = Y_WLANSTATE_INVALID;
        this.imm_setConst({
    ...
    startWlanScan() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {string} **/
            let config;
            config = yield _this10.get_wlanConfig();
            // a full scan is triggered when a config is applied
            return yield _this10.set_wlanConfig(config);
        })();
    }
    ...
    joinNetwork(ssid, securityKey) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this11.set_wlanConfig('INFRA:' + ssid + '\\' + securityKey);
        })();
    }
    ...
    adhocNetwork(ssid, securityKey) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this12.set_wlanConfig('ADHOC:' + ssid + '\\' + securityKey);
        })();
    }
    ...
    softAPNetwork(ssid, securityKey) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this13.set_wlanConfig('SOFTAP:' + ssid + '\\' + securityKey);
        })();
    }
    ...
    get_detectedWlans() {
        ...
        return _asyncToGenerator(function* () {
            ...
            json = yield _this14._download('wlan.json?by=name');
            wlanlist = _this14.imm_json_get_array(json);
            res.length = 0;
