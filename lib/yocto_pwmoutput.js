...
class YPwmOutput extends _yocto_api.YFunction {
    ...
    get_dutyCycleAtPowerOn() {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = _this17._dutyCycleAtPowerOn;
            return res;
        })();
    }
