        ...
        return _asyncToGenerator(function* () {
            ...
            if (age_ms >= 10 || _this6._qt_stamp == 0) {
                ...
                if (_this6._qt_stamp == 0) {
                    _this6._qt_w = yield YQt.FindQtInContext(_this6._serial + '.qt1');
                    _this6._qt_x = yield YQt.FindQtInContext(_this6._serial + '.qt2');
                    _this6._qt_y = yield YQt.FindQtInContext(_this6._serial + '.qt3');
                    _this6._qt_z = yield YQt.FindQtInContext(_this6._serial + '.qt4');
                }
