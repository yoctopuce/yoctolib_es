...
exports.YDigitalIOProxy = exports.YDigitalIO = exports.Y_COMMAND_INVALID = exports.Y_PORTSIZE_INVALID = exports.Y_PORTDIAGS_INVALID = exports.Y_PORTPOLARITY_INVALID = exports.Y_PORTOPENDRAIN_INVALID = exports.Y_PORTDIRECTION_INVALID = exports.Y_PORTSTATE_INVALID = exports.Y_OUTPUTVOLTAGE_INVALID = exports.Y_OUTPUTVOLTAGE_EXT_V = exports.Y_OUTPUTVOLTAGE_USB_3V = exports.Y_OUTPUTVOLTAGE_USB_5V = undefined;
...
var Y_PORTDIAGS_INVALID = exports.Y_PORTDIAGS_INVALID = _yocto_api.YAPI.INVALID_UINT;
...
class YDigitalIO extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {number} **/
        this._portDiags = Y_PORTDIAGS_INVALID;
        /** @member {number} **/
        ...
        this.imm_setConst({
            ...
            PORTDIAGS_INVALID: _yocto_api.YAPI.INVALID_UINT,
    ...
    set_outputVoltage(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this13._setAttr('outputVoltage', rest_val);
        })();
    }
    ...
    set_command(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this15._setAttr('command', rest_val);
        })();
    }
    ...
    set_bitState(bitno, bitstate) {
        ...
        return _asyncToGenerator(function* () {
            if (!(bitstate >= 0)) {
                return _this16._throw(_this16._yapi.INVALID_ARGUMENT, 'invalid bitstate', _this16._yapi.INVALID_ARGUMENT);
            }
            if (!(bitstate <= 1)) {
                return _this16._throw(_this16._yapi.INVALID_ARGUMENT, 'invalid bitstate', _this16._yapi.INVALID_ARGUMENT);
            }
            return yield _this16.set_command(String.fromCharCode(82 + bitstate) + '' + String(Math.round(bitno)));
        })();
    }
    ...
    get_bitState(bitno) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let portVal;
            portVal = yield _this17.get_portState();
    ...
    toggle_bitState(bitno) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this18.set_command('T' + String(Math.round(bitno)));
        })();
    }
    ...
    set_bitDirection(bitno, bitdirection) {
        ...
        return _asyncToGenerator(function* () {
            if (!(bitdirection >= 0)) {
                return _this19._throw(_this19._yapi.INVALID_ARGUMENT, 'invalid direction', _this19._yapi.INVALID_ARGUMENT);
            }
            if (!(bitdirection <= 1)) {
                return _this19._throw(_this19._yapi.INVALID_ARGUMENT, 'invalid direction', _this19._yapi.INVALID_ARGUMENT);
            }
            return yield _this19.set_command(String.fromCharCode(73 + 6 * bitdirection) + '' + String(Math.round(bitno)));
        })();
    }
    ...
    get_bitDirection(bitno) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let portDir;
            portDir = yield _this20.get_portDirection();
    ...
    set_bitPolarity(bitno, bitpolarity) {
        ...
        return _asyncToGenerator(function* () {
            if (!(bitpolarity >= 0)) {
                return _this21._throw(_this21._yapi.INVALID_ARGUMENT, 'invalid bitpolarity', _this21._yapi.INVALID_ARGUMENT);
            }
            if (!(bitpolarity <= 1)) {
                return _this21._throw(_this21._yapi.INVALID_ARGUMENT, 'invalid bitpolarity', _this21._yapi.INVALID_ARGUMENT);
            }
            return yield _this21.set_command(String.fromCharCode(110 + 4 * bitpolarity) + '' + String(Math.round(bitno)));
        })();
    }
    ...
    get_bitPolarity(bitno) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let portPol;
            portPol = yield _this22.get_portPolarity();
    ...
    set_bitOpenDrain(bitno, opendrain) {
        ...
        return _asyncToGenerator(function* () {
            if (!(opendrain >= 0)) {
                return _this23._throw(_this23._yapi.INVALID_ARGUMENT, 'invalid state', _this23._yapi.INVALID_ARGUMENT);
            }
            if (!(opendrain <= 1)) {
                return _this23._throw(_this23._yapi.INVALID_ARGUMENT, 'invalid state', _this23._yapi.INVALID_ARGUMENT);
            }
            return yield _this23.set_command(String.fromCharCode(100 - 32 * opendrain) + '' + String(Math.round(bitno)));
        })();
    }
    ...
    get_bitOpenDrain(bitno) {
        ...
        return _asyncToGenerator(function* () {
            /** @type {number} **/
            let portOpenDrain;
            portOpenDrain = yield _this24.get_portOpenDrain();
    ...
    pulse(bitno, ms_duration) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this25.set_command('Z' + String(Math.round(bitno)) + ',0,' + String(Math.round(ms_duration)));
        })();
    }
    ...
    delayedPulse(bitno, ms_delay, ms_duration) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this26.set_command('Z' + String(Math.round(bitno)) + ',' + String(Math.round(ms_delay)) + ',' + String(Math.round(ms_duration)));
        })();
    }
