...
class YColorLedCluster extends _yocto_api.YFunction {
    ...
    saveBlinkSeq(seqIndex) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this28.sendCommand('WS' + String(Math.round(seqIndex)));
        })();
    }
    ...
    set_rgbColorBuffer(ledIndex, buff) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this29._upload('rgb:0:' + String(Math.round(ledIndex)), buff);
        })();
    }
    ...
    set_rgbColorArray(ledIndex, rgbList) {
        ...
        return _asyncToGenerator(function* () {
            ...
            res = yield _this30._upload('rgb:0:' + String(Math.round(ledIndex)), buff);
            return res;
        })();
    }
    ...
    rgbArray_move(rgbList, delay) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            res = yield _this31._upload('rgb:' + String(Math.round(delay)), buff);
            return res;
        })();
    }
    ...
    set_hslColorBuffer(ledIndex, buff) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this32._upload('hsl:0:' + String(Math.round(ledIndex)), buff);
        })();
    }
    ...
    set_hslColorArray(ledIndex, hslList) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            res = yield _this33._upload('hsl:0:' + String(Math.round(ledIndex)), buff);
            return res;
        })();
    }
    ...
    hslArray_move(hslList, delay) {
        ...
        return _asyncToGenerator(function* () {
            ...
            // may throw an exception
            res = yield _this34._upload('hsl:' + String(Math.round(delay)), buff);
            return res;
        })();
    }
    ...
    get_rgbColorBuffer(ledIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this35._download('rgb.bin?typ=0&pos=' + String(Math.round(3 * ledIndex)) + '&len=' + String(Math.round(3 * count)));
        })();
    }
    ...
    get_rgbColorArray(ledIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let b;
            // may throw an exception
            buff = yield _this36._download('rgb.bin?typ=0&pos=' + String(Math.round(3 * ledIndex)) + '&len=' + String(Math.round(3 * count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                r = buff[3 * idx];
    ...
    get_rgbColorArrayAtPowerOn(ledIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let b;
            // may throw an exception
            buff = yield _this37._download('rgb.bin?typ=4&pos=' + String(Math.round(3 * ledIndex)) + '&len=' + String(Math.round(3 * count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                r = buff[3 * idx];
    ...
    get_linkedSeqArray(ledIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let seq;
            // may throw an exception
            buff = yield _this38._download('rgb.bin?typ=1&pos=' + String(Math.round(ledIndex)) + '&len=' + String(Math.round(count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                seq = buff[idx];
    ...
    get_blinkSeqSignatures(seqIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let ll;
            // may throw an exception
            buff = yield _this39._download('rgb.bin?typ=2&pos=' + String(Math.round(4 * seqIndex)) + '&len=' + String(Math.round(4 * count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                hh = buff[4 * idx];
    ...
    get_blinkSeqStateSpeed(seqIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let ll;
            // may throw an exception
            buff = yield _this40._download('rgb.bin?typ=6&pos=' + String(Math.round(seqIndex)) + '&len=' + String(Math.round(count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                lh = buff[2 * idx];
    ...
    get_blinkSeqStateAtPowerOn(seqIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let started;
            // may throw an exception
            buff = yield _this41._download('rgb.bin?typ=5&pos=' + String(Math.round(seqIndex)) + '&len=' + String(Math.round(count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                started = buff[idx];
    ...
    get_blinkSeqState(seqIndex, count) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let started;
            // may throw an exception
            buff = yield _this42._download('rgb.bin?typ=3&pos=' + String(Math.round(seqIndex)) + '&len=' + String(Math.round(count)));
            res.length = 0;
            idx = 0;
            while (idx < count) {
                started = buff[idx];
...
class YColorLedClusterProxy extends _yocto_api.YFunctionProxy {
    ...
    _asyncInit() {
        ...
        return _asyncToGenerator(function* () {
            /** @type {Uint8Array} **/
            _this43.liveFunc._cachedColorBuffer = yield _this43.liveFunc.get_rgbColorBuffer(0, _this43.liveFunc._activeLedCount);
            _this43.liveFunc._cachedColorAtPowerOn = yield _this43.liveFunc.get_rgbColorArrayAtPowerOn(0, _this43.liveFunc._activeLedCount);;
        })();
    }
    ...
    get_rgbColorBuffer(ledIndex, count) {
        ...
        this.liveFunc.get_rgbColorBuffer(0, this.liveFunc._activeLedCount).then(function (rgbBuff) {
            _this44.liveFunc._cachedColorBuffer = rgbBuff;
        });
        return res;
    }
    ...
    get_rgbColorArrayAtPowerOn(ledIndex, count) {
        ...
        this.liveFunc.get_rgbColorArrayAtPowerOn(0, this.liveFunc._activeLedCount).then(function (rgbColorArray) {
            _this45.liveFunc._cachedColorAtPowerOn = rgbColorArray;
        });
        return res;
    }
