...
var Y_USTEPMAXSPEED_INVALID = exports.Y_USTEPMAXSPEED_INVALID = _yocto_api.YAPI.INVALID_DOUBLE;
...
class YStepperMotor extends _yocto_api.YFunction {
    constructor(obj_yapi, str_func) {
        ...
        /** @member {number} **/
        this._ustepMaxSpeed = Y_USTEPMAXSPEED_INVALID;
        /** @member {number} **/
        ...
        this.imm_setConst({
            ...
            STEPPING_FULLSTEP: 4,
            STEPPING_INVALID: -1,
            USTEPMAXSPEED_INVALID: _yocto_api.YAPI.INVALID_DOUBLE,
     ...
     *
     * @param newval {number} : a floating point number corresponding to the maximal motor speed for
    ...
    set_ustepMaxSpeed(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(Math.round(newval * 65536.0));
            return yield _this15._setAttr('ustepMaxSpeed', rest_val);
        })();
    }
     ...
     *
     * @return {number} a floating point number corresponding to the maximal motor speed for
     * micro-stepping, measured in steps per second
     *
    ...
    set_overcurrent(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this18._setAttr('overcurrent', rest_val);
        })();
    }
    ...
    set_tCurrStop(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this20._setAttr('tCurrStop', rest_val);
        })();
    }
    ...
    set_tCurrRun(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this22._setAttr('tCurrRun', rest_val);
        })();
    }
    ...
    set_alertMode(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this24._setAttr('alertMode', rest_val);
        })();
    }
    ...
    set_command(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = newval;
            return yield _this26._setAttr('command', rest_val);
        })();
    }
    ...
    sendCommand(command) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this27.set_command(command);
        })();
    }
    ...
    reset() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this28.sendCommand('Z');
        })();
    }
    ...
    findHomePosition(speed) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this29.sendCommand('H');
        })();
    }
    ...
    changeSpeed(speed) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this30.sendCommand('R' + String(Math.round(Math.round(1000 * speed))));
        })();
    }
    ...
    moveTo(absPos) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this31.sendCommand('M' + String(Math.round(Math.round(16 * absPos))));
        })();
    }
    ...
    moveRel(relPos) {
        ...
        return _asyncToGenerator(function* () {
            return yield _this32.sendCommand('m' + String(Math.round(Math.round(16 * relPos))));
        })();
    }
    ...
    emergencyStop() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this33.sendCommand('!');
        })();
    }
    ...
    alertStepOut() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this34.sendCommand('.');
        })();
    }
    ...
    abortAndBrake() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this35.sendCommand('B');
        })();
    }
    ...
    abortAndHiZ() {
        ...
        return _asyncToGenerator(function* () {
            return yield _this36.sendCommand('z');
        })();
    }
...
class YStepperMotorProxy extends _yocto_api.YFunctionProxy {
     ...
     */
    set_ustepMaxSpeed(newval) {
        this.liveFunc.set_ustepMaxSpeed(newval);
        return this._yapi.SUCCESS;
    }
     ...
     */
    get_ustepMaxSpeed() {
        return this.liveFunc._ustepMaxSpeed;
    }
