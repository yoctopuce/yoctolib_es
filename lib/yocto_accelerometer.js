...
exports.YAccelerometerProxy = exports.YAccelerometer = exports.Y_ZVALUE_INVALID = exports.Y_YVALUE_INVALID = exports.Y_XVALUE_INVALID = exports.Y_BANDWIDTH_INVALID = exports.Y_GRAVITYCANCELLATION_INVALID = exports.Y_GRAVITYCANCELLATION_ON = exports.Y_GRAVITYCANCELLATION_OFF = undefined;
...
class YAccelerometer extends _yocto_api.YSensor {
    ...
    set_bandwidth(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            return yield _this3._setAttr('bandwidth', rest_val);
        })();
    }
    ...
    get_gravityCancellation() {
        ...
        return _asyncToGenerator(function* () {
            ...
            return _this7._gravityCancellation;
        })();
    }
    ...
    set_gravityCancellation(newval) {
        ...
        return _asyncToGenerator(function* () {
            ...
            let rest_val;
            rest_val = String(newval);
            return yield _this8._setAttr('gravityCancellation', rest_val);
        })();
    }
